...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-BEnNl80Y.js";
...
import { a as isValidFileSecretRefId, c as secretRefKey, i as isValidExecSecretRefId, l as validateExecSecretRefId, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage } from "./ref-contract-ZM9OZ0jK.js";
import { a as resolveSecretRefValue, l as resolveSecretProviderIntegrationConfig, s as isPluginIntegrationSecretProviderConfig } from "./resolve-DrrdKJKb.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-CCZXI5Xh.js";
import { n as info, o as success, t as danger } from "./globals-DiwHZb7D.js";
import { S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, W as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import { T as SecretProviderSchema } from "./zod-schema.core-BedchlTo.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-D0tK4K9_.js";
...
import { s as formatStrictJsonParseFailure } from "./error-format-17foa2IM.js";
import { n as formatPluginPackagingRuntimeOutputRecoveryHint } from "./config-recovery-hints-CafyV8SI.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-CoGt090u.js";
import { n as setCommandJsonMode } from "./json-mode-CFDipFg9.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-CsVmFN7q.js");
