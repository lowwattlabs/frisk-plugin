...
import { f as resolveHomeDir, g as shortenHomePath, p as resolveUserPath, u as pathExists$1 } from "./utils-CFG_gPqL.js";
import { s as resolveRuntimeServiceVersion } from "./version-Crcn9X9T.js";
import { m as writeJson } from "./json-files-BhHaMcRK.js";
import { i as resolveOpenClawStateSqlitePath } from "./openclaw-state-db-DDSD6wpM.js";
import { n as requireNodeSqlite } from "./sqlite-wal-BRMrE3Ol.js";
import { u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import "./config-Ba5VqNR9.js";
import { n as isPathWithin, t as buildCleanupPlan } from "./cleanup-utils-CJYxXGIF.js";
...
async function createBackupArchive(opts = {}) {
	...
	try {
		...
		const tarFilter = (entryPath) => {
			...
			if (sanitizedStateSqlite?.skippedSourcePaths.has(path.resolve(entryPath))) return false;
