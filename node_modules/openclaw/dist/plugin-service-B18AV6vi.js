...
import { b as readStringParam, c as imageResultFromFile, g as readPositiveIntegerParam, l as jsonResult, m as readNonNegativeIntegerParam } from "./common-CQZwSsYR.js";
...
import { Ki as ErrorCodes, qi as errorShape } from "./src-CgoRVpph.js";
import "./number-runtime-CORbdVbA.js";
import { i as wrapExternalContent } from "./external-content-BdbdWtKm.js";
import "./string-coerce-runtime-DzE-BRXv.js";
import { n as startLazyPluginServiceModule } from "./plugin-runtime-C4qAqHwR.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-D5sNzPzb.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-B-J4T3y7.js";
import { t as describeImageFile } from "./runtime-DQfMfG28.js";
import "./param-readers-CiA4k-w-.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-B5cMBKJK.js";
import { n as withTimeout } from "./sdk-security-runtime-CVJhypTk.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-B4Pf6W0G.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-goUXTfnY.js";
import "./sdk-setup-tools-DxN36Chl.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-DYPfTxTI.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-BEcNM11s.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CzVJo9kO.js";
import { n as normalizeBrowserScreenshot } from "./routes-BuZ_zwNV.js";
import { t as createBrowserRouteDispatcher } from "./dispatcher-CK8jofr8.js";
import { n as createBrowserControlContext } from "./plugin-enabled-CgQ4CtJ1.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-BHmin1th.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-XrpXI33R.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-B6hKyVhP.js");
