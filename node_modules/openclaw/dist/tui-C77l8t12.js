...
import { u as registerUncaughtExceptionHandler } from "./unhandled-rejections-CTJN5L5N.js";
import { _ as uniqueStrings } from "./string-normalization-WNUDCpXX.js";
import { t as loggingState } from "./state-CHRYWIGY.js";
import { s as setConsoleSubsystemFilter } from "./console-DcpfMatG.js";
import { l as resolveAgentIdByWorkspacePath } from "./agent-scope-BcYNOCQG.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, r as agentSessionKeysMatchByRequestKey, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
...
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels } from "./thinking-BHlJqFAp.js";
...
import { n as listChatCommands, r as listChatCommandsForConfig } from "./commands-registry-list-DoI8AMGd.js";
import { i as stripLeadingInboundMetadata } from "./strip-inbound-meta-VWt31sJ-.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CuUvHfKt.js";
import { f as isAuthErrorMessage } from "./sanitize-user-facing-text-lkgL0Nf2.js";
import { n as formatTokenCount } from "./usage-format-BF9TD_8H.js";
import { n as classifyFailoverReason } from "./errors-B5i-PbnI.js";
import "./embedded-agent-helpers-CdZv6Xta.js";
import { r as resolveToolDisplay, t as formatToolDetail } from "./tool-display-5Rh0YE_B.js";
import { r as resolveSessionInfoModelSelection } from "./model-selection-display-vptV_WEA.js";
import "./commands-registry-Vmpn6ZeA.js";
import { a as parseGoalCommand, n as formatGoalResumeContinuationPrompt, t as formatGoalContinuationPrompt } from "./commands-goal-BhrHOC62.js";
...
function createCommandHandlers(context) {
	const { client, chatLog, tui, opts, state, deliverDefault, openOverlay, closeOverlay, refreshSessionInfo, loadHistory, setSession, setEmptySession, refreshAgents, abortActive, setActivityStatus, formatSessionKey, applySessionInfoFromPatch, applySessionMutationResult, noteLocalRunId, noteLocalBtwRunId, forgetLocalRunId, forgetLocalBtwRunId, consumeCompletedRunForPendingSend, flushPendingHistoryRefreshIfIdle, runAuthFlow, requestExit } = context;
...
async function runTui(opts) {
	...
	if (opts.backend) client = opts.backend;
		...
		const { EmbeddedTuiBackend } = await import("./embedded-backend-C7kcXam2.js");
		client = new EmbeddedTuiBackend();
	} else {
		const { GatewayChatClient } = await import("./gateway-chat-BzLkGOHy.js");
	...
	const { handleChatEvent, handleAgentEvent, handleBtwEvent, pauseStreamingWatchdog, reconnectStreamingWatchdog, consumeCompletedRunForPendingSend, flushPendingHistoryRefreshIfIdle } = createEventHandlers({
		chatLog,
		btw,
		tui,
		state,
