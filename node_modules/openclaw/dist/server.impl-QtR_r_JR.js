...
import { n as isVitestRuntimeEnv, r as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-5g5TGXM7.js";
import { D as resolveIntegerOption, b as parseStrictPositiveInteger } from "./number-coercion-CJQ8TR--.js";
import { a as normalizeStateDirEnv, i as isNixMode } from "./paths-CiHrdfZh.js";
import { _ as uniqueStrings } from "./string-normalization-WNUDCpXX.js";
import { _ as sleep } from "./utils-CFG_gPqL.js";
import { D as runWithDiagnosticTraceContext, h as setDiagnosticsEnabledForProcess, l as isDiagnosticsEnabled, v as createDiagnosticTraceContext } from "./diagnostic-events-D6xo_Ohn.js";
import { r as runtimeForLogger, t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import { o as setCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BFPpxZI9.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-BqWfg4Sp.js";
import { c as isDiagnosticsTimelineEnabled, s as emitDiagnosticsTimelineEvent } from "./plugin-metadata-snapshot-CDfe2bdF.js";
...
import { _ as resolveRequestClientIp, i as isLoopbackHost, m as resolveGatewayListenHosts } from "./net-Cm4muceK.js";
import { o as createAuthRateLimiter } from "./auth-rate-limit-D5Ztzuls.js";
import { o as isLocalDirectRequest, r as authorizeHttpGatewayConnect } from "./auth-DCaNI_5E.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BZAxqZnD.js";
import { A as applyConfigOverrides, c as promoteConfigSnapshotToLastKnownGood, i as getRuntimeConfig, u as readConfigFileSnapshot, v as registerConfigWriteListener } from "./io-AmXZn-TT.js";
...
import { t as loadGatewayTlsRuntime$1 } from "./gateway-CDk42N3c.js";
import { n as createCoreGatewayMethodDescriptors, r as isCoreGatewayMethodClassified, s as listCoreGatewayMethodNames, t as STARTUP_UNAVAILABLE_GATEWAY_METHODS } from "./core-descriptors-Co4WOjdH.js";
...
import "./method-scopes-CooE5VHV.js";
import { h as setPreRestartDeferralCheck, m as setGatewaySigusr1RestartPolicy } from "./restart-DxnZU_9l.js";
import { n as readGatewayRestartHandoffSync } from "./restart-handoff-BjXU59Bh.js";
import { f as pinActivePluginChannelRegistry, g as releasePinnedPluginHttpRouteRegistry, h as releasePinnedPluginChannelRegistry, p as pinActivePluginHttpRouteRegistry } from "./runtime-Cc67q459.js";
import { i as createPluginGatewayMethodDescriptors, n as createGatewayMethodRegistry, t as createGatewayMethodDescriptorsFromHandlers } from "./registry-CnBfezYp.js";
import { i as resolveMainSessionKey } from "./main-session-BOhvpyEd.js";
import { n as getLoadedChannelPluginEntryById, r as listLoadedChannelPlugins } from "./registry-loaded-C34IYNUy.js";
import "./sessions-7_zgwGXH.js";
import { a as enqueueSystemEvent } from "./system-events-BMZOXQOE.js";
import { b as startDiagnosticHeartbeat, x as stopDiagnosticHeartbeat } from "./diagnostic-G4ZpZF4z.js";
import { i as withDiagnosticPhase } from "./diagnostic-phase-NTC2Jsdk.js";
import { o as resolveCronJobsStorePath } from "./store-BVkTHOZT.js";
import { u as getActiveEmbeddedRunCount } from "./run-state-DzXVr7P-.js";
import { l as getTotalQueueSize } from "./command-queue-LbK8r37L.js";
import { n as clearSecretsRuntimeSnapshot, r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-LK_7s91k.js";
import { o as setFallbackGatewayContextResolver } from "./server-plugins-CDOxQqfa.js";
import { t as getTotalPendingReplies } from "./dispatcher-registry-CaTZukRA.js";
import { c as recordGatewayRestartTraceDetail, d as resumeGatewayRestartTraceFromHandoff, i as finishGatewayRestartTrace, l as recordGatewayRestartTraceSpan, n as collectGatewayProcessMemoryUsageMb, u as resumeGatewayRestartTraceFromEnv } from "./restart-trace-D-XhyANs.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D75aiTHM.js";
import { c as resolveControlUiRootSync, n as isPackageProvenControlUiRootSync, s as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-a0r3-e4M.js";
import { n as logRejectedLargePayload } from "./diagnostic-payload-UBYebn4S.js";
import { i as MAX_BUFFERED_BYTES, o as MAX_PREAUTH_PAYLOAD_BYTES } from "./server-constants-BGwLM6XN.js";
import { s as normalizePluginNodeCapabilityScopedUrl } from "./plugin-node-capability-DG6eW8bP.js";
import { i as summarizeAgentEventForWsLog, n as logWs, r as shouldLogWs } from "./ws-log-Bs-rCRVj.js";
import { t as createDefaultDeps } from "./deps-nxfMcRIs.js";
import { c as setDefaultSecurityHeaders, r as sendGatewayAuthFailure } from "./http-common-DuE8kH2j.js";
import { t as GatewayLockError } from "./gateway-lock-doRFR7NE.js";
...
import { n as ensureControlUiAllowedOriginsForNonLoopbackBind } from "./gateway-control-ui-origins-BezPpmwz.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-ClQNx0ZS.js";
...
import { a as incrementPresenceVersion, i as getPresenceVersion, n as getHealthCache, o as refreshGatewayHealthSnapshot, r as getHealthVersion } from "./health-state-CNLYUTD4.js";
import { t as resolveGatewayPluginConfig } from "./runtime-plugin-config-hqYuXAk0.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Bkz_hM0W.js";
import { t as GATEWAY_EVENTS } from "./server-methods-list-DIp_9uxr.js";
import { a as resolvePluginRoutePathContext, i as isProtectedPluginRoutePathFromContext } from "./route-match-DRoeBB9a.js";
import { n as shouldEnforceGatewayAuthForPluginPath } from "./route-auth-Cn-tSOU5.js";
import { t as findMatchingPluginNodeCapabilityRoute } from "./route-capability-BBH_aZhH.js";
...
function createLazyGatewayCronState(params) {
	...
	const load = async () => {
		...
		loading ??= import("./server-cron-BOX9bvp4.js").then(({ buildGatewayCronService }) => {
			loaded = {
...
function getIdentityAvatarModule() {
	identityAvatarModulePromise ??= import("./identity-avatar-ROlYtZEp.js");
	return identityAvatarModulePromise;
}
function getControlUiModule() {
	controlUiModulePromise ??= import("./control-ui-Bo3xoRkE.js");
	return controlUiModulePromise;
}
function getEmbeddingsHttpModule() {
	embeddingsHttpModulePromise ??= import("./embeddings-http-CfIxRekk.js");
	return embeddingsHttpModulePromise;
}
function getManagedImageAttachmentsModule() {
	managedImageAttachmentsModulePromise ??= import("./managed-image-attachments-De-STuZo.js");
	return managedImageAttachmentsModulePromise;
}
function getModelsHttpModule() {
	modelsHttpModulePromise ??= import("./models-http-CT61NANT.js");
	return modelsHttpModulePromise;
}
function getOpenAiHttpModule() {
	openAiHttpModulePromise ??= import("./openai-http-bSSJac6P.js");
	return openAiHttpModulePromise;
}
function getOpenResponsesHttpModule() {
	openResponsesHttpModulePromise ??= import("./openresponses-http-D3C1z4N7.js");
	return openResponsesHttpModulePromise;
}
function getSessionHistoryHttpModule() {
	sessionHistoryHttpModulePromise ??= import("./sessions-history-http-DBupgMio.js");
	return sessionHistoryHttpModulePromise;
}
function getSessionKillHttpModule() {
	sessionKillHttpModulePromise ??= import("./session-kill-http-BG8PiJJ5.js");
	return sessionKillHttpModulePromise;
}
function getToolsInvokeHttpModule() {
	toolsInvokeHttpModulePromise ??= import("./tools-invoke-http-l5NtTW9F.js");
	return toolsInvokeHttpModulePromise;
}
function getPluginNodeCapabilityAuthModule() {
	pluginNodeCapabilityAuthModulePromise ??= import("./plugin-node-capability-auth-JawANNyA.js");
	return pluginNodeCapabilityAuthModulePromise;
}
function getHttpAuthUtilsModule() {
	httpAuthUtilsModulePromise ??= import("./http-auth-utils-DrjwgIn6.js");
	return httpAuthUtilsModulePromise;
}
function getPluginRouteRuntimeScopesModule() {
	pluginRouteRuntimeScopesModulePromise ??= import("./plugin-route-runtime-scopes-CI5AKtXx.js");
...
const loadGatewayPluginsHttpModule = async () => await import("./plugins-http-BmwrHB3b.js");
	...
	try {
		...
		const handleHooksRequest = async (req, res) => {
			...
			if (!loadedHooksRequestHandler) {
				const { createGatewayHooksRequestHandler } = await import("./hooks-ZeT1dI57.js");
...
const loadGatewayModelCatalogModule = async () => {
	gatewayModelCatalogModulePromise ??= import("./server-model-catalog-DeviUmhr.js");
...
function loadGatewayStartupEarlyModule() {
	gatewayStartupEarlyModulePromise ??= import("./server-startup-early-CfGx7dYC.js");
	return gatewayStartupEarlyModulePromise;
}
function loadGatewayStartupPostAttachModule() {
	gatewayStartupPostAttachModulePromise ??= import("./server-startup-post-attach-DWd6W0GV.js");
...
function getChannelRuntime() {
	cachedChannelRuntimePromise ??= import("./runtime-channel-r618b0sJ.js").then(({ createRuntimeChannel }) => createRuntimeChannel());
	return cachedChannelRuntimePromise;
}
async function closeMcpLoopbackServerOnDemand() {
	const { closeMcpLoopbackServer } = await import("./mcp-http-Bin63cAQ.js");
...
const loadGatewayPluginBootstrapModule = async () => {
	gatewayPluginBootstrapModulePromise ??= import("./server-plugin-bootstrap-CzWbx7ZZ.js");
...
async function stopTaskRegistryMaintenanceOnDemand() {
	const { stopTaskRegistryMaintenance } = await import("./task-registry.maintenance-rxStbXTW.js");
...
const runDefaultSetupWizard = async (...args) => {
	const { runSetupWizard } = await import("./setup-CiDZYaNc.js");
	return runSetupWizard(...args);
};
async function startGatewayServer(port = 18789, opts = {}) {
	normalizeStateDirEnv(process.env);
	const { bootstrapGatewayNetworkRuntime } = await import("./server-network-runtime-CKLWwQ1x.js");
	...
	const startupConfigModulePromise = import("./server-startup-config-Be6d9k2R.js");
	let startupPluginsModulePromise = null;
	const loadStartupPluginsModule = () => {
		startupPluginsModulePromise ??= import("./server-startup-plugins-CTQJSgYQ.js");
	...
	const runtimeConfig = await startupTrace.measure("runtime.config", async () => {
		const { resolveGatewayRuntimeConfig } = await import("./server-runtime-config-0ucdIiwg.js");
	...
	const { createChannelManager } = await import("./server-channels-CwkKMJj5.js");
	...
	const { createGatewayNodeSessionRuntime } = await import("./server-node-session-runtime-vGBiVZew.js");
	...
	try {
		...
		const [{ startGatewayEventSubscriptions }, { startGatewayRuntimeServices }] = await startupTrace.measure("runtime.post-early-imports", () => Promise.all([import("./server-runtime-subscriptions-CG_S8mAn.js"), import("./server-runtime-startup-services-Bc6RyYyf.js")]));
		...
		const { execApprovalManager, pluginApprovalManager, extraHandlers, coreGatewayHandlers } = await startupTrace.measure("gateway.handlers", async () => {
			const [{ createGatewayAuxHandlers }, { coreGatewayHandlers: coreGatewayHandlersLocal }] = await Promise.all([import("./server-aux-handlers-D98G5EnE.js"), import("./server-methods-BMqwyjZa.js")]);
			return {
		...
		const reloadAttachedGatewayPlugins = async (params) => {
			...
			const [{ loadPluginLookUpTable }, { prepareGatewayPluginLoad }, { startPluginServices }] = await Promise.all([
				import("./plugin-lookup-table-BaONfZOP.js"),
				loadGatewayPluginBootstrapModule(),
				import("./services-jg7ygky-.js")
			]);
		...
		const [{ attachGatewayWsHandlers }, { listPluginNodeCapabilities }] = await startupTrace.measure("gateway.ws-imports", () => Promise.all([import("./server-ws-runtime-B0jvh7oW.js"), import("./route-capability-O-oDE-l8.js")]));
		...
		const loadScheduledServicesModule = () => {
			scheduledServicesModulePromise ??= import("./server-runtime-services-BC4YZtie.js");
		...
		activateScheduledServicesWhenReady();
		const { startManagedGatewayConfigReloader } = await import("./server-reload-handlers-DOWbEw5A.js");
