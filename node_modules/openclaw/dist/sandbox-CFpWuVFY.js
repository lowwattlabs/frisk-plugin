...
import { c as splitSandboxBindSpec, s as resolveSandboxHostPathViaExistingAncestor } from "./network-mode-DyhC9CPP.js";
import "./config-Ba5VqNR9.js";
import { f as isSameSsrFPolicy } from "./ssrf-DQLCs47S.js";
import { a as resolveSandboxPath, i as resolveSandboxInputPath } from "./sandbox-paths-D0IzFPUM.js";
import { c as DEFAULT_USER_FILENAME, d as ensureAgentWorkspace, i as DEFAULT_IDENTITY_FILENAME, n as DEFAULT_BOOTSTRAP_FILENAME, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_HEARTBEAT_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-DVU_odQG.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT, x as SANDBOX_BROWSER_SECURITY_HASH_EPOCH, y as SANDBOX_BROWSER_IMAGE_CONTRACT_EPOCH } from "./constants-DVEmzBJl.js";
import { n as isToolAllowed } from "./tool-policy-3GZkPhX1.js";
import { i as resolveSandboxConfigForAgent, r as resolveSandboxBrowserDockerCreateConfig } from "./config-BCiaH6gw.js";
	...
	if (workspaceDir === sandboxWorkspaceDir) {
		...
		if (cfg.workspaceAccess !== "rw") try {
			const [{ syncSkillsToWorkspace }, { getRemoteSkillEligibility }, { canExecRequestNode }] = await Promise.all([
				import("./workspace-CIylKpwt.js"),
				import("./remote-05t6Pf7L.js"),
				import("./exec-defaults-JNHaRq2D.js")
			]);
...
async function resolveSandboxContext(params) {
	...
	if (cfg.prune.idleHours !== 0 || cfg.prune.maxAgeDays !== 0) await (await import("./prune--OFEFprC.js")).maybePruneSandboxes(cfg);
