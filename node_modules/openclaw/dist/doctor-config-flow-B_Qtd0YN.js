...
import { t as CONFIG_PATH } from "./paths-CiHrdfZh.js";
import { t as formatCliCommand } from "./command-format-CcxbKMj_.js";
import { c as isRecord$1 } from "./utils-CFG_gPqL.js";
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-BEnNl80Y.js";
import { i as normalizeProviderId$1 } from "./provider-id-Dq06Bcx6.js";
import { r as normalizeChatChannelId } from "./ids-EemT8aea.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-By1zn6Bl.js";
import { u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { i as setPathExistingStrict } from "./path-utils-Dad1P0uh.js";
import { n as discoverConfigSecretTargets } from "./target-registry-CCZXI5Xh.js";
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-AmXZn-TT.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-BrAGcTz5.js";
...
import { r as normalizeTalkSection } from "./talk-Bbheu2kt.js";
import { a as callGateway } from "./call-9LwLArZ9.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-BWcqgscC.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-CgvTDNPw.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, c as mergeMissing, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-o81PpUkj.js";
import { n as ensureRecord, r as hasOwnKey, t as cloneRecord } from "./legacy-config-record-shared-4Hv0ogZ5.js";
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CsISncfz.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-BEcipzN3.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-j40ip3Sz.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-CERanAVt.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-BlhFOrTO.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-DtfgFRsB.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-C-CtjdxF.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-CFl4j36_.js");
