...
import { Q as splitSetupEntries, f as createStandardChannelSetupStatus, g as createTopLevelChannelGroupPolicySetter, m as createTopLevelChannelDmPolicy, p as createTopLevelChannelAllowFromSetter, v as mergeAllowFromEntries } from "./setup-wizard-helpers-aMuEtwAz.js";
import "./setup-DqsZvrbQ.js";
import "./setup-tools-EFtMiPjX.js";
import { _ as hasConfiguredMSTeamsCredentials, b as saveDelegatedTokens, r as formatUnknownError, y as resolveMSTeamsCredentials } from "./errors-CgyhTdJV.js";
import { c as resolveMSTeamsUserAllowlist, o as parseMSTeamsTeamEntry, s as resolveMSTeamsChannelAllowlist } from "./resolve-allowlist-DEaDSCTD.js";
	...
	finalize: async (params) => {
		...
		if (finalCreds?.type === "secret") {
			if (await params.prompter.confirm({
				...
				try {
					const { loginMSTeamsDelegated } = await import("./oauth-DMZJBLXM.js");
