...
import { b as readStringParam, g as readPositiveIntegerParam, i as createActionGate, t as ToolAuthorizationError } from "./common-CQZwSsYR.js";
import { l as createScopedDmSecurityResolver, t as adaptScopedAccountAccessor } from "./channel-config-helpers-Q5p9ejlB.js";
import "./string-coerce-runtime-DzE-BRXv.js";
import { t as chunkTextForOutbound } from "./text-chunking-BcNuyNPW.js";
import { n as describeAccountSnapshot } from "./account-helpers-CDTU7Oaa.js";
...
import { _ as createAllowlistProviderOpenWarningCollector, w as projectAccountConfigWarningCollector } from "./channel-policy-DLbIVuEn.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-yJN_bbSv.js";
import { i as createResolvedDirectoryEntriesLister } from "./directory-config-helpers-DXaVQVQd.js";
import { n as createRuntimeOutboundDelegates, t as createRuntimeDirectoryLiveAdapter } from "./runtime-forwarders-CJHIfxll.js";
import { i as splitChannelApprovalCapability, n as createApproverRestrictedNativeApprovalCapability, r as createChannelApprovalCapability } from "./approval-delivery-helpers-BCbYC_RR.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-C6fUAy44.js";
import { r as createChannelNativeOriginTargetResolver } from "./approval-native-helpers-DTCZzPEP.js";
...
import { c as collectStatusIssuesFromLastError, d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Bw3y4bRG.js";
import "./channel-status-D86kmK7E.js";
import "./channel-actions-Box0txX4.js";
...
import { n as requiresExplicitMatrixDefaultAccount } from "./account-selection-B0lGJ9LP.js";
import { a as resolveMatrixAccountConfig } from "./account-config-bH4Gv22C.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BMNAWsb9.js";
import { n as normalizeMatrixUserId } from "./allowlist-DgsPLD5W.js";
import { t as normalizeMatrixApproverId } from "./approval-ids-DQu5ULfg.js";
import { a as isMatrixExecApprovalAuthorizedSender, c as shouldHandleMatrixApprovalRequest, d as matrixApprovalAuth, i as isMatrixApprovalClientEnabled, l as shouldSuppressLocalMatrixExecApprovalPrompt, n as getMatrixExecApprovalApprovers, o as isMatrixExecApprovalClientEnabled, r as isMatrixAnyApprovalClientEnabled, s as resolveMatrixExecApprovalTarget, t as getMatrixApprovalApprovers, u as getMatrixApprovalAuthApprovers } from "./exec-approvals-BHBuMesn.js";
import { a as resolveMatrixTargetIdentity, i as resolveMatrixDirectUserId, n as normalizeMatrixMessagingTarget, r as normalizeMatrixResolvableTarget } from "./target-ids-BlSlcwkl.js";
import { t as formatMatrixErrorMessage } from "./errors-DwOmgBwR.js";
import { n as matrixConfigAdapter, t as MatrixChannelConfigSchema } from "./config-schema-Bm9dNHEB.js";
import { n as normalizeCompatibilityConfig, t as legacyConfigRules } from "./doctor-contract-D5Va-21z.js";
import { n as resolveMatrixRoomConfig, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-DCjS-qxo.js";
import { d as setMatrixThreadBindingIdleTimeoutBySessionKey, p as setMatrixThreadBindingMaxAgeBySessionKey } from "./thread-bindings-shared-BzeLbdjl.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-CV61hkax.js";
import { a as namedAccountPromotionKeys, o as resolveSingleAccountPromotionTarget, s as singleAccountKeysToMove } from "./setup-dm-policy-Dh1WIIBR.js";
import { n as matrixSetupAdapter, t as createMatrixSetupWizardProxy } from "./setup-core-CNAEG_QW.js";
...
import { t as maybeCreateMatrixMigrationSnapshot } from "./migration-snapshot-backup-DJYKJ7mR.js";
import { n as resolveMatrixInboundConversation } from "./thread-binding-api-B08Nsb3B.js";
...
const matrixNativeApprovalCapability = createApproverRestrictedNativeApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-CQK_T--v.js")).matrixApprovalNativeRuntime
	})
});
...
const loadMatrixSetupWizard = createLazyRuntimeNamedExport(() => import("./setup-surface-BqDz2aiZ.js"), "matrixSetupWizard");
const loadMatrixChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CdzLoM7X.js"), "matrixChannelRuntime");
let matrixDoctorModulePromise = null;
const loadMatrixDoctorModule = async () => {
	matrixDoctorModulePromise ??= import("./doctor-CIU4LRXS.js");
...
const matrixPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			...
			try {
				monitorMatrixProvider = (await import("./monitor-gFWlG7LE.js")).monitorMatrixProvider;
			} finally {
				releaseLock();
			}
