...
import { a as resolveAgentDir, s as resolveDefaultAgentDir, t as listAgentEntries } from "./agent-scope-config-BoFGd2i9.js";
...
import { t as AUTH_STORE_LOCK_OPTIONS } from "./constants-CQXVENzh.js";
import { E as isSafeToAdoptMainStoreOAuthIdentity, S as areOAuthCredentialsEquivalent, _ as loadPersistedAuthProfileStore, p as saveAuthProfileStore, w as hasUsableOAuthCredential, y as isLegacyOAuthRef } from "./store-U0aP-Cup.js";
...
async function repairStaleOAuthProfilesForAgent(params) {
	return await withFileLock(resolveAuthStorePath(params.agentDir), AUTH_STORE_LOCK_OPTIONS, async () => {
		...
		saveAuthProfileStore(result.store, params.agentDir, { pruneOrderProfileIds: result.removedProfileIds });
		return {
			status: "changed",
