...
import { _ as parseStrictFiniteNumber, c as asFiniteNumberInRange, m as isFutureDateTimestampMs } from "./number-coercion-CJQ8TR--.js";
import { c as isRecord } from "./utils-CFG_gPqL.js";
import { d as normalizeSecretInputString, s as hasConfiguredSecretInput, u as normalizeResolvedSecretInputString } from "./types.secrets-BEnNl80Y.js";
...
import { a as isHttpsUrlAllowedByHostnameSuffixAllowlist, c as normalizeHostnameSuffixAllowlist, n as buildHostnameAllowlistPolicyFromSuffixAllowlist } from "./ssrf-policy-DM3MoCYe.js";
import "./ssrf-runtime-BFhKr63u.js";
import "./provider-http-osSi-BpS.js";
import { t as getMSTeamsRuntime } from "./runtime-api-DRULZAn-.js";
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-D4vh8cK2.js";
...
async function loadSdkModules() {
	sdkAppPromise ??= Promise.all([import("./dist-Dkj9JxYe.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-m7dmJ-Tv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
		App: apps.App,
