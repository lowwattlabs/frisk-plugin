...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, k as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-8KO9gKcu.js";
...
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-YVod7apR.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-B7_8Ya3E.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-vDv7YBAw.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-CEda07Kl.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-C4ismryx.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-CFhPDAVw.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-BzF31m0f.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BvxfgHBc.js"));
...
const routedCommandDefinitions = {
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-wX7PlufR.js");
			...
			const { statusCommand } = await import("./status-BvEF1_Gx.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-BA-5VDHO.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-BK0YqRqG.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-CcyY8PEv.js");
