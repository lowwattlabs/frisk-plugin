...
import { _ as resolveOAuthDir } from "./paths-CiHrdfZh.js";
...
function loadSkillsModule() {
	skillsModulePromise ??= import("./workspace-CIylKpwt.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-D91MshD8.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-aA_LKVwL.js");
	return agentWorkspaceDirsModulePromise;
}
function loadSkillSourceModule() {
	skillSourceModulePromise ??= import("./source-CAb9osJy.js");
	return skillSourceModulePromise;
}
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./scanner-CEHwE6WZ.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-RIoHrMHu.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-D3VWB9Ti.js");
