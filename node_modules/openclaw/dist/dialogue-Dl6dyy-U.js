import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-CkIIrG7n.js";
import { r as loadCrestodianOverview } from "./overview-D5DkAcoR.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-Y4SnWn47.js")).planCrestodianCommand)({
		input,
		overview
	});
