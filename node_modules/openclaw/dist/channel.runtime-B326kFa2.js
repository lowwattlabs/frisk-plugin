...
import "./accounts-DcsKp9Fl.js";
import "./runtime-api-Cn9Uszgg.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-M0k2VsbG.js";
import { t as sendMessageZalo } from "./send-_CMQXIhw.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-FlsPX_9P.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-D6gnfTEE.js");
