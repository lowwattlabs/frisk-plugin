#!/usr/bin/env node
import { a as formatUncaughtError } from "./errors-DJFNHUbg.js";
import { t as formatCliFailureLines } from "./failure-output-DB1q_ALb.js";
import { r as runFatalErrorHooks } from "./fatal-error-hooks-gDVRMZSa.js";
import { t as isMainModule } from "./is-main-DoKHeRG7.js";
import { c as isUncaughtExceptionHandled, r as isBenignUncaughtExceptionError, t as installUnhandledRejectionHandler } from "./unhandled-rejections-CTJN5L5N.js";
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-DH-TCAeA.js"));
if (isMain) {
