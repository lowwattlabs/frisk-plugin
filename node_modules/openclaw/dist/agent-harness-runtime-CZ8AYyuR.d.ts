...
import { M as MemoryCitationsMode } from "./types.tools-DGn1azQf.js";
import { l as ImageContent } from "./types-DAMKpKGt.js";
import { o as ModelCompatConfig } from "./types.models-BZoNFPND.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode } from "./types-BIVMBCTf.js";
import { Ar as AgentToolUpdateCallback, Er as AgentTool, kr as AgentToolResult, wr as AgentMessage } from "./index-DKxB8WKn.js";
import { Ar as CodexAppServerToolResultEvent, Bi as PreemptiveCompactionRoute, Cs as ProviderRuntimePluginHandle, Da as TranscriptRewriteResult, Dr as CodexAppServerExtensionContext, Gr as AgentToolResultMiddlewareContext, Ji as ToolOutcomeObserver, Kr as AgentToolResultMiddlewareEvent, Or as CodexAppServerExtensionFactory, Qi as requestDeferredPluginToolApproval, Ri as EmbeddedRunAttemptParams, Ss as ProviderRuntimeModel, Ui as AgentRuntimePlan, Vi as NormalizedUsage, Wi as BuildAgentRuntimePlanParams, Wr as AgentToolResultMiddleware, Zo as EmbeddedRunTrigger, Zr as OpenClawAgentToolResult, ba as ContextEngineRuntimeContext, da as CompactResult, fa as ContextEngine, la as AssembleResult, ss as ExecToolDefaults, ya as ContextEnginePromptCacheInfo, zi as EmbeddedRunAttemptResult } from "./types-DOrS-soN.js";
import { d as InboundEventKind } from "./templating-BdP7Fw7G.js";
import { n as SkillSnapshot } from "./types-DgZg8Ee9.js";
...
import { s as AuthProfileStore } from "./types--v-RuEVE.js";
import { Dr as ToolDefinition } from "./index-J-ma9Bgj.js";
import { t as SubsystemLogger } from "./subsystem-CfQVin8T.js";
import { t as ModelAuthMode } from "./model-auth-e3WSmRWs.js";
import { $ as PluginHookLlmInputEvent, L as PluginHookContextWindowSource, et as PluginHookLlmOutputEvent, f as PluginHookAgentContext, m as PluginHookBeforeAgentFinalizeEvent, p as PluginHookAgentEndEvent } from "./hook-types-eDvaxJMP.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { l as EmbeddedAgentQueueMessageOptions } from "./runs-DGGilf0l.js";
import { t as ProcessToolDefaults } from "./bash-tools.process-BKy5qLNB.js";
import { M as SandboxContext } from "./sandbox-DIgWCaOk.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-p5XaMSRJ.js";
import { t as BundleMcpDiagnostic } from "./bundle-mcp-DABlFCpS.js";
import { t as PluginToolMcpMeta } from "./tools-BQ_8rHoL.js";
