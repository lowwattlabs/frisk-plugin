...
import { d as resolveGatewayPort, s as resolveConfigPath } from "./paths-CiHrdfZh.js";
...
async function loadCrestodianOverview(opts = {}) {
	...
	let gatewayError;
	try {
		const details = (deps.buildGatewayConnectionDetails ?? (await import("./call-Blf_Okhs.js")).buildGatewayConnectionDetails)({
			config: cfg,
			configPath
		});
