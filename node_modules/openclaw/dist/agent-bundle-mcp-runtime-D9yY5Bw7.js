...
import { n as findJsonSchemaShapeError, r as normalizeJsonSchemaForTypeBox } from "./json-schema-defaults-BxEBjVey.js";
import { n as signalProcessTree, t as killProcessTree } from "./kill-tree-kSm0C74g.js";
import { a as redactSensitiveUrl, o as redactSensitiveUrlLikeString } from "./redact-sensitive-url-DT6j3eLK.js";
import { a as loadUndiciRuntimeDeps } from "./undici-runtime-ebEj6qcl.js";
import { r as loadEnabledBundleMcpConfig } from "./bundle-mcp-mSeu75xV.js";
import { t as normalizeHeadersInitForFetch } from "./fetch-headers-D18pVzIl.js";
import { t as retainSafeHeadersForCrossOriginRedirect } from "./redirect-headers-C45a8n-d.js";
import { i as toMcpStringRecord, n as resolveStdioMcpServerLaunchConfig, r as isMcpConfigRecord, t as describeStdioMcpServerLaunchConfig } from "./mcp-stdio-Cz2Qr9D1.js";
import { r as sanitizeServerName } from "./agent-bundle-mcp-names-B02Vk5fe.js";
import { i as resolveOpenClawMcpTransportAlias, r as normalizeConfiguredMcpServers } from "./mcp-config-normalize-CEgQZSRA.js";
...
function buildMcpHttpFetch(params) {
	if (!(params.sslVerify === false || Boolean(params.clientCert || params.clientKey))) return fetchWithUndici;
	...
	return async (url, init) => {
		if (scopedOrigin && new URL(url).origin !== scopedOrigin) return fetchWithUndici(url, init);
...
function buildOAuthClientMetadata(config) {
	return {
		client_name: "OpenClaw MCP",
		redirect_uris: [normalizeOptionalString(config.redirectUrl) ?? DEFAULT_REDIRECT_URL],
...
function buildStreamableHttpFetch(baseFetch) {
	return async (url, init) => {
