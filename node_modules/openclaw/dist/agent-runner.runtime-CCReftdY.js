...
import { n as isAbortError } from "./unhandled-rejections-CTJN5L5N.js";
import { t as createLazyImportLoader } from "./lazy-promise-D9U9idWj.js";
import { n as defaultRuntime } from "./runtime-pp2OBTec.js";
import { _ as createChildDiagnosticTraceContext, a as emitTrustedDiagnosticEvent, l as isDiagnosticsEnabled, x as freezeDiagnosticTraceContext } from "./diagnostic-events-D6xo_Ohn.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import { a as markAutoFallbackPrimaryProbe, n as entryMatchesAutoFallbackPrimaryProbe, r as hasConfiguredModelFallbacks, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-BcYNOCQG.js";
import { f as resolveAgentIdFromSessionKey } from "./session-key-BOpfMTUN.js";
import { r as resolveAgentConfig } from "./agent-scope-config-BoFGd2i9.js";
...
import { c as resolveContextConfigProviderForRuntime } from "./openai-routing-Bc6sEjDj.js";
import { n as resolveAgentHarnessPolicy } from "./harness-runtimes-BYhR8wfO.js";
import "./defaults-mDjiWzE5.js";
import { _ as resolveResponseUsageMode, g as normalizeVerboseLevel } from "./thinking-BHlJqFAp.js";
import { n as parseNonNegativeByteSize } from "./zod-schema-CNsDPNyw.js";
...
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-f1e3xUso.js";
import { o as isAudioFileName } from "./mime-n-YFWBtW.js";
import { o as normalizeDeliveryContext } from "./delivery-context.shared-DQ3Juxwd.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-Bz9nEaho.js";
import { i as readSessionEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-X9ls7b1K.js";
import { d as updateSessionStore, f as updateSessionStoreEntry, t as applySessionStoreEntryPatch } from "./store-D2vwNFZF.js";
import { r as isInternalMessageChannel } from "./message-channel-rCegTRAO.js";
import { c as resolveSessionPluginTraceLines, o as resolveFreshSessionTotalTokens, s as resolveSessionPluginStatusLines } from "./types-DUYD_-CI.js";
import { d as resolveSessionGoalDisplayState } from "./sessions-7_zgwGXH.js";
import "./transcript-jsonl-B-FDKU0h.js";
import { i as modelKey, r as legacyModelKey } from "./model-selection-normalize-BLLQsO6X.js";
import { t as isCliProvider } from "./model-selection-cli-vihwKwXl.js";
import "./model-selection-BKypu26e.js";
import { c as estimateMessagesTokens } from "./compaction-planning-4RyC6kFX.js";
import { f as resolveModelAuthMode } from "./model-auth-UZfuk32X.js";
import { a as resolveSourceReplyVisibilityPolicy } from "./source-reply-delivery-mode-CVlG2-Nl.js";
...
import { o as stripLegacyBracketToolCallBlocks } from "./assistant-visible-text-BWx-tg5g.js";
import { d as sanitizeUserFacingText } from "./sanitize-user-facing-text-lkgL0Nf2.js";
import { p as replyRunRegistry } from "./reply-run-registry-B8uh7Okn.js";
import { o as resolveCronJobsStorePath, t as loadCronJobsStore } from "./store-BVkTHOZT.js";
import { i as formatEmbeddedAgentQueueFailureSummary, p as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-ZDT-yHKC.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-BpOBzvOi.js";
import { u as readSessionMessagesAsync } from "./session-utils.fs-FlJCaQFx.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-9jdLB75K.js";
import { i as hasNonzeroUsage, n as derivePromptTokens, o as normalizeUsage, r as deriveSessionTotalTokens, t as deriveContextPromptTokens } from "./usage-CMHCCi6P.js";
import { c as shouldPreserveUserFacingSessionStateForInputProvenance } from "./input-provenance-3lgzT57B.js";
import { a as resolveSessionTranscriptCandidates } from "./session-transcript-files.fs-OVGfH0_W.js";
import { o as resolveContextTokensForModel } from "./context-CkdWJLB1.js";
import { a as resolveModelCostConfig, n as formatTokenCount, r as formatUsd, t as estimateUsageCost } from "./usage-format-BF9TD_8H.js";
import { n as resolveSendPolicy } from "./send-policy-DZpzgiDG.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-LbK8r37L.js";
import { i as resolveSandboxConfigForAgent } from "./config-BCiaH6gw.js";
...
import { a as resolveCliRuntimeExecutionProvider, t as areRuntimeModelRefsEquivalent } from "./model-runtime-aliases-BZbkQtpt.js";
import { d as stripHeartbeatToken } from "./heartbeat-vio2lkit.js";
import { j as readPostCompactionContext } from "./compaction-successor-transcript-CUmEvaGX.js";
import { a as generateSecureUuid } from "./secure-random-BxnbXS5x.js";
import { c as FollowupRunDeferredError, l as completeFollowupRunLifecycle, o as scheduleFollowupDrain, r as enqueueFollowupRun, s as refreshQueuedFollowupSession, u as isFollowupRunAborted } from "./queue-D-mTrnGc.js";
import { i as isRenderablePayload, n as applyReplyThreading } from "./reply-payloads-DTRGRssp.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-DkCU8iPc.js";
import "./embedded-agent-helpers-CdZv6Xta.js";
import { n as filterMessagingToolMediaDuplicates, r as resolveMessagingToolPayloadDedupe, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-CtoX9DQ8.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-B6keltUN.js";
import { o as runWithModelFallback } from "./model-fallback-hP2QoTn4.js";
import "./sandbox-CFpWuVFY.js";
import { l as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-1AUyw8RK.js";
import "./tool-result-middleware-BT_IFZOo.js";
import { n as resolveEffectiveReplyRoute } from "./effective-reply-route-Dsfqf3WC.js";
import { t as runEmbeddedAgent } from "./embedded-agent-eUaVGd6D.js";
import { c as setCliSessionId, n as clearCliSession, r as getCliSessionBinding, s as setCliSessionBinding } from "./cli-session-DCbzzAVH.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-G2vU8DaW.js";
import { n as classifyCompactionReason } from "./compact-reasons-DERZ3i76.js";
import { n as buildAgentRuntimeOutcomePlan, t as buildAgentRuntimeDeliveryPlan } from "./build-BY7vvUlP.js";
import { a as resolveQueuedReplyExecutionConfig, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyRuntimeConfig, r as formatBunFetchSocketError, s as resolveModelFallbackOptions, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-D-p5_hDw.js";
import { a as resolveRunAfterAutoFallbackPrimaryProbeRecheck, c as normalizeReplyPayloadDirectives, d as runCliAgentWithLifecycle, i as buildPreflightCompactionFailureText, l as clearDroppedCliSessionBinding, n as resolveReplyTurnKind, o as resolveSessionRuntimeOverrideForProvider, r as buildKnownAgentRunFailureReplyPayload, s as runAgentTurnWithFallback, t as admitReplyTurn, u as keepCliSessionBindingOnlyWhenReused } from "./reply-turn-admission-CJiQkxZa.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-CHjTj4Yz.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-CvF-ruBJ.js";
import { t as createReplyMediaContext } from "./reply-media-paths.runtime-CSGqf518.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-D43ac8rR.js";
import { r as enqueueCommitmentExtraction } from "./runtime-bHkbdCoq.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-2fz2WBBx.js";
import { t as REPLY_RUN_STILL_SHUTTING_DOWN_TEXT } from "./get-reply-run-queue-mH_RPenk.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-CjsU3bfs.js";
import { t as formatProviderModelRef } from "./model-runtime-CLiYpmhJ.js";
import "./fallback-notice-state-QfXJIQtT.js";
import { n as incrementCompactionCount } from "./session-updates--YjOZpH_.js";
...
const embeddedAgentRuntimeLoader = createLazyImportLoader(() => import("./embedded-agent-BV3hNLh-.js"));
