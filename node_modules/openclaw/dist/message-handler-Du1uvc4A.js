...
import { D as runWithDiagnosticTraceContext, v as createDiagnosticTraceContext } from "./diagnostic-events-D6xo_Ohn.js";
import { a as isPrivateOrLoopbackAddress, c as isTrustedProxyAddress, f as resolveClientIp, h as resolveHostName, i as isLoopbackHost, n as isLocalishHost, o as isPrivateOrLoopbackHost, r as isLoopbackAddress } from "./net-Cm4muceK.js";
import { a as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, t as AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN } from "./auth-rate-limit-D5Ztzuls.js";
import { a as hasForwardedRequestHeaders, c as checkBrowserOrigin, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedRateLimitAttempt } from "./auth-DCaNI_5E.js";
...
import { c as buildDeviceAuthPayloadV3, l as normalizeDeviceMetadataForAuth, s as buildDeviceAuthPayload } from "./client-BfgBP91A.js";
import { i as normalizeDevicePublicKeyBase64Url, s as verifyDeviceSignature, t as deriveDeviceIdFromPublicKey } from "./device-identity-MBMlKHkl.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-rCegTRAO.js";
import { n as isOperatorApprovalRuntimeToken } from "./operator-approval-runtime-token-C5pv_wEb.js";
import { Ki as ErrorCodes, Mt as validateRequestFrame, P as validateConnectParams, qi as errorShape, t as formatValidationErrors } from "./src-CgoRVpph.js";
import { t as rawDataToString } from "./ws-C3qhmaFC.js";
import { l as roleScopesAllow } from "./pairing-token-CMO8P9C8.js";
import { c as updatePairedNodeMetadata, d as sameNodeApprovalSurfaceSet, f as sameNodePermissionSurface, n as getPairedNode, s as requestNodePairing, u as normalizeNodeApprovalSurfaceList } from "./node-pairing-CO8saNqD.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-DEjg5ClH.js";
...
import { a as indexPluginNodeCapabilitySurfaces, d as setClientPluginNodeCapability, l as resolvePluginNodeCapabilityExpiresAtMs, o as mintPluginNodeCapabilityToken, r as buildPluginNodeCapabilityScopedHostUrl } from "./plugin-node-capability-DG6eW8bP.js";
import { a as normalizeDeclaredNodeCommands, o as resolveNodeCommandAllowlist, s as resolveNodePairingCommandAllowlist } from "./node-command-policy-D5sNzPzb.js";
import { n as logWs, t as formatForLog } from "./ws-log-Bs-rCRVj.js";
import { a as redeemDeviceBootstrapTokenProfile, d as isPairingSetupBootstrapProfile, l as verifyDeviceBootstrapToken, m as resolveBootstrapProfileScopesForRoles, n as getBoundDeviceBootstrapProfile, o as restoreDeviceBootstrapToken, p as resolveBootstrapProfileScopesForRole, r as getDeviceBootstrapTokenProfile, s as revokeDeviceBootstrapToken } from "./device-bootstrap-BJpZ3cpy.js";
import { _ as updatePairedDeviceMetadata, a as getPairedDevice, c as listApprovedPairedDeviceRoles, l as listDevicePairing, n as approveDevicePairing, p as requestDevicePairing, r as ensureDeviceToken, s as hasEffectivePairedDeviceRole, t as approveBootstrapDevicePairing, u as listEffectivePairedDeviceRoles, v as verifyDeviceToken } from "./device-pairing-DkTELHfz.js";
import { t as resolveSharedGatewaySessionGeneration } from "./ws-shared-generation-Bp5l7wzu.js";
import { r as loadVoiceWakeConfig, t as formatError } from "./server-utils-AIYX2EwW.js";
import { r as upsertPresence } from "./system-presence-6qeC9ZZz.js";
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-CNLYUTD4.js";
import { n as parseGatewayRole, r as roleCanSkipDeviceIdentity } from "./role-policy-Bnlb3Uhy.js";
import { t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CkT0KfAa.js";
import { n as buildHandshakeAuthLogKey, r as shouldLimitMissingCredentialAuthLog, t as HandshakeAuthLogLimiter } from "./handshake-auth-log-limiter-C8TQVwNS.js";
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			const dispatch = (async () => {
				const { handleGatewayRequest } = await import("./server-methods-BMqwyjZa.js");
