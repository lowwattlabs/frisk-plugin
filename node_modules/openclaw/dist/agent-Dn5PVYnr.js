...
import { a as formatUncaughtError, c as readErrorName } from "./errors-DJFNHUbg.js";
...
import { f as resolveAgentIdFromSessionKey, s as classifySessionKeyShape, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { c as resolveDefaultAgentId, n as listAgentIds } from "./agent-scope-config-BoFGd2i9.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-B_4RUpAv.js";
import { a as hasGatewayClientCap, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BzCrekjX.js";
...
import { i as resolveAssistantAvatarUrl } from "./control-ui-shared-CDdfd1kC.js";
import { l as onAgentEvent, u as registerAgentRunContext } from "./agent-events-f1e3xUso.js";
import { n as resolveAgentMainSessionKey, r as resolveExplicitAgentSessionKey } from "./main-session-BOhvpyEd.js";
import { i as resolveSessionStoreKey, n as canonicalizeSpawnedByForAgent } from "./session-store-key-BxTZ7QhH.js";
import { i as mergeDeliveryContext, o as normalizeDeliveryContext, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-DQ3Juxwd.js";
import { n as isInternalNonDeliveryChannel } from "./message-channel-constants-xBuIaJJT.js";
import { i as normalizeMessageChannel, n as isGatewayMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath } from "./paths-Bz9nEaho.js";
import { D as resolveMaintenanceConfigFromInput } from "./store-load-X9ls7b1K.js";
...
import { c as resolveSessionResetPolicy, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-Cg-ypwIC.js";
import { t as asBoolean } from "./boolean-By0bZpFH.js";
import { a as normalizeAgentRunTimeoutPhase, i as mergeAgentRunTerminalOutcome, t as buildAgentRunTerminalOutcome } from "./agent-run-terminal-outcome-DZzwLfzy.js";
import { i as createRunningTaskRun, o as finalizeTaskRunByRunId } from "./detached-task-runtime-VADcP34g.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D5IVNNSy.js";
import { r as readAcpSessionMeta } from "./session-meta-DmjSKzYK.js";
import { c as shouldPreserveUserFacingSessionStateForInputProvenance, n as annotateInterSessionPromptText, s as normalizeInputProvenance } from "./input-provenance-3lgzT57B.js";
import { b as resolveSessionModelRef, d as migrateAndPruneGatewaySessionStoreKey, g as resolveGatewaySessionStoreTarget, h as resolveGatewayModelSupportsImages, l as loadGatewaySessionRow, u as loadSessionEntry } from "./session-utils-BLUgAqaB.js";
import { n as resolveSendPolicy } from "./send-policy-DZpzgiDG.js";
import { c as isTimeoutError } from "./failover-error-BPprEaIb.js";
import { s as resolveTrustedGroupId } from "./agent-tools.policy-caKmfQJ7.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun, s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-CFUna7Th.js";
import "./subagent-announce-delivery-DhVEJzi6.js";
import { n as shouldDowngradeDeliveryToSessionOnly } from "./best-effort-delivery-CIzV-RHI.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-CRKB2xO6.js";
import { Ki as ErrorCodes, i as validateAgentWaitParams, n as validateAgentIdentityParams, qi as errorShape, r as validateAgentParams, t as formatValidationErrors } from "./src-CgoRVpph.js";
import { l as updateChatRunProvider, o as registerChatAbortController, s as resolveAgentRunExpiresAtMs } from "./chat-abort-BipmFF4B.js";
import { a as emitGatewaySessionEndPluginHook, c as performGatewaySessionReset, o as emitGatewaySessionStartPluginHook } from "./session-reset-service-4Xcd7Aaj.js";
import { n as resolvePublicAgentAvatarSource, t as resolveAgentAvatar } from "./identity-avatar-B-90cUZN.js";
import { n as agentCommandFromIngress } from "./agent-command-DRsBZPLN.js";
import { n as resolveAgentDeliveryPlanWithSessionRoute, r as resolveAgentOutboundTarget } from "./agent-delivery-B5b6B5M-.js";
import { t as formatForLog } from "./ws-log-Bs-rCRVj.js";
import "./agent-ClQs8FI-.js";
import { n as consumeExecApprovalFollowupRuntimeHandoff, r as parseExecApprovalFollowupApprovalId } from "./bash-tools.exec-approval-followup-state-ZlqqhDtL.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BQ1pjbLf.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-B2uOkBdP.js";
import { n as setGatewayDedupeEntry, r as waitForTerminalGatewayDedupe, t as readTerminalSnapshotFromGatewayDedupe } from "./agent-wait-dedupe-zH9EMnN2.js";
import { n as resolveAssistantIdentity } from "./assistant-identity-ClQNx0ZS.js";
import { r as resolveVoiceWakeRouteByTrigger, t as loadVoiceWakeRoutingConfig } from "./voicewake-routing-CkT0KfAa.js";
import { t as reactivateCompletedSubagentSession } from "./session-subagent-reactivation-BzEgoYI-.js";
...
async function registerPluginSubagentRunFromGateway(params) {
	...
	const { registerSubagentRun } = await import("./subagent-registry-DtARkSWE.js");
	registerSubagentRun({
		runId: params.runId,
		childSessionKey,
...
const agentHandlers = {
	agent: async ({ params, respond, context, client, isWebchatConnect }) => {
		...
		try {
			...
			if (!isRawModelRun && inputProvenance?.kind !== "inter_session") message = injectTimestamp(message, timestampOptsFromConfig(cfg));
