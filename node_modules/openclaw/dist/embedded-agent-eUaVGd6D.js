...
import { p as resolveUserPath } from "./utils-CFG_gPqL.js";
import { x as freezeDiagnosticTraceContext } from "./diagnostic-events-D6xo_Ohn.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import { r as hasConfiguredModelFallbacks, s as resolveAgentExecutionContract, y as resolveSessionAgentIds } from "./agent-scope-BcYNOCQG.js";
...
import { c as resolveContextConfigProviderForRuntime, i as listOpenAIAuthProfileProvidersForAgentRuntime, n as OPENAI_PROVIDER_ID, r as isOpenAIProvider, u as resolveSelectedOpenAIRuntimeProvider } from "./openai-routing-Bc6sEjDj.js";
...
import { o as resolveContextEngine, s as resolveContextEngineOwnerPluginId } from "./registry-CMq-i5MO.js";
import { s as emitAgentPlanEvent, u as registerAgentRunContext } from "./agent-events-f1e3xUso.js";
import { u as resolveStorePath } from "./paths-Bz9nEaho.js";
import { f as updateSessionStoreEntry } from "./store-D2vwNFZF.js";
import { i as isMarkdownCapableMessageChannel } from "./message-channel-rCegTRAO.js";
import "./sessions-7_zgwGXH.js";
import { t as extractAssistantTextForPhase } from "./chat-message-content-CnGjfPsN.js";
import { a as resolveProviderAuthProfileId } from "./provider-hook-runtime-93YL7Xgt.js";
...
import { n as markAuthProfileSuccess } from "./profiles-CKMjfEZZ.js";
import { o as isProfileInCooldown } from "./usage-state-BKUXV2I8.js";
import { i as resolveAuthProfileOrder, r as resolveAuthProfileEligibility } from "./order-B646U7fZ.js";
import { d as sanitizeRuntimeProviderRequestOverrides, o as resolveProviderRequestConfig } from "./provider-request-config-wvUPb42I.js";
import { t as redactIdentifier } from "./redact-identifier-BQUQ8b3-.js";
import { t as sanitizeForConsole } from "./console-sanitize-BUMxGUp3.js";
import { a as markAuthProfileFailure, s as resolveProfilesUnavailableReason } from "./usage-DqBi7Kf-.js";
import { n as ensureOpenClawModelsJson } from "./models-config-5uq4m8n8.js";
import { t as MissingProviderAuthError } from "./model-auth-runtime-shared-CDjHPu_G.js";
import { a as getApiKeyForModel, g as shouldPreferExplicitConfigApiKeyAuth, n as applyLocalNoAuthHeaderOverride, t as applyAuthHeaderOverride } from "./model-auth-UZfuk32X.js";
import { r as formatRawAssistantErrorForUi } from "./assistant-error-format-CuUvHfKt.js";
import { l as isRawApiErrorPayload, n as formatBillingErrorMessage, o as getApiErrorPayloadFingerprint, t as BILLING_ERROR_USER_MESSAGE, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-lkgL0Nf2.js";
import "./runs-ZDT-yHKC.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyPayloadText } from "./tokens-BpOBzvOi.js";
import { n as derivePromptTokens, o as normalizeUsage } from "./usage-CMHCCi6P.js";
import { t as parseInlineDirectives } from "./directive-tags-Dg-nkHHo.js";
import { n as sleepWithAbort } from "./backoff-DsLoRHnE.js";
import { i as enqueueCommandInLane } from "./command-queue-LbK8r37L.js";
import { C as parseImageDimensionError, a as extractObservedOverflowTokenCount, f as isCompactionFailureError, h as isFailoverErrorMessage, l as isAuthAssistantError, m as isFailoverAssistantError, n as classifyFailoverReason, o as formatAssistantErrorText, s as formatUserFacingAssistantErrorText, u as isBillingAssistantError, v as isLikelyContextOverflowError, w as parseImageSizeError, y as isRateLimitAssistantError } from "./errors-B5i-PbnI.js";
import { a as describeFailoverError, i as coerceToFailoverError, t as FailoverError, u as resolveFailoverStatus } from "./failover-error-BPprEaIb.js";
import { a as hasReplyPayloadContent } from "./payload-CZlThETZ.js";
import { A as resolveEmptyResponseRetryInstruction, B as createEmbeddedRunReplayState, C as createEmbeddedRunStageTracker, D as extractPlanningOnlyPlanDetails, E as STRICT_AGENTIC_BLOCKED_TEXT, F as resolveReplayInvalidFlag, I as resolveRunLivenessState, L as resolveSilentToolResultReplyPayload, M as resolvePlanningOnlyRetryInstruction, N as resolvePlanningOnlyRetryLimit, O as resolveAckExecutionFastPathInstruction, P as resolveReasoningOnlyRetryInstruction, R as shouldRetryMissingAssistantTurn, S as EMBEDDED_RUN_ATTEMPT_DISPATCH_STAGE, T as shouldWarnEmbeddedRunStageSummary, V as observeReplayMetadata, _ as resolveRateLimitProfileRotationLimit, a as RUNTIME_AUTH_REFRESH_MIN_DELAY_MS, b as createUsageAccumulator, c as buildUsageAgentMetaFields, d as resolveActiveErrorContext, f as resolveFinalAssistantRawText, g as resolveOverloadProfileRotationLimit, h as resolveOverloadFailoverBackoffMs, i as RUNTIME_AUTH_REFRESH_MARGIN_MS, j as resolveIncompleteTurnPayloadText, k as resolveAttemptReplayMetadata, l as createCompactionDiagId, m as resolveMaxRunRetryIterations, n as runAgentHarnessAttempt, o as RUNTIME_AUTH_REFRESH_RETRY_MS, p as resolveFinalAssistantVisibleText, r as selectAgentHarness, s as buildErrorAgentMeta, u as isAssistantForModelRef, v as resolveReportedModelRef, w as formatEmbeddedRunStageSummary, x as mergeUsageIntoAccumulator, y as scrubAnthropicRefusalMagic, z as shouldTreatEmptyAssistantReplyAsSilent } from "./selection-DrXxngyT.js";
import { i as createHeartbeatToolResponsePayload } from "./heartbeat-tool-response-Bs6YWghQ.js";
import { d as isStrictAgenticExecutionContractActive } from "./openclaw-tools-ChLzmhJi.js";
import { t as log$1 } from "./logger-Dls9PNjc.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BP451Fk5.js";
import { n as rotateTranscriptFileAfterCompaction, r as shouldRotateCompactionTranscript, s as normalizeContextTokenBudget } from "./compaction-successor-transcript-CUmEvaGX.js";
import { d as retireSessionMcpRuntimeForSessionKey, u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-D9yY5Bw7.js";
import "./agent-bundle-mcp-tools-Cj0bYMPi.js";
import "./tool-split-DUW_5AZX.js";
import { n as resolveProcessToolScopeKey } from "./agent-tools-B9xOi7lj.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-De8Ux2Rx.js";
import { l as hasMessagingToolDeliveryEvidence, u as hasOutboundDeliveryEvidence } from "./subagent-announce-delivery-DhVEJzi6.js";
import { n as resolveGlobalLane, r as resolveSessionLane } from "./lanes-CVttd5qX.js";
import { i as pickFallbackThinkingLevel, s as normalizeTextForComparison } from "./embedded-agent-helpers-CdZv6Xta.js";
import { P as formatToolAggregate } from "./streaming-Cx6Axj9z.js";
import { d as parseReplyDirectives } from "./payloads-BNQsXibr.js";
import { c as suspendSession, d as shouldSuppressRawErrorConsoleSuffix, f as LiveSessionModelSwitchError, l as buildApiErrorObservationFields, m as shouldAllowCooldownProbeForReason, s as resolveSessionSuspensionReason } from "./model-fallback-hP2QoTn4.js";
import { i as resolveStoredSessionKeyForSessionId, r as resolveSessionKeyForRequest } from "./session-B7J3Cdcm.js";
import { i as extractAssistantVisibleText, r as extractAssistantThinking } from "./embedded-agent-utils-BQcyBXno.js";
import { n as resolveModelAsync } from "./model-CxH-pH6G.js";
import { t as ensureContextEnginesInitialized } from "./init-BSq3N1Q2.js";
import { n as resolveEmbeddedCompactionTarget, r as listActiveProcessSessionReferences, t as buildEmbeddedCompactionRuntimeContext } from "./compaction-runtime-context-DBZC2RTG.js";
import { n as isLikelyMutatingToolName } from "./tool-mutation-DD_opp5e.js";
import { a as resolveLiveToolResultMaxChars, c as truncateOversizedToolResultsInSession, o as sessionLikelyHasOversizedToolResults } from "./tool-result-truncation-BaAVFkaU.js";
import { c as resolveCompactionTimeoutMs, o as compactContextEngineWithSafetyTimeout } from "./tool-result-middleware-BT_IFZOo.js";
import "./extra-params-D_aTqTqO.js";
import { m as resolveContextEngineCapabilities, r as forgetPromptBuildDrainCacheForRun } from "./attempt.prompt-helpers-BBjwii9U.js";
import { c as runContextEngineMaintenance } from "./context-engine-lifecycle-fPRxv4bw.js";
import { a as formatContextWindowWarningMessage, i as formatContextWindowBlockMessage, r as evaluateContextWindowGuard, s as resolveContextWindowInfo } from "./context-window-guard-Bduu9uuf.js";
import "./sandbox-info-D4xgUn7r.js";
import { n as runAgentCleanupStep } from "./attempt.tool-run-context-CLJmsaPI.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-ZmJM9hkF.js";
...
import { n as isRecoverableNativeHarnessBindingFailure, t as maybeCompactAgentHarnessSession } from "./compaction-Leb_Cvap.js";
import { t as ensureSelectedAgentHarnessPlugin } from "./runtime-plugin-G2vU8DaW.js";
import { t as ensureRuntimePluginsLoaded } from "./runtime-plugins-BUsPqArp.js";
import { t as DEFERRED_CONTEXT_ENGINE_COMPACTION_REASON } from "./compact-reasons-DERZ3i76.js";
import { n as createAgentHarnessTaskRuntimeScope } from "./agent-harness-task-runtime-scope-Dn0qCAKi.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-D8V2p0a_.js";
import { n as shouldSwitchToLiveModel, t as clearLiveModelSwitchPending } from "./live-model-switch-j2sKWxQm.js";
import { t as buildAgentRuntimeAuthPlan } from "./auth-pPYx5tqb.js";
import { r as buildAgentRuntimePlan } from "./build-BY7vvUlP.js";
import { n as resolveRunWorkspaceDir, t as redactRunIdentifier } from "./workspace-run-yfoV6MdM.js";
...
async function compactEmbeddedAgentSession(params) {
	...
	const harnessResult = attemptNativeHarnessCompaction ? await maybeCompactAgentHarnessSession({
		...params,
		contextEngine,
		contextTokenBudget,
