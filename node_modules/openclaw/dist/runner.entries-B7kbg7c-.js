...
import { n as readResponseWithLimit } from "./read-response-with-limit-CXIgnDwL.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-C60hWKdY.js";
import { t as buildRandomTempFilePath } from "./temp-download-xVIYllO1.js";
import { n as createConfigScopedPromiseLoader } from "./plugin-cache-primitives-DcK62VYf.js";
import { l as resolveEffectivePluginActivationState, n as createPluginActivationSource, s as normalizePluginsConfig } from "./config-state-0SrO5o-9.js";
...
import { i as runExec } from "./exec-BcwfCgxg.js";
import { a as loadManifestContractSnapshot } from "./manifest-contract-eligibility-M1Sun1H3.js";
import { n as resolveBundledPluginCompatibleLoadValues } from "./activation-context-Ch7TVfeX.js";
import { r as fetchWithSsrFGuard } from "./fetch-guard-B8N1GCBS.js";
import { c as kindFromMime, i as getFileExtension, n as detectMime, o as isAudioFileName } from "./mime-n-YFWBtW.js";
import "./local-file-access-CBe_wA_B.js";
import { i as mergeModelProviderRequestOverrides, l as sanitizeConfiguredModelProviderRequest, u as sanitizeConfiguredProviderRequest } from "./provider-request-config-wvUPb42I.js";
import { n as CUSTOM_LOCAL_AUTH_MARKER } from "./model-auth-markers-Br3imLsr.js";
import { a as convertHeicToJpeg } from "./image-ops-BNUtOAql.js";
import { n as estimateBase64DecodedBytes, t as canonicalizeBase64 } from "./base64-ULycPSnu.js";
import { c as runFfmpeg } from "./media-services-_hEj8Smc.js";
import { t as parseMediaContentLength } from "./content-length-DJmVMHoe.js";
import { i as readRemoteMediaBuffer, n as MediaFetchError } from "./fetch-0Ti_Xazz.js";
import { r as mergeInboundPathRoots, t as isInboundPathAllowed } from "./inbound-path-policy-Cb7u7r6V.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-D0HjZuqR.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-A9AWW5N0.js";
import { t as describeImageWithModel } from "./image-runtime-BbCCu-1X.js";
import { c as DEFAULT_VIDEO_MAX_BASE64_BYTES, d as getMediaUnderstandingProvider, l as MIN_AUDIO_FILE_BYTES, n as DEFAULT_MAX_BYTES, s as DEFAULT_TIMEOUT_SECONDS, t as CLI_OUTPUT_MAX_BUFFER } from "./defaults.constants-D76MIP-M.js";
import { c as resolveTimeoutMs, n as resolveMaxBytes, o as resolvePrompt, r as resolveMaxChars } from "./resolve-DcHbK6NY.js";
import { n as providerOperationRetryConfig } from "./operation-retry-BA2ypTwl.js";
import "./temp-path-CCzr4iW8.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BAYb3KkO.js";
import { t as applyTemplate } from "./templating-CLmjS51i.js";
import { i as resolveProxyFetchFromEnv } from "./proxy-fetch-CAV5T1mL.js";
...
async function loadModelAuth() {
	cachedModelAuth ??= await import("./model-auth-BVQXzWCr.js");
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const model = entry.model?.trim() || (await import("./defaults-BEQZ39Tx.js")).resolveDefaultMediaModel({
			cfg,
			providerId,
			capability: "audio",
			workspaceDir: params.workspaceDir
