...
import { c as isRecord, y as truncateUtf16Safe } from "./utils-CFG_gPqL.js";
...
import { c as kindFromMime } from "./mime-n-YFWBtW.js";
import { u as resolveStorePath } from "./paths-Bz9nEaho.js";
import { o as readSessionUpdatedAt, r as getSessionEntry } from "./store-D2vwNFZF.js";
...
import { h as isInsideCode, m as findCodeRegions } from "./assistant-visible-text-BWx-tg5g.js";
import { n as resolveSendPolicy } from "./send-policy-DZpzgiDG.js";
import { i as deliverTextOrMediaReply, m as resolveSendableOutboundReplyParts } from "./reply-payload-JUvJDGAb.js";
import { a as settleReplyDispatcher, t as dispatchInboundMessage } from "./dispatch-Bgs9vXV4.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-CiTBhMnQ.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute } from "./resolve-route-MOedhfPi.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, i as resolveOpenProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-CtUCjpzX.js";
...
import { t as isInboundPathAllowed } from "./inbound-path-policy-Cb7u7r6V.js";
import { n as loadWebMedia } from "./web-media-B4RFpB_P.js";
import { i as resolveHumanDelayConfig } from "./identity-CNVeGBq1.js";
import { c as resolveTextChunkLimit, o as chunkTextWithMode, s as resolveChunkMode } from "./chunk-CRDYS4Jb.js";
...
import { t as convertMarkdownTables } from "./tables-CBzNiAzk.js";
import "./text-chunking-BcNuyNPW.js";
import "./text-utility-runtime-Dw3yQ53Y.js";
import { n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-Dsnaqb-N.js";
import { r as createReplyDispatcherWithTyping } from "./reply-dispatcher.types-bzYiWg6l.js";
import "./routing-DgmMc1xB.js";
import { a as resolveEnvelopeFormatOptions, i as formatInboundFromLabel, r as formatInboundEnvelope } from "./envelope-DCl07AQa.js";
import { E as toInboundMediaFacts, b as filterChannelInboundQuoteContext, y as buildChannelInboundEventContext } from "./kernel-CRhpTSO8.js";
import { t as recordInboundSession } from "./session-Dr9JqhwH.js";
...
import "./transport-ready-runtime-BUQp1Cf0.js";
import { r as normalizeScpRemoteHost } from "./scp-host-Dtc2Ep6p.js";
import "./media-store-CIiBtRFv.js";
...
import { c as createChannelInboundDebouncer, l as shouldDebounceTextInbound } from "./channel-inbound-VeiRhql9.js";
import "./channel-feedback-DfgrCmIQ.js";
...
import { a as resolveIMessageAccount } from "./accounts-CLKCBKB9.js";
import { t as createIMessageRpcClient } from "./client-DO4wMaPb.js";
import { n as imessageRpcSupportsMethod, t as getCachedIMessagePrivateApiStatus } from "./private-api-status-7AvyVySY.js";
import { c as parseIMessageTarget, o as normalizeIMessageHandle, r as isAllowedIMessageReplyContextSender, s as parseIMessageAllowTarget, t as formatIMessageChatTarget } from "./targets-tyiSoI44.js";
import { o as isKnownFromMeIMessageMessageId, s as rememberIMessageReplyCache } from "./monitor-reply-cache-EApDfNs1.js";
import { n as resolveIMessageInboundConversationId, o as probeIMessage, t as sanitizeOutboundText } from "./sanitize-outbound-CQhnzTWS.js";
import { a as extractIMessageApprovalPromptBinding, c as maybeResolveIMessageApprovalReaction, f as resolveIMessageReactionContext, l as registerIMessageApprovalReactionTarget, o as handleIMessageApprovalReaction, s as listPendingIMessageApprovalReactionPollTargets } from "./normalize-1SFQtrTE.js";
import { n as resolveIMessageAttachmentRoots, r as resolveIMessageRemoteAttachmentRoots } from "./media-contract-m52rEXCo.js";
import { a as resolveCatchupConfig, i as performIMessageCatchup, n as advanceIMessageCatchupCursor } from "./catchup-5G0COCkK.js";
import { r as hasPersistedIMessageEcho } from "./persisted-echo-cache-CTPRRTl4.js";
import { t as sendMessageIMessage } from "./send-DFe48NJd.js";
...
function resolveIMessageWatchSourceDbPath(params) {
	if (params.catchupEnabled || params.remoteHost) return;
...
async function monitorIMessageProvider(opts = {}) {
	...
	const watchStartupRowidWatermark = watchSourceDbPath ? await resolveIMessageStartupRowidWatermark(watchSourceDbPath) : null;
	...
	const handleMessage = async (raw) => {
		...
		if (watchStartupRowidWatermark !== null && typeof message.id === "number" && Number.isFinite(message.id) && message.id <= watchStartupRowidWatermark) {
			logVerbose(`imessage: dropping stale watch notification at or before startup rowid account=${accountInfo.accountId}`);
			return;
		}
	...
	for (let attempt = 1; attempt <= WATCH_SUBSCRIBE_MAX_ATTEMPTS; attempt++) {
		...
		try {
			...
			attemptSubscriptionId = (await attemptClient.request("watch.subscribe", {
				...
				...watchStartupRowidWatermark !== null ? { since_rowid: watchStartupRowidWatermark } : {}
