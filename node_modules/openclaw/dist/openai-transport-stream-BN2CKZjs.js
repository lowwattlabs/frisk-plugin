...
import { b as ssrfPolicyFromHttpBaseUrlAllowedOrigin, m as mergeSsrFPolicies, x as ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist } from "./ssrf-DQLCs47S.js";
import { o as withTrustedEnvProxyGuardedFetchMode, r as fetchWithSsrFGuard } from "./fetch-guard-B8N1GCBS.js";
import { F as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-D9JyOweC.js";
...
import { c as resolveProviderRequestPolicyConfig, i as mergeModelProviderRequestOverrides, n as buildProviderRequestDispatcherPolicy, r as getModelProviderRequestTransport } from "./provider-request-config-wvUPb42I.js";
import { t as redactIdentifier } from "./redact-identifier-BQUQ8b3-.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-BWtVPADW.js";
import { o as calculateCost } from "./sanitize-unicode-OHmjpZhP.js";
...
import { l as detectOpenAICompletionsCompat } from "./provider-model-compat-B8SNjjNN.js";
import { t as resolveAzureDeploymentNameFromMap } from "./azure-deployment-map-DoNnsBna.js";
import { i as createReasoningTagTextPartitioner, t as convertMessages } from "./openai-completions-Bn1F8OS2.js";
import { t as clampOpenAIPromptCacheKey } from "./openai-prompt-cache-D8Qty_Hp.js";
import { t as isGemma4ModelId } from "./google-models-BLPkvvgs.js";
import { i as resolveOpenAIStrictToolSetting, n as normalizeOpenAIStrictToolParameters, r as resolveOpenAIStrictToolFlagForInventory, t as findOpenAIStrictToolSchemaDiagnostics } from "./openai-tool-schema-B4TiCBAq.js";
import { r as resolveDebugProxySettings } from "./env-C5R_hDMF.js";
import { g as truncateErrorDetail, h as readResponseTextLimited, t as ProviderHttpError } from "./provider-http-errors-CaOrolH3.js";
import { n as ensureModelProviderLocalService } from "./provider-local-service-xadjtBox.js";
import { n as sanitizeInlineImageDataUrl } from "./inline-image-data-url-DNd2TAbq.js";
import { a as stripSystemPromptCacheBoundary } from "./system-prompt-cache-boundary-tt7CUWva.js";
...
function buildGuardedModelFetch(model, timeoutMs, options) {
	...
	return async (input, init) => {
		...
		if (synthesizeJsonAsSse && options?.sanitizeSse !== false) await assertOpenAISdkStreamContentType({
			response,
			model,
...
function parseXmlAttribute(attributes, name) {
	const match = new RegExp(`\\b${name}=("([^"]*)"|'([^']*)'|([^\\s>]+))`).exec(attributes);
...
function shouldTrustReasoningContentReplayMetadata(model) {
	if (!model.reasoning || isGemma4ModelId(model.id)) return false;
