...
function registerWorkboardCli(params) {
	...
	addGatewayClientOptions(workboard.command("dispatch").description("Promote ready cards and start worker runs through the Gateway").option("--json", "Print JSON", false)).action(async (options) => {
		try {
