...
import { p as resolvePayloadMediaUrls, w as createReplyToFanout, x as sendTextMediaPayload, y as sendPayloadMediaSequenceOrFallback } from "./reply-payload-JUvJDGAb.js";
...
import { p as DiscordError } from "./discord-vgfy3GhQ.js";
import { t as parseDiscordRetryAfterBodySeconds } from "./retry-after-DJY488jL.js";
import { t as chunkDiscordTextWithMode } from "./chunk-BUt4kwpL.js";
import { i as normalizeDiscordOutboundTarget } from "./normalize-veVfIIBj.js";
import { t as createDiscordSendReceipt } from "./send.receipt-BJqZDPUC.js";
import { s as readDiscordComponentSpec } from "./components-z-C7yM61.js";
import { n as notifyDiscordInboundEventOutboundPayloadSuccess } from "./inbound-event-delivery-tuLMYFfq.js";
...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-CA9H4qXZ.js").then((module) => module.sendDiscordComponentMessage);
	return await (await discordComponentSendPromise)(...args);
}
function loadDiscordSharedInteractive() {
	discordSharedInteractivePromise ??= import("./shared-interactive-DrDDtUHs.js");
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BPuDhcwf.js");
