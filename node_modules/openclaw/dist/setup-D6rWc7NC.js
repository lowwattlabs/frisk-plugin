...
import { n as safeParseWithSchema } from "./zod-parse-BcXk7-Ki.js";
import JSON5 from "json5";
import fs from "node:fs/promises";
//#region src/commands/setup.ts
const JsonRecordSchema = record(string(), unknown());
const agentWorkspaceModuleLoader = createLazyImportLoader(() => import("./workspace-CBk_XDOE.js"));
const configIOModuleLoader = createLazyImportLoader(() => import("./config/config.js"));
const configLoggingModuleLoader = createLazyImportLoader(() => import("./logging-DJfxb5zp.js"));
...
async function resolveDefaultSessionTranscriptsDir() {
	const { resolveSessionTranscriptsDir } = await import("./sessions-DT7Qvno9.js");
