...
import { l as redactToolPayloadText } from "./redact-B8nIzFk3.js";
...
import { h as isWindowsDrivePath } from "./archive-CO2Km8eH.js";
import { c as isRecord$1, p as resolveUserPath, y as truncateUtf16Safe } from "./utils-CFG_gPqL.js";
...
import { a as resolveAgentModelTimeoutMsValue, i as resolveAgentModelPrimaryValue, r as resolveAgentModelFallbackValues } from "./model-input-Gsx2piCb.js";
import { o as resolveAgentEffectiveModelPrimary, s as resolveAgentExecutionContract, v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-BcYNOCQG.js";
...
import { n as normalizeAccountId } from "./account-id-By1zn6Bl.js";
import { f as resolveAgentIdFromSessionKey, i as buildAgentMainSessionKey, l as isValidAgentId, t as DEFAULT_AGENT_ID, u as normalizeAgentId, y as toAgentStoreSessionKey } from "./session-key-BOpfMTUN.js";
import { a as resolveAgentDir, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-BoFGd2i9.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-BFPpxZI9.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-CUF3xoIA.js";
import { t as privateFileStore } from "./private-file-store-CKzSdUro.js";
import { a as resolvePluginMetadataSnapshot } from "./plugin-metadata-snapshot-CDfe2bdF.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-BmQMksrF.js";
import { t as logDebug } from "./logger-CuDPuGSa.js";
import { i as getRuntimeConfig, o as parseConfigJson5, y as resolveConfigSnapshotHash } from "./io-AmXZn-TT.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-B_4RUpAv.js";
import { t as getProviderEnvVars } from "./provider-env-vars-D4aVf9o0.js";
...
import { t as parseDurationMs } from "./parse-duration-DCzQczTy.js";
import "./config-Ba5VqNR9.js";
import { n as isRestartEnabled } from "./commands.flags-DlEB68fT.js";
import { n as GATEWAY_CLIENT_IDS, r as GATEWAY_CLIENT_MODES } from "./client-info-BzCrekjX.js";
import { a as callGateway } from "./call-9LwLArZ9.js";
import { r as GatewayClientRequestError } from "./client-BfgBP91A.js";
...
import { r as isAdminOnlyMethod } from "./method-scopes-CooE5VHV.js";
import { p as scheduleGatewaySigusr1Restart } from "./restart-DxnZU_9l.js";
import { i as listAvailableManifestContractValues, n as isManifestPluginAvailableForControlPlane, s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-M1Sun1H3.js";
import { o as normalizeChannelId } from "./registry-snmJh0Ya.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-D4pJ4aKM.js";
import { d as listMediaGenerationProviderModels, f as synthesizeMediaGenerationCatalogEntries } from "./registry-BVye-IRt.js";
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-CI4Tvuwo.js";
import { t as SsrFBlockedError } from "./ssrf-DQLCs47S.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-CBGmN_LW.js";
import { o as resolveContextEngine } from "./registry-CMq-i5MO.js";
import { t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-f1e3xUso.js";
import { a as imageMimeFromFormat, n as detectMime } from "./mime-n-YFWBtW.js";
import { n as assertSandboxPath } from "./sandbox-paths-D0IzFPUM.js";
import "./local-file-access-CBe_wA_B.js";
import { a as toRelativeWorkspacePath, n as resolveWorkspaceRoot, t as normalizeWorkspaceDir } from "./workspace-dir-DBuIUvyj.js";
import { h as stringifyRouteThreadId } from "./channel-route-Cggl4GyH.js";
import { i as mergeDeliveryContext, n as deliveryContextFromSession, o as normalizeDeliveryContext } from "./delivery-context.shared-DQ3Juxwd.js";
import { t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-constants-xBuIaJJT.js";
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-Bz9nEaho.js";
import { j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-X9ls7b1K.js";
import { a as normalizeChannelId$1, i as listChannelPlugins, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-C3m2WQdt.js";
import { n as resolveSessionConversationRef } from "./session-conversation-BccSrkOD.js";
import { d as updateSessionStore } from "./store-D2vwNFZF.js";
import "./plugins-2jPMnXk3.js";
...
import { c as createSessionGoal, f as updateSessionGoalStatus, o as MODEL_UPDATABLE_SESSION_GOAL_STATUSES, u as getSessionGoal } from "./sessions-7_zgwGXH.js";
import { _ as normalizeProviderTransportWithPlugin } from "./provider-runtime-D9JyOweC.js";
import "./auth-profiles-rqlgCONI.js";
import { n as resolveApiKeyForProfile } from "./oauth-sduuRWWS.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CsdRhsMj.js";
import { n as listProfilesForProvider } from "./profile-list-DiPcz2wn.js";
import { i as resolveAuthProfileOrder } from "./order-B646U7fZ.js";
import { i as buildModelAliasIndex, y as resolveModelRefFromString } from "./model-selection-shared-WGXc9fXh.js";
import { n as modelKey } from "./model-ref-shared-Bh0ESsLz.js";
import { a as normalizeModelRef, i as modelKey$1, n as findNormalizedProviderValue } from "./model-selection-normalize-BLLQsO6X.js";
import { n as ensureOpenClawModelsJson } from "./models-config-5uq4m8n8.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog, t as resolveThinkingDefault } from "./model-thinking-default-BnwKbvNv.js";
import { c as resolveDefaultModelForAgent, d as resolvePersistedSelectedModelRef, i as normalizeStoredOverrideModel } from "./model-selection-BKypu26e.js";
import { o as requireApiKey } from "./model-auth-runtime-shared-CDjHPu_G.js";
import { t as stableStringify } from "./stable-stringify-TfJ9A6yH.js";
import { n as loadModelCatalog } from "./model-catalog-BN-bUmfZ.js";
import { d as stripInternalRuntimeContext } from "./internal-runtime-context-hfmw8MFR.js";
import { t as complete } from "./stream-DsNKgWle.js";
import { V as createReadTool, Y as createEditTool, z as createWriteTool } from "./sessions-CHf3LZvU.js";
import { s as getImageMetadata } from "./image-ops-BNUtOAql.js";
import { a as getApiKeyForModel, o as getCustomProviderApiKey } from "./model-auth-UZfuk32X.js";
import { n as isRequesterParentOfBackgroundAcpSession } from "./session-interaction-mode-DLy_8z1t.js";
import { n as hasInboundMetadataSentinel, r as stripInboundMetadata } from "./strip-inbound-meta-VWt31sJ-.js";
import { d as listFreshTasksForOwnerKey, h as listTasksForOwnerKey } from "./task-registry-BRJY2R2w.js";
import { n as extractTextFromChatContent } from "./chat-content-BbLAEXko.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-Dwl2jN25.js";
import "./runtime-internal-C1I_dnJA.js";
import { a as failTaskRunByRunId, c as recordTaskRunProgressByRunId, i as createRunningTaskRun, n as completeTaskRunByRunId } from "./detached-task-runtime-VADcP34g.js";
import { t as resolveRequiredCompletionDeliveryFailureTerminalResult } from "./task-completion-contract-CLQRswVp.js";
import { r as readAcpSessionMeta } from "./session-meta-DmjSKzYK.js";
import { r as normalizeCronJobPatch, t as normalizeCronJobCreate } from "./normalize-pobeoxGa.js";
import { g as resolveActiveEmbeddedRunSessionId, i as formatEmbeddedAgentQueueFailureSummary, p as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-ZDT-yHKC.js";
import { n as capArrayByJsonBytes, p as readSessionTitleFieldsFromTranscriptAsync } from "./session-utils.fs-FlJCaQFx.js";
import { r as jsonUtf8Bytes } from "./json-utf8-bytes-BBYnCgMh.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-3lgzT57B.js";
import { t as resolveModelAgentRuntimeMetadata } from "./agent-runtime-metadata-SecQANSF.js";
import { n as discoverModels, t as discoverAuthStorage } from "./agent-model-discovery-CPBhXINp.js";
import { V as resolveSubagentRunTimerDelayMs } from "./subagent-registry-state-CBt8mivm.js";
import { f as pruneLegacyStoreKeys, g as resolveGatewaySessionStoreTarget, r as deriveSessionTitle, y as resolveSessionModelIdentityRef } from "./session-utils-BLUgAqaB.js";
import { d as writeRestartSentinel, r as formatDoctorNonInteractiveHint, s as removeRestartSentinelFile, t as buildRestartSuccessContinuation } from "./restart-sentinel-D3lYdtMW.js";
import { S as describeUpdatePlanTool, _ as describeSessionStatusTool, b as describeSessionsSendTool, d as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY, f as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, g as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, h as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, m as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, p as SESSIONS_SPAWN_SUBAGENT_TOOL_DISPLAY_SUMMARY, s as CRON_TOOL_DISPLAY_SUMMARY, u as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, v as describeSessionsHistoryTool, x as describeSessionsSpawnTool, y as describeSessionsListTool } from "./tool-catalog-D5QsrL1H.js";
import "./tool-policy-K2Xr4lej.js";
import { n as isToolAllowedByPolicyName } from "./tool-policy-match-B8YPWGDv.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-D11nb3Jt.js";
import { n as getSessionBindingService } from "./session-binding-service-eLc0_un9.js";
import { a as hasReplyPayloadContent } from "./payload-CZlThETZ.js";
import { a as resolveSubagentCapabilities, c as findAcpUnsupportedInheritedToolAllow, d as formatAcpInheritedToolDenyError, f as inheritedToolAllowPatch, h as normalizeInheritedToolDenylist, l as findAcpUnsupportedInheritedToolDeny, m as normalizeInheritedToolAllowlist, p as inheritedToolDenyPatch, s as getSubagentDepthFromSessionStore, u as formatAcpInheritedToolAllowError } from "./subagent-capabilities-CwtfDvdi.js";
import { t as isAcpRuntimeSpawnAvailable } from "./availability-Ccnm968o.js";
import { n as HEARTBEAT_TOOL_OUTCOMES, o as normalizeHeartbeatToolResponse, r as HEARTBEAT_TOOL_PRIORITIES, t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Bs6YWghQ.js";
import { t as canonicalizeBase64 } from "./base64-ULycPSnu.js";
import { a as manifestProviderBaseUrlGuardPasses, i as manifestPluginSetupProviderEnvVars, n as hasNonEmptyManifestEnvCandidate, r as manifestConfigSignalPasses } from "./manifest-tool-availability-Bl_stVVp.js";
import { a as resolvePluginTools } from "./tools-RrdXLseQ.js";
import { d as retireSessionMcpRuntimeForSessionKey } from "./agent-bundle-mcp-runtime-D9yY5Bw7.js";
import "./agent-bundle-mcp-tools-Cj0bYMPi.js";
import { D as listAllChannelSupportedActions, _ as wrapToolWithBeforeToolCallHook, k as listChannelSupportedActions, u as isToolWrappedWithBeforeToolCallHook } from "./agent-tools.before-tool-call-CDXSxqiL.js";
import { i as listCrossChannelSchemaSupportedMessageActions, n as channelSupportsMessageCapabilityForChannel, o as resolveChannelMessageToolSchemaProperties, t as channelSupportsMessageCapability } from "./message-action-discovery-D7tPA6lO.js";
...
import "./media-services-_hEj8Smc.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-B1anI66H.js";
import { r as sanitizeToolResultImages } from "./tool-images-BO1Itut2.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-maGHz7cj.js";
import { c as getToolParamsRecord, d as wrapToolParamValidation, l as stripMalformedXmlArgValueSuffix, n as resolveNode, o as REQUIRED_PARAM_GROUPS, r as resolveNodeId, s as assertRequiredParams, u as stripMalformedXmlArgValueSuffixFromKeys } from "./nodes-utils-C7t-bOVx.js";
import { a as optionalPositiveIntegerSchema, i as optionalNonNegativeIntegerSchema, n as channelTargetsSchema, o as optionalStringEnum, r as optionalFiniteNumberSchema, s as stringEnum, t as channelTargetSchema } from "./typebox-CWrBnvir.js";
import "./delivery-context-Cm-3AUIL.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-BgXXPpNN.js";
import { r as getActiveSecretsRuntimeConfigSnapshot } from "./runtime-state-LK_7s91k.js";
import { n as createTranscriptsTool, r as resolveTranscriptsConfig } from "./transcripts-tool-d-SS71DV.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-De8Ux2Rx.js";
import { a as resolveRequesterOriginForChild, d as resolveSubagentTargetPolicy, l as resolveSpawnedWorkspaceInheritance, n as resolveSubagentModelAndThinkingPlan, o as mapToolContextToSpawnedRunMetadata, r as splitModelRef, s as normalizeSpawnedRunMetadata, t as resolveConfiguredSubagentRunTimeoutSeconds, u as resolveSubagentAllowedTargetIds } from "./subagent-spawn-plan-CFUna7Th.js";
import { i as createSessionVisibilityRowChecker, o as resolveEffectiveSessionToolsVisibility, r as createSessionVisibilityGuard, t as createAgentToAgentPolicy } from "./session-visibility-ztQqgLnY.js";
import { a as resolveCurrentSessionClientAlias, c as resolveMainSessionAlias, d as shouldResolveSessionIdInput, i as resolveSandboxedSessionToolContext, l as resolveSessionReference, n as deriveChannel, o as resolveDisplaySessionKey, r as resolveSessionToolContext, s as resolveInternalSessionKey, t as classifySessionKind, u as resolveVisibleSessionReference } from "./sessions-helpers-BHxfvpmm.js";
import { r as stripToolMessages } from "./chat-history-text-Ba-9NCEO.js";
import { t as resolveCronCreationDelivery } from "./delivery-context-CAEYswe7.js";
import { t as assertCronDeliveryInputNonBlankFields } from "./delivery-target-validation-rI-6HP-3.js";
import { t as normalizeHttpWebhookUrl } from "./webhook-url-DWxLEr-i.js";
import { t as collectEnabledInsecureOrDangerousFlags } from "./dangerous-config-flags-B-1JDB4J.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BSKslun2.js";
import { a as recordCapabilityCandidateFailure, f as throwCapabilityGenerationFailure, h as resolveCapabilityModelRefForProviders, i as normalizeDurationToClosestMax, m as findCapabilityProviderById, n as buildNoCapabilityModelConfiguredMessage, o as resolveCapabilityModelCandidates, p as hasMediaNormalizationEntry, t as buildMediaGenerationNormalizationMetadata } from "./runtime-shared-BpMu8uPo.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-B6AWfJ04.js";
import { t as loadCapabilityManifestSnapshot } from "./capability-provider-runtime-kzHPFTZS.js";
import { n as resolveConfiguredMediaMaxBytes, r as resolveGeneratedMediaMaxBytes } from "./configured-max-bytes-D-t8zkAL.js";
import { u as saveMediaBuffer } from "./store-LFm8rX8c.js";
import { n as classifyMediaReferenceSource, r as normalizeMediaReferenceSource } from "./media-reference-CpElDB5_.js";
import { i as normalizeInboundPathRoots } from "./inbound-path-policy-Cb7u7r6V.js";
import { r as getDefaultLocalRoots } from "./local-media-access-B9KUpMtO.js";
import { n as loadWebMedia, r as loadWebMediaRaw } from "./web-media-B4RFpB_P.js";
import { g as formatAgentInternalEventsForPrompt, i as loadSessionEntryByKey, t as deliverSubagentAnnouncement, v as formatGeneratedAttachmentLines, y as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-DhVEJzi6.js";
import { r as routeToDeliveryFields, t as routeFromBindingRecord } from "./route-projection-CVm9TTu5.js";
import { n as resolveChannelInboundAttachmentRootsForChannel } from "./channel-inbound-roots-CBohQ9f8.js";
import { a as hasProviderAuthForTool, n as coerceToolModelConfig, o as hasToolModelConfig$1, r as hasAuthForProvider, s as resolveDefaultModelRef, t as buildToolModelConfigFromCandidates } from "./model-config.helpers-DxUWEX--.js";
import { a as runWithImageModelFallback, n as resolveImageFallbackCandidates, r as resolveImageFallbackDefaultProvider } from "./model-fallback-hP2QoTn4.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-BT3tPkfp.js";
import { n as extractAssistantText } from "./embedded-agent-utils-BQcyBXno.js";
import { n as isMinimaxVlmProvider } from "./minimax-vlm-CPYJjmI9.js";
import { a as resolveConfiguredImageModelRefs, n as coerceImageModelConfig, o as resolveProviderVisionModelFromConfig, r as decodeDataUrl } from "./image-tool.helpers-Ciu0_H-L.js";
import { n as normalizeMediaProviderId } from "./provider-id-A9AWW5N0.js";
import { i as resolveDocumentMediaModel, n as resolveAutoMediaKeyProviders, r as resolveDefaultMediaModel, t as providerSupportsNativePdfDocument } from "./defaults-CAUNc9-r.js";
import { r as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-BbCCu-1X.js";
import { d as getMediaUnderstandingProvider, s as DEFAULT_TIMEOUT_SECONDS, u as buildMediaUnderstandingRegistry } from "./defaults.constants-D76MIP-M.js";
import { t as matchesMediaEntryCapability } from "./entry-capabilities-CafsAsmp.js";
import { c as resolveTimeoutMs } from "./resolve-DcHbK6NY.js";
import "./media-understanding-6uGMsVYQ.js";
import { a as resolveBundledStaticCatalogModel, i as bundledStaticCatalogProviderUsesRuntimeAugment, n as resolveModelAsync } from "./model-CxH-pH6G.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BLYuePHK.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-0T3nBYf-.js";
import { d as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-RagBiOB3.js";
import { a as POLL_CREATION_PARAM_DEFS, c as parseJsonMessageParam, i as stripFormattedReasoningMessage, n as runMessageAction, o as SHARED_POLL_CREATION_PARAM_NAMES, r as resolveAllowedMessageActions, s as parseInteractiveParam, t as getToolResult } from "./message-action-runner-BiT3I6n2.js";
import { n as listMusicGenerationProviders, r as parseMusicGenerationModelRef, t as getMusicGenerationProvider } from "./provider-registry-i3OOrjl6.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-BV3lN8MO.js";
import { a as parseCameraClipPayload, c as writeCameraPayloadToFile, i as cameraTempPath, n as screenRecordTempPath, o as parseCameraSnapPayload, r as writeScreenRecordToFile, s as writeCameraClipPayloadToFile, t as parseScreenRecordPayload } from "./nodes-screen-VgUcb_qw.js";
import { T as resolveEnabledBundledManifestContractPlugins, w as extractPdfContent } from "./runner.entries-B7kbg7c-.js";
import { c as resolveAnthropicMessagesUrl } from "./provider-stream-Crs84j2E.js";
import { t as triggerSessionPatchHook } from "./session-patch-hooks-gWFufzVo.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-f472QJN_.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-BkLWhqIh.js";
import { n as createModelVisibilityPolicy } from "./model-visibility-policy-B32YV-8G.js";
import { i as resolveNestedAgentLaneForSession, t as AGENT_LANE_SUBAGENT } from "./lanes-ReZ09_e4.js";
import { a as waitForAgentRunAndReadUpdatedAssistantReply, i as waitForAgentRun, r as readLatestAssistantReplySnapshot } from "./run-wait-_x7v1MpM.js";
import { f as ANNOUNCE_SKIP_TOKEN, g as isReplySkip, h as isNonDeliverableSessionsReply, m as isAnnounceSkip, p as REPLY_SKIP_TOKEN } from "./subagent-session-cleanup-DFJj9W5n.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, f as supportsAutomaticThreadBindingSpawn, n as formatThreadBindingSpawnDisabledError, o as resolveThreadBindingIdleTimeoutMsForChannel, t as formatThreadBindingDisabledError, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bcq9PRwO.js";
import { h as registerSubagentRun, i as countActiveRunsForSession } from "./subagent-registry-dq-LC-2-.js";
import { t as emitSessionLifecycleEvent } from "./session-lifecycle-events-CrY3-yco.js";
import { r as resolveInboundConversationResolution, t as resolveChannelDefaultBindingPlacement } from "./conversation-resolution-CV_8jox6.js";
import { i as resolveThreadBindingThreadName, r as resolveThreadBindingIntroText } from "./thread-bindings-messages-DJW4AiWY.js";
import { n as resolveParentForkDecision, t as forkSessionFromParent } from "./session-fork-CpYRjPHb.js";
import { t as ensureContextEnginesInitialized } from "./init-BSq3N1Q2.js";
import { t as buildSubagentSystemPrompt } from "./subagent-system-prompt-DD9G2N-M.js";
import { a as proposeUpdateSkill, d as reviseSkillProposal, i as proposeCreateSkill, l as rejectSkillProposal, n as inspectSkillProposal, o as quarantineSkillProposal, r as listSkillProposals, t as applySkillProposal, u as resolvePendingSkillProposal } from "./service-yYn6i75I.js";
import { n as buildSubagentList } from "./subagent-list-C7O1Jin1.js";
import { a as listControlledSubagentRuns, o as resolveSubagentController, t as MAX_RECENT_MINUTES } from "./subagent-control-DwbbZUbD.js";
import { a as wrapWebContent, i as wrapExternalContent } from "./external-content-BdbdWtKm.js";
import { k as textToSpeech } from "./tts-runtime-CRnu1vgI.js";
import "./tts-BxWPQUPI.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-jXeLnizv.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-BV_zw_UW.js";
import { i as resolveWebProviderConfig } from "./provider-runtime-shared-Da_3Al2P.js";
import { a as truncateText$1, n as htmlToMarkdown, r as markdownToText, t as extractBasicHtmlContent } from "./web-fetch-utils-CBjzg2Gn.js";
import { a as readResponseText, c as resolveTimeoutSeconds, i as readCache, o as resolveCacheTtlMs, r as normalizeCacheKey, u as writeCache } from "./web-shared-DkAjzoqT.js";
import { i as runWebSearch } from "./runtime-C6RIaGHP.js";
import "./web-search-provider-common-BBAwXplM.js";
...
function createCronPayloadSchema() {
	return Type.Optional(cronPayloadObjectSchema({ toolsAllow: Type.Optional(Type.Array(Type.String(), { description: "Allowed tools" })) }));
}
...
async function tryDeliverMediaGenerationDirect(params) {
	...
	try {
		const { sendMessage } = await import("./task-registry-delivery-runtime-CEu6EJTV.js");
		await sendMessage({
			cfg: params.config,
...
async function loadImageWebMediaRuntime() {
	return await import("./web-media-DO93ZmGP.js");
}
...
let agentStepDeps = {
	agentCommandFromIngress: (async (...args) => {
		const { agentCommandFromIngress } = await import("./agent-Dk-C0Y52.js");
...
async function callGatewayLazy(opts) {
	const { callGateway } = await import("./call-Blf_Okhs.js");
...
const acpSpawnModuleLoader = createLazyImportLoader(() => import("./acp-spawn-D2FLewZA.js"));
...
const webGuardedFetchLoader = createLazyImportLoader(() => import("./web-guarded-fetch-6wJVlNQZ.js"));
