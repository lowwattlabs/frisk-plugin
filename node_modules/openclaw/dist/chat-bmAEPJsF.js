...
import { l as asPositiveSafeInteger, s as asFiniteNumber } from "./number-coercion-CJQ8TR--.js";
...
import { v as resolveSessionAgentId } from "./agent-scope-BcYNOCQG.js";
import { c as parseAgentSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { g as scopeLegacySessionKeyToAgent, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BoFGd2i9.js";
import { l as measureDiagnosticsTimelineSpan, s as emitDiagnosticsTimelineEvent, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-CDfe2bdF.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-B_4RUpAv.js";
import { a as hasGatewayClientCap, i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES, t as GATEWAY_CLIENT_CAPS } from "./client-info-BzCrekjX.js";
...
import { t as isPassThroughRemoteMediaSource } from "./media-source-url-hjqZhmYb.js";
import "./local-file-access-CBe_wA_B.js";
import { i as resolveSessionStoreKey } from "./session-store-key-BxTZ7QhH.js";
import { n as deliveryContextFromSession } from "./delivery-context.shared-DQ3Juxwd.js";
...
import { i as resolveSessionFilePath } from "./paths-Bz9nEaho.js";
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient } from "./message-channel-rCegTRAO.js";
...
import { a as readRecentSessionMessagesWithStatsAsync, c as readSessionMessageByIdAsync, g as stripEnvelopeFromMessage, h as readSessionTranscriptIndex, i as readRecentSessionMessagesAsync, n as capArrayByJsonBytes, t as attachOpenClawTranscriptMeta, u as readSessionMessagesAsync } from "./session-utils.fs-FlJCaQFx.js";
import { r as jsonUtf8Bytes } from "./json-utf8-bytes-BBYnCgMh.js";
import { s as normalizeInputProvenance } from "./input-provenance-3lgzT57B.js";
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Dg-nkHHo.js";
import { a as getSessionDefaults, b as resolveSessionModelRef, h as resolveGatewayModelSupportsImages, o as listAgentsForGateway, p as resolveDeletedAgentIdFromSessionKey, t as buildGatewaySessionInfo, u as loadSessionEntry } from "./session-utils-BLUgAqaB.js";
...
import { t as dispatchInboundMessage } from "./dispatch-Bgs9vXV4.js";
import { n as estimateBase64DecodedBytes } from "./base64-ULycPSnu.js";
import { r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-BsQfWDIB.js";
import { i as deleteMediaBuffer, t as MEDIA_MAX_BYTES, u as saveMediaBuffer } from "./store-LFm8rX8c.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-D0HjZuqR.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-B9KUpMtO.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-BNQsXibr.js";
import { C as validateChatMessageGetParams, Ki as ErrorCodes, S as validateChatInjectParams, T as validateChatSendParams, qi as errorShape, t as formatValidationErrors, x as validateChatHistoryParams, y as validateChatAbortParams } from "./src-CgoRVpph.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-CFpWuVFY.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CYUBq3RH.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-Xif5zAc6.js";
import { s as augmentChatHistoryWithCliSessionImports } from "./attempt-execution.helpers-DqLxRxXa.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CSGqf518.js";
import { n as createReplyDispatcher } from "./reply-dispatcher.types-bzYiWg6l.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-lOMF8eR0.js";
import { a as isChatStopCommandText, c as resolveInFlightRunSnapshot, i as boundInFlightRunSnapshotForChatHistory, l as updateChatRunProvider, o as registerChatAbortController, t as abortChatRunById } from "./chat-abort-BipmFF4B.js";
...
import { t as logLargePayload } from "./diagnostic-payload-UBYebn4S.js";
import { a as MAX_PAYLOAD_BYTES, c as getMaxChatHistoryMessagesBytes } from "./server-constants-BGwLM6XN.js";
import { t as formatForLog } from "./ws-log-Bs-rCRVj.js";
import { a as projectRecentChatDisplayMessages, i as projectChatDisplayMessages, n as isToolHistoryBlockType, o as resolveEffectiveChatHistoryMaxChars, r as projectChatDisplayMessage } from "./chat-display-projection-CMTVNdR4.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-Cz_1HIO3.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-BQ1pjbLf.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-DJBm1f38.js";
import { n as timestampOptsFromConfig, t as injectTimestamp } from "./agent-timestamp-B2uOkBdP.js";
import { n as setGatewayDedupeEntry } from "./agent-wait-dedupe-zH9EMnN2.js";
import { t as loadOptionalServerMethodModelCatalog } from "./optional-model-catalog-BuZ9XtNq.js";
...
async function handleChatHistoryRequest({ params, respond, context, method, includeAgentsList }) {
	...
	const modelCatalog = await measureDiagnosticsTimelineSpan(`gateway.${method}.model_catalog`, () => loadOptionalServerMethodModelCatalog(context, method), {
		config: cfg,
		phase: method
	});
			...
			measureDiagnosticsTimelineSpan("gateway.chat_send.dispatch_inbound", async () => {
				...
				await measureDiagnosticsTimelineSpan("gateway.chat_send.post_dispatch", async () => {
					...
					if (!agentRunStarted) {
						...
						const sourceReplyPayloads = deliveredReplies.filter((entryEntry) => entryEntry.kind === "final").map((entryResult) => entryResult.payload).filter(isSourceReplyTranscriptMirrorPayload);
...
//#endregion
export { dropPreSessionStartAnnouncePairs as a, sanitizeChatSendMessageInput as c, buildSessionHistorySnapshot as d, resolveSessionHistoryTailReadOptions as f, chatHandlers as i, hasTrackedActiveSessionRun as l, augmentChatHistoryWithCanvasBlocks as n, enforceChatHistoryFinalBudget as o, buildOversizedHistoryPlaceholder as r, replaceOversizedChatHistoryMessages as s, CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES as t, SessionHistorySseState as u };
