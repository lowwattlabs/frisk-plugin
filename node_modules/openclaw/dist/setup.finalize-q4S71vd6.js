...
import { p as resolveUserPath, u as pathExists } from "./utils-CFG_gPqL.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-QBWwaRhw.js";
import { o as isSystemdUserServiceAvailable } from "./systemd-WVwWBU0G.js";
...
import { n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-DVU_odQG.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-D96rgQHr.js";
import { i as hasAuthProfileForProvider } from "./model-config.helpers-DxUWEX--.js";
import { n as listConfiguredWebSearchProviders } from "./runtime-C6RIaGHP.js";
import { a as installCompletion, i as formatCompletionReloadCommand, l as resolveCompletionProfilePath } from "./completion-runtime-DPlUXKJ5.js";
...
import { n as openUrl, t as detectBrowserOpenSupport } from "./browser-open-oQjG3E1N.js";
import { i as formatControlUiSshHint, m as waitForGatewayReachable, u as probeGatewayReachable } from "./onboard-helpers-Cevaj40Q.js";
...
function loadOnboardSearchModule() {
	onboardSearchModulePromise ??= import("./onboard-search-BZ1jzU-B.js");
...
async function finalizeSetupWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-Btocneod.js");
