...
import { n as shouldEagerRegisterSubcommands } from "./command-registration-policy-DeS25d8_.js";
import { t as addGatewayClientOptions } from "./gateway-rpc-CXxcUWGi.js";
import { t as formatHelpExamples } from "./help-format-CBGqVsX5.js";
import { i as registerCommandGroups } from "./register-command-groups-B7kGANQE.js";
import "./cli-runtime-C8RTrvVL.js";
import "./core-api-BoVTANpF.js";
...
const browserCommandGroupDefinitions = [
	{
		...
		register: async (args) => {
			(await import("./browser-cli-manage-BqwbqFsd.js")).registerBrowserManageCommands(args.browser, args.parentOpts);
		}
	},
	{
		...
		register: async (args) => {
			(await import("./browser-cli-inspect-Tw-5N_5N.js")).registerBrowserInspectCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-input-BsOcyIz1.js")).registerBrowserActionInputCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-actions-observe-CQSbZD2m.js")).registerBrowserActionObserveCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-debug-BFHQm8w3.js")).registerBrowserDebugCommands(args.browser, args.parentOpts);
		}
	},
	{
		placeholders: [
		...
		register: async (args) => {
			(await import("./browser-cli-state-Dc-B4mky.js")).registerBrowserStateCommands(args.browser, args.parentOpts);
		}
	}
];
