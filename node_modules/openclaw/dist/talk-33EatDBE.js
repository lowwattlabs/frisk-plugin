...
import { i as resolveActiveTalkProviderConfig, r as normalizeTalkSection, t as buildTalkConfigResponse } from "./talk-Bbheu2kt.js";
import "./config-Ba5VqNR9.js";
import { a as TALK_SECRETS_SCOPE, t as ADMIN_SCOPE } from "./operator-scopes-CS3xdS-V.js";
import { a as providerMatchesId, i as getVoiceProviderConfig, s as resolveSupportedVoiceModelRefs } from "./registry-BVye-IRt.js";
import { n as redactConfigObject } from "./redact-snapshot-CvCLe6ow.js";
import { Cn as validateTalkClientCreateParams, En as validateTalkClientToolCallParams, Fn as validateTalkSessionCloseParams, Gn as validateTalkSpeakParams, Hn as validateTalkSessionSubmitToolResultParams, In as validateTalkSessionCreateParams, Ki as ErrorCodes, Mn as validateTalkSessionAppendAudioParams, Nn as validateTalkSessionCancelOutputParams, On as validateTalkConfigParams, Pn as validateTalkSessionCancelTurnParams, Rn as validateTalkSessionJoinParams, Tn as validateTalkClientSteerParams, Un as validateTalkSessionTurnParams, Vn as validateTalkSessionSteerParams, jn as validateTalkModeParams, qi as errorShape, t as formatValidationErrors, xn as validateTalkCatalogParams } from "./src-CgoRVpph.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DNMy_uGh.js";
import { D as synthesizeSpeech, M as withSpeakerSelectionCompat, N as withSpeakerSelectionFallbackCompat, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig } from "./tts-runtime-CRnu1vgI.js";
import "./tts-BxWPQUPI.js";
import { t as abortChatRunById } from "./chat-abort-BipmFF4B.js";
import { t as formatForLog } from "./ws-log-Bs-rCRVj.js";
import { r as listRealtimeTranscriptionProviders } from "./provider-registry-B9LnLSmL.js";
import { A as buildRealtimeVoiceAgentConsultWorkingResponse, C as shouldAutoControlRealtimeVoiceAgentText, D as buildRealtimeVoiceAgentConsultChatMessage, H as createTalkSessionController, L as createRealtimeVoiceForcedConsultCoordinator, Q as REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ, T as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, V as readSpeakableRealtimeVoiceToolResult, W as recordTalkObservabilityEvent, c as resolveConfiguredRealtimeVoiceProvider, d as listRealtimeVoiceProviders, g as REALTIME_VOICE_AGENT_CONTROL_TOOL_NAME, h as REALTIME_VOICE_AGENT_CONTROL_TOOL, i as isLikelyRealtimeVoiceAssistantEchoTranscript, l as canonicalizeRealtimeVoiceProviderId, o as recordRealtimeVoiceTranscript, p as controlRealtimeVoiceAgentRun, s as createRealtimeVoiceBridgeSession, v as buildRealtimeVoiceAgentControlSpeechMessage, w as REALTIME_VOICE_AGENT_CONSULT_TOOL } from "./session-log-runtime-0O2WPUie.js";
import { i as chatHandlers } from "./chat-bmAEPJsF.js";
import { t as resolveSessionKeyFromResolveParams } from "./sessions-resolve-9TLd7NuC.js";
