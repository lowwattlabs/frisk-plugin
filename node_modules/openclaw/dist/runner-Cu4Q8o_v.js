...
import { i as buildModelAliasIndex, l as inferUniqueProviderFromConfiguredModels, y as resolveModelRefFromString } from "./model-selection-shared-WGXc9fXh.js";
import { c as resolveDefaultModelForAgent } from "./model-selection-BKypu26e.js";
import { r as mergeInboundPathRoots } from "./inbound-path-policy-Cb7u7r6V.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-D0HjZuqR.js";
import { t as resolveChannelInboundAttachmentRoots } from "./channel-inbound-roots-CBohQ9f8.js";
import { n as isMinimaxVlmProvider, t as isMinimaxVlmModel } from "./minimax-vlm-CPYJjmI9.js";
import { n as normalizeMediaProviderId, t as normalizeMediaExecutionProviderId } from "./provider-id-A9AWW5N0.js";
import { d as getMediaUnderstandingProvider, u as buildMediaUnderstandingRegistry } from "./defaults.constants-D76MIP-M.js";
import { t as providerSupportsCapability } from "./provider-supports-Cl4QwVMy.js";
import { a as resolveModelEntries, s as resolveScopeDecision } from "./resolve-DcHbK6NY.js";
import { S as normalizeAttachments, _ as fileExists, a as runCliEntry, b as selectAttachments, o as runProviderEntry, r as formatDecisionSummary, t as buildModelDecision, v as MediaAttachmentCache, y as isMediaUnderstandingSkipError } from "./runner.entries-B7kbg7c-.js";
...
async function loadModelCatalogApi() {
	cachedModelCatalogApi ??= await import("./model-catalog-D0ccNE56.js");
...
async function hasProviderAuthAvailable(params) {
	...
	cachedHasAvailableAuthForProvider ??= (await import("./model-auth-BVQXzWCr.js")).hasAvailableAuthForProvider;
...
async function resolveAutoImageModelId(params) {
	...
	const { resolveDefaultMediaModel } = await import("./defaults-BEQZ39Tx.js");
