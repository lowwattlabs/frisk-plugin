...
import { s as hasConfiguredSecretInput } from "./types.secrets-BEnNl80Y.js";
...
import { i as resolveSessionFilePath, u as resolveStorePath } from "./paths-Bz9nEaho.js";
...
import { i as createActionGate } from "./common-CQZwSsYR.js";
import { i as createHybridChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-Q5p9ejlB.js";
...
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-yU1EBN6I.js";
...
import { E as projectConfigAccountIdWarningCollector, g as createAllowlistProviderGroupPolicyWarningCollector } from "./channel-policy-DLbIVuEn.js";
...
import { D as patchTopLevelChannelConfigSection, P as promptSingleChannelSecretInput, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-aMuEtwAz.js";
...
import "./account-resolution-BiVDai4U.js";
import { t as PAIRING_APPROVED_MESSAGE } from "./pairing-message-C9w9gv4K.js";
import { d as createDefaultChannelRuntimeState, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Bw3y4bRG.js";
import "./channel-status-D86kmK7E.js";
import "./channel-config-primitives-DyQQ3UsW.js";
...
import { a as resolveDefaultFeishuAccountId, i as listFeishuAccountIds, l as resolveFeishuRuntimeAccount, m as isRecord$1, n as inspectFeishuCredentials, r as listEnabledFeishuAccounts, s as resolveFeishuAccount } from "./accounts-5oFpJVZc.js";
import { n as looksLikeFeishuId, r as normalizeFeishuTarget } from "./targets-D3OBd-RR.js";
import { n as createFeishuSendReceipt } from "./send-result-BSFS2uQ8.js";
import { a as parseFeishuTargetId, i as parseFeishuDirectConversationId, n as buildFeishuModelOverrideParentCandidates, r as parseFeishuConversationId, t as buildFeishuConversationId } from "./conversation-id-D-F6YvRp.js";
import { i as listFeishuDirectoryPeers, r as listFeishuDirectoryGroups, t as buildFeishuPresentationCard } from "./presentation-card-25hmPy6G.js";
import { t as messageActionTargetAliases } from "./security-audit-COq8TfI9.js";
import { s as resolveFeishuGroupToolPolicy } from "./policy-b3HM-Vvq.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-B2uOT7Cu.js";
import { t as collectFeishuSecurityAuditFindings } from "./security-audit-shared-BWMy5xey.js";
import { t as resolveFeishuSessionConversation } from "./session-conversation-Bwnw9oIx.js";
...
const loadAppRegistrationModule = async () => {
	appRegistrationModulePromise ??= import("./app-registration-BYoPdXJ2.js");
	...
	status: {
		...
		resolveStatusLines: async ({ cfg, accountId, configured }) => {
			...
			if (configured && account.configured) try {
				const { probeFeishu } = await import("./probe-D_x3Talp.js");
...
const loadFeishuChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-CoIEEqge.js"), "feishuChannelRuntime");
...
async function createFeishuActionClient(account) {
	const { createFeishuClient } = await import("./client-C4VUPlSy.js");
...
const feishuPlugin = createChatChannelPlugin({
	base: {
		...
		gateway: { startAccount: async (ctx) => {
			const { monitorFeishuProvider } = await import("./monitor-CPFhS4lH.js");
