...
import "./gpt5-prompt-overlay-Di2rFi7G.js";
import "./provider-attribution-BQdzaGfN.js";
import { a as normalizeModelCompat } from "./provider-model-compat-B8SNjjNN.js";
import "./moonshot-thinking-DB1L4dZN.js";
...
const CLAUDE_OPUS_48_MODEL_PREFIXES = ["claude-opus-4-8", "claude-opus-4.8"];
...
function isClaudeOpus48ModelId(modelId) {
...
function resolveClaudeThinkingProfile(modelId) {
	if (isClaudeOpus48ModelId(modelId)) return {
		levels: [
