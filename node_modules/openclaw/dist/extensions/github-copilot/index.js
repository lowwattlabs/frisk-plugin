...
import { i as getCachedLiveCatalogValue } from "../../provider-catalog-shared-D5pfdNmi.js";
import { n as fetchCopilotModelCatalog, r as resolveCopilotForwardCompatModel, t as PROVIDER_ID } from "../../models-CyhHcedz.js";
import { t as resolveFirstGithubToken } from "../../auth-CszwGGiL.js";
import { t as githubCopilotMemoryEmbeddingProviderAdapter } from "../../embeddings-BumHxwqJ.js";
import { t as buildGithubCopilotReplayPolicy } from "../../replay-policy-BCJdebGN.js";
import { o as wrapCopilotProviderStream } from "../../stream-CkZCip-_.js";
...
function compatSupportsXHigh(compat) {
	return Array.isArray(compat?.supportedReasoningEfforts) && compat.supportedReasoningEfforts.some((effort) => normalizeOptionalLowercaseString(effort) === "xhigh");
}
		...
		api.registerProvider({
			...
			resolveThinkingProfile: ({ modelId, compat }) => {
				return { levels: [
					...
					{ id: "medium" },
					{ id: "high" },
					...COPILOT_XHIGH_MODEL_IDS.includes(normalizeOptionalLowercaseString(modelId) ?? "") || compatSupportsXHigh(compat) ? [{ id: "xhigh" }] : []
				] };
			},
