...
import "../../agent-settings-BrNIdcFH.js";
import { l as jsonResult } from "../../common-CQZwSsYR.js";
import { n as resolveCronStyleNow } from "../../current-time-pX5as6TY.js";
...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-Dn4trLJY.js";
import { t as resolveMemoryCoreNowMs } from "../../time-Cnl8idsF.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-CHhrb6C9.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-CcIzM8pz.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-CFrBcYUP.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-DR6etGPD.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-B1e6kiUM.js");
