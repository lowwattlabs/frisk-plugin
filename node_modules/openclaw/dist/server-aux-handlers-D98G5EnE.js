...
import { m as resolveSecretInputRef } from "./types.secrets-BEnNl80Y.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import { a as resolveSecretRefValue } from "./resolve-DrrdKJKb.js";
import { i as resolveManifestContractOwnerPluginId } from "./plugin-registry-CUF3xoIA.js";
import { t as assertExpectedResolvedSecretValue } from "./secret-value-C4U1SbWS.js";
import { r as createResolverContext } from "./runtime-shared-D9GocWE7.js";
import { i as setPathExistingStrict, n as getPath } from "./path-utils-Dad1P0uh.js";
import { r as discoverConfigSecretTargetsByIds } from "./target-registry-CCZXI5Xh.js";
import { i as getRuntimeConfig } from "./io-AmXZn-TT.js";
import "./config-Ba5VqNR9.js";
import { n as channelRouteDedupeKey } from "./channel-route-Cggl4GyH.js";
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import { n as getLoadedChannelPlugin } from "./registry-C3m2WQdt.js";
import { t as resolveChannelApprovalAdapter } from "./plugins-2jPMnXk3.js";
import "./message-channel-rCegTRAO.js";
import { c as buildPluginApprovalRequestMessage, o as approvalDecisionLabel, s as buildPluginApprovalExpiredMessage, u as resolvePluginApprovalRequestAllowedDecisions } from "./plugin-approvals-WkXJ-bse.js";
import { k as resolveExecApprovalRequestAllowedDecisions } from "./exec-approvals-BjcYozOJ.js";
import { i as getActiveSecretsRuntimeEnv, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-LK_7s91k.js";
import { n as collectCommandSecretAssignmentsFromSnapshot, t as analyzeCommandSecretAssignmentsFromSnapshot } from "./command-config-DArnD7xa.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-CXJcwBFs.js";
import { t as resolveRuntimeWebTools } from "./runtime-web-tools-BJev_8ep.js";
import { t as matchesApprovalRequestFilters } from "./approval-request-filters-CmCO4X55.js";
import { d as formatExecApprovalExpiresIn } from "./exec-approval-reply-DX1AI0Hh.js";
import { i as sanitizeExecApprovalWarningText, t as resolveExecApprovalCommandDisplay } from "./exec-approval-command-display-DDQnyipR.js";
import { i as buildPluginApprovalResolvedReplyPayload, n as buildApprovalResolvedReplyPayload, r as buildPluginApprovalPendingReplyPayload, t as buildApprovalPendingReplyPayload } from "./approval-renderers-tu4uMLYu.js";
import { l as roleScopesAllow } from "./pairing-token-CMO8P9C8.js";
import { l as listDevicePairing, s as hasEffectivePairedDeviceRole } from "./device-pairing-DkTELHfz.js";
import { a as diffConfigPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-9lCc4Vtb.js";
import { d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, l as sendApnsExecApprovalAlert, o as resolveApnsAuthConfigFromEnv, r as loadApnsRegistrations, t as clearApnsRegistrationIfCurrent, u as sendApnsExecApprovalResolvedWake } from "./push-apns-CT2owbry.js";
...
async function activateSecretsRuntimeSnapshot(snapshot) {
	(await import("./runtime-Da8ERfzw.js")).activateSecretsRuntimeSnapshot(snapshot);
}
...
function createGatewayAuxHandlers(params) {
	...
	const loadExecApprovalHandlers = () => execApprovalHandlersPromise ??= import("./exec-approval-D4H5hxsl.js").then(({ createExecApprovalHandlers }) => createExecApprovalHandlers(execApprovalManager, {
	...
	const loadPluginApprovalHandlers = () => pluginApprovalHandlersPromise ??= import("./plugin-approval-DaMPN8qa.js").then(({ createPluginApprovalHandlers }) => createPluginApprovalHandlers(pluginApprovalManager, { forwarder: execApprovalForwarder }));
	...
	const loadSecretsHandlers = () => secretsHandlersPromise ??= import("./secrets-CRr4Vit_.js").then(({ createSecretsHandlers }) => createSecretsHandlers({
