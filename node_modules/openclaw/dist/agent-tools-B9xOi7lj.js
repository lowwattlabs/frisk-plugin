...
import { c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BoFGd2i9.js";
import { a as logWarn } from "./logger-CuDPuGSa.js";
import { t as bindAbortRelay } from "./fetch-timeout-CI4Tvuwo.js";
import { n as assertSandboxPath } from "./sandbox-paths-D0IzFPUM.js";
import { i as toRelativeSandboxPath, n as resolveWorkspaceRoot, r as resolvePathFromInput } from "./workspace-dir-DBuIUvyj.js";
import { a as resolveGatewayMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import "./message-channel-rCegTRAO.js";
import { P as createCodingTools, V as createReadTool } from "./sessions-CHf3LZvU.js";
import { c as EXEC_TOOL_DISPLAY_SUMMARY, l as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-D5QsrL1H.js";
import { a as collectExplicitDenylist, c as hasRestrictiveAllowPolicy, g as resolveToolProfilePolicy, h as normalizeToolName, i as collectExplicitAllowlist, l as mergeAlsoAllowPolicy, p as expandToolGroups, u as replaceWithEffectiveToolAllowlist } from "./tool-policy-K2Xr4lej.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-B8YPWGDv.js";
import { _ as SANDBOX_AGENT_WORKSPACE_MOUNT } from "./constants-DVEmzBJl.js";
...
import { t as HEARTBEAT_RESPONSE_TOOL_NAME } from "./heartbeat-tool-response-Bs6YWghQ.js";
import { C as wrapToolWorkspaceRootGuardWithOptions, S as wrapToolWorkspaceRootGuard, _ as createOpenClawReadTool, b as createSandboxedWriteTool, g as createHostWorkspaceWriteTool, h as createHostWorkspaceEditTool, m as resolveOpenClawPluginToolsForOptions, t as createOpenClawTools, v as createSandboxedEditTool, x as wrapToolMemoryFlushAppendOnlyWrite, y as createSandboxedReadTool } from "./openclaw-tools-ChLzmhJi.js";
import { o as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-core-CFEAkLwU.js";
import { t as normalizeToolParameterSchema } from "./agent-tools-parameter-schema-MxXzai8u.js";
import { i as getPluginToolMeta, n as copyPluginToolMeta } from "./tools-RrdXLseQ.js";
import { O as listChannelAgentTools, T as copyChannelAgentToolMeta, _ as wrapToolWithBeforeToolCallHook, a as copyBeforeToolCallHookMarker, u as isToolWrappedWithBeforeToolCallHook } from "./agent-tools.before-tool-call-CDXSxqiL.js";
...
import { t as resolveExecCommandHighlighting } from "./exec-command-highlighting-BNLhNbXM.js";
import { n as resolveEventSessionRoutingPolicy } from "./event-session-routing-CnxDz5Ld.js";
import { I as resolveExecPolicyForMode } from "./exec-approvals-BjcYozOJ.js";
import { i as resolveMergedSafeBinProfileFixtures } from "./exec-safe-bin-runtime-policy-DQ5UvZ4b.js";
...
import "./codex-native-web-search-AnQLxklI.js";
import { t as resolveToolLoopDetectionConfig } from "./tool-loop-detection-config-De8Ux2Rx.js";
import { l as resolveToolFsConfig, o as createToolFsPolicy } from "./local-roots-D0HjZuqR.js";
import { n as buildDefaultToolPolicyPipelineSteps, t as applyToolPolicyPipeline } from "./tool-policy-pipeline-CKMYzLWU.js";
...
const bashToolsModuleLoader = createLazyImportLoader(() => import("./bash-tools-DLTG5o1P.js"));
...
//#endregion
export { isLocalModelLeanEnabled as _, TOOL_SEARCH_CODE_MODE_TOOL_NAME as a, addClientToolsToToolCatalog as c, applyToolSearchCatalog as d, clearToolSearchCatalog as f, filterLocalModelLeanTools as g, resolveToolSearchConfig as h, TOOL_DESCRIBE_RAW_TOOL_NAME as i, addClientToolsToToolSearchCatalog as l, projectToolSearchTargetTranscriptMessages as m, resolveProcessToolScopeKey as n, TOOL_SEARCH_RAW_TOOL_NAME as o, createToolSearchCatalogRef as p, TOOL_CALL_RAW_TOOL_NAME as r, ToolSearchRuntime as s, createOpenClawCodingTools as t, applyToolCatalogCompaction as u, resolveLocalModelLeanPreserveToolNames as v };
