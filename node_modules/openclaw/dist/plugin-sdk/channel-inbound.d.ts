import { a as createCommandTurnContext, c as isNativeCommandTurn, l as isTextSlashCommandTurn, o as isAuthorizedTextSlashCommandTurn, r as CommandTurnContext, s as isExplicitCommandTurn, u as InboundEventKind } from "./templating-DBMP5vaC.js";
import { n as AccessGroupMembershipResolver } from "./access-groups-DQEj2Eiu.js";
import { c as resolveMentionPatternPolicy, n as BuildMentionRegexesOptions, o as ResolveMentionPatternPolicyParams, s as ResolvedMentionPatternPolicy } from "./mentions.types-oldzslx5.js";
import { a as resolveEnvelopeFormatOptions, i as formatInboundFromLabel, r as formatInboundEnvelope, t as EnvelopeFormatOptions } from "./envelope-DKgc1wrn.js";
...
import { A as SupplementalContextFacts, P as recordChannelBotPairLoopAndCheckSuppression, d as ChannelTurnDroppedHistoryOptions, j as ChannelBotLoopProtectionFacts, m as ChannelTurnRecordOptions, v as CommandFacts, x as InboundMediaFacts } from "./types-C6dRHLVk.js";
import { C as finalizeChannelInboundContext, S as filterChannelInboundSupplementalContext, _ as FinalizeChannelInboundContextAsyncParams, b as buildChannelInboundEventContext, c as resolveChannelTurnDispatchCounts, g as ChannelInboundSupplementalResolutionOptions, h as BuiltChannelInboundEventContext, m as BuildChannelInboundEventContextParams, o as hasFinalChannelTurnDispatch, p as BuildChannelInboundEventContextAsyncParams, r as recordDroppedChannelInboundHistory, s as hasVisibleChannelTurnDispatch, v as FinalizeChannelInboundContextParams, w as resolveChannelInboundSupplementalContext, x as filterChannelInboundQuoteContext, y as FinalizeChannelInboundContextResult } from "./kernel-CW4R-xA_.js";
import { i as toLocationContext, n as NormalizedLocation, r as formatLocationText, t as LocationSource } from "./location-D6ia4w3e.js";
import { i as resolveInboundDirectDmAccessWithRuntime, n as ResolvedInboundDirectDmAccess, r as createPreCryptoDirectDmAuthorizer, t as DirectDmCommandAuthorizationRuntime } from "./direct-dm-access-BTG7CwBk.js";
import { n as DirectDmPreCryptoGuardPolicyOverrides, r as createDirectDmPreCryptoGuardPolicy, t as DirectDmPreCryptoGuardPolicy } from "./direct-dm-guard-policy-DGv6Tk_t.js";
import { t as dispatchInboundDirectDmWithRuntime } from "./direct-dm-CPS_a0VC.js";
import { a as normalizeMentionText, i as matchesMentionWithExplicit, n as buildMentionRegexes, r as matchesMentionPatterns } from "./mentions-Cj5CGP7W.js";
import { a as ChannelInboundMediaInput, c as toHistoryMediaEntries, d as classifyChannelInboundEvent, f as resolveUnmentionedGroupInboundPolicy, h as shouldDebounceTextInbound, i as filterChannelTurnSupplementalContext, l as toInboundMediaFacts, m as createChannelInboundDebouncer, n as BuiltChannelTurnContext, o as ChannelInboundMediaPayload, p as resolveInboundSessionEnvelopeContext, r as buildChannelTurnContext, s as buildChannelInboundMediaPayload, t as BuildChannelTurnContextParams, u as ClassifyChannelInboundEventParams } from "./channel-inbound-6fgec67K.js";
import { r as logInboundDrop, t as LogFn } from "./logging-BuEYHHqy.js";
import { g as runChannelInboundEvent, i as PreparedInboundReply, n as ChannelInboundEventRunnerParams, r as InboundReplyDispatchResult, s as dispatchChannelInboundReply, t as AssembledInboundReply, u as dispatchReplyFromConfigWithSettledDispatcher, v as runPreparedInboundReply } from "./inbound-reply-dispatch-CJPfUBXA.js";
import { r as mergeInboundPathRoots } from "./inbound-path-policy-DR2yVY3b.js";
