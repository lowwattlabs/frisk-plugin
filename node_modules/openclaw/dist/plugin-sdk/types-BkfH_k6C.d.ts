import { E as ThinkingLevel, f as Model$1, l as ImageContent$1, r as AssistantMessage } from "./types-DAMKpKGt.js";
import { Dr as AgentMessage, Mr as AgentToolResult, Wr as StreamFn, kr as AgentTool } from "./proxy-C7H2zfcV.js";
import { a as SourceReplyDeliveryMode, c as PromptImageOrderEntry, l as InputProvenance, n as GetReplyOptions, o as UserTurnTranscriptRecorder, r as PartialReplyPayload, u as ReplyPayload } from "./types-C9mauU5w.js";
import { n as MsgContext, u as InboundEventKind } from "./templating-DBMP5vaC.js";
import { i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot } from "./types.openclaw-Cx3cX1B-.js";
import { o as AgentModelConfig } from "./types.provider-request-Zn1BAFhk.js";
import { O as SessionMaintenanceMode, j as SessionScope } from "./types.base-bTa1ro6X.js";
import { n as SafeBinProfileFixture } from "./exec-safe-bin-policy-profiles-BDyHRwUP.js";
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-Shbq8KVY.js";
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-BoI6231R.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-CswYzVAm.js";
import { a as AuthProfileFailureReason, c as OAuthCredential, i as AuthProfileCredential, o as AuthProfileIdRepairResult, r as AuthProfileBlockedSource, s as AuthProfileStore, t as ApiKeyCredential } from "./types-CHe6UkpD.js";
import { f as MediaUnderstandingProvider } from "./types-DxIbnlqh.js";
import { t as ChannelId } from "./channel-id.types-CGgu7V7s.js";
import { b as ExecTarget, g as ExecAsk, v as ExecMode, y as ExecSecurity } from "./exec-approvals-Bx7ikP4P.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { d as UnifiedModelCatalogEntry, f as UnifiedModelCatalogKind, h as PluginConfigUiHint, u as PluginKind } from "./manifest-registry-Cl7vgHJw.js";
import { t as JsonSchemaObject } from "./json-schema.types-fpZiub1R.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-CLmrfAQv.js";
import { i as WizardPrompter } from "./prompts-DgKIGa-v.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { n as ChannelPlugin } from "./types.public-CsG15_M2.js";
import { n as PluginMetadataSnapshot, t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-C9y1_wbn.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-BQK69xjJ.js";
import { n as ConfigReplaceResult, t as ConfigMutationBase } from "./config-XkInEDWT.js";
import { i as resolveStateDir } from "./paths-yU5fdeFB.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { o as SsrFPolicy } from "./ssrf-skjEI_i5.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-BnQCWazi.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as ReasoningLevel, f as ThinkLevel, m as VerboseLevel, p as ThinkingCatalogEntry, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-B8cE1FER.js";
import { n as SkillSnapshot, r as SkillTelemetrySource } from "./types-DgZg8Ee9.js";
import { r as SandboxBackendExecSpec, s as SandboxFsBridge } from "./backend-handle.types-D7afWmft.js";
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-BeMUIOmF.js";
import { o as ChannelRouteRef } from "./channel-route-BXiIwvgB.js";
import { t as DeliveryContext } from "./delivery-context.types-8b05DG_j.js";
...
import { r as completeSimple } from "./stream-BVSlknIW.js";
import { t as ProviderUsageSnapshot } from "./provider-usage.types-BHIqsSz-.js";
import { i as HookEntry, o as ensureAgentWorkspace, r as InternalHookHandler } from "./internal-hook-types-CKIMi9vm.js";
import { r as AnyAgentTool } from "./common-B9HBLAjs.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-CQ47s1F_.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-CVUr_WXo.js";
import { s as LogLevel } from "./subsystem-n4Y4vCcQ.js";
import { t as ProviderAuthEvidence } from "./provider-env-vars-CCTsdmgJ.js";
import { c as EmbeddedAgentExecutionPhase } from "./store-8mbdDYWx.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-6FEupg54.js";
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-_KmtoC6s.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-BbsorG_x.js";
import { S as resolveSessionFilePath, T as resolveStorePath, _ as updateSessionStoreEntry, b as loadSessionStore, d as patchSessionEntry, g as updateSessionStore, l as getSessionEntry, u as listSessionEntries, v as upsertSessionEntry } from "./sessions-CG-C9nUD.js";
import { o as enqueueSystemEvent } from "./system-events-Bh7EuqjE.js";
import { a as runCommandWithTimeout } from "./exec-BdCmhVG3.js";
import { s as mediaKindFromMime } from "./constants-fqKZGUyI.js";
import { h as resizeToJpeg, u as getImageMetadata } from "./media-services-VQu0-ewV.js";
import { n as loadWebMedia } from "./web-media-CFXhZXf3.js";
import { n as detectMime } from "./mime-dv79Otx3.js";
import { d as readRemoteMediaBuffer, f as saveRemoteMedia, g as isVoiceCompatibleAudio, p as saveResponseMedia, u as fetchRemoteMedia } from "./fetch-CnhQkwd6.js";
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-DxB5NcdJ.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-xiQ1Ety8.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BAPHRDT8.js";
import { n as RuntimeWebSearchMetadata, t as RuntimeWebFetchMetadata } from "./runtime-web-tools.types-Co2KBj4w.js";
import { C as SecretInputMode, n as GatewayRequestHandler, v as AgentEventPayload, x as onAgentEvent, y as AgentEventStream } from "./types-DZUzH5Sq.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { i as PluginStateSyncKeyedStore, r as PluginStateKeyedStore, t as OpenKeyedStoreOptions } from "./plugin-state-store.types-BezmQQsu.js";
import { l as CreateChannelIngressQueueOptions, t as ChannelIngressQueue } from "./ingress-queue-C333uGot.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-Dh84waYc.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-Bxc0H1P6.js";
import { d as MemoryPromptSectionBuilder, o as MemoryFlushPlanResolver, r as MemoryCorpusSupplement, s as MemoryPluginCapability, u as MemoryPluginRuntime } from "./memory-state-JZmWTGMT.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-DpbN1zjN.js";
import { Dt as PluginHookToolContext, F as PluginHookBeforeToolCallEvent, I as PluginHookBeforeToolCallResult, Kt as PluginNextTurnInjection, Ot as PluginHookToolInputKind, Yt as PluginJsonValue, Z as PluginHookHandlerMap, c as PluginApprovalResolution, cn as PluginHookBeforeAgentStartResult, it as PluginHookName, kt as PluginHookToolKind, qt as PluginNextTurnInjectionEnqueueResult } from "./hook-types-BwOyYpy9.js";
import { Ht as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-nR_9LU0b.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-CrEBY9Oj.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-HwIzyhwV.js";
import { r as ReplyDispatcher } from "./reply-dispatcher.types-B0sivCQE.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-oldzslx5.js";
import { n as RecordInboundSession$1 } from "./session.types-DpQw5fev.js";
import { t as hasControlCommand } from "./command-detection-u-mvVt2o.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-QlS08ORL.js";
import { t as convertMarkdownTables } from "./tables-B_IykLqQ.js";
import { c as DispatchReplyFromConfig, o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-xWQssrnW.js";
import { n as finalizeInboundContext } from "./inbound-context-5zW1wx6X.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-DKgc1wrn.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-KZemz4Gc.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-Cmb4sKfV.js";
import { t as buildPairingReply } from "./pairing-messages-C4lLpBvR.js";
import { p as saveMediaBuffer } from "./store-C-72pVXw.js";
import { n as getChannelActivity, r as recordChannelActivity } from "./channel-activity-D6hFynVB.js";
import { f as implicitMentionKindWhen, p as resolveInboundMentionDecision } from "./mention-gating-D6dFDlTf.js";
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-Bxd5yZsQ.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-DOReeeWu.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-CqkwecYF.js";
import { a as runPreparedInboundReply, b as buildChannelInboundEventContext, i as runChannelInboundEvent, t as dispatchChannelInboundReply } from "./kernel-CW4R-xA_.js";
...
//#endregion
export { OpenClawPluginService as $, SpeechDirectiveTokenParseResult as $a, EmbeddedAgentRunMeta as $c, setBeforeToolCallDiagnosticsEnabled as $i, PluginRuntime as $n, EmbeddedBlockChunker as $o, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $r, ensureAuthProfileStore as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, LlmCompleteUsage as Aa, resolveProviderAuthAliasMap as Ac, AgentHarnessDeliveryDefaults as Ai, ProviderResolvePromptOverlayContext as An, WebFetchCredentialResolutionSource as Ao, CodexAppServerToolResultEvent as Ar, resolveUsableCustomProviderApiKey as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, TaskFlowDetail as Ba, ProviderDefaultThinkingPolicyContext as Bc, PreemptiveCompactionRoute as Bi, ProviderTransportTurnState as Bn, WebSearchProviderSetupContext as Bo, CliBackendThinkingLevel as Br, EnvApiKeyResult as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, TranscriptRewriteReplacement as Ca, formatAuthDoctorHint as Cc, RealtimeTranscriptionSessionCallbacks as Ci, ProviderReplaySanitizeMode as Cn, OpenClawPluginToolFactory as Co, PluginSessionTurnUnscheduleByTagParams as Cr, hasRuntimeAvailableProviderAuth as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, LlmCompleteMessage as Da, resolveAuthProfileOrder as Dc, AgentHarnessAttemptResult as Di, ProviderResolveAuthProfileIdContext as Dn, onSessionTranscriptUpdate as Do, CodexAppServerExtensionContext as Dr, resolveModelAuthMode as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, LlmCompleteCaller as Ea, resolveAuthProfileEligibility as Ec, AgentHarnessAttemptParams as Ei, ProviderReplayToolCallIdMode as En, emitSessionTranscriptUpdate as Eo, PluginTrustedToolPolicyRegistration as Er, resolveApiKeyForProvider as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, PluginRuntimeTaskFlows as Fa, hasUsableOAuthCredential as Fc, AgentHarnessSupport as Fi, ProviderRuntimeProviderConfig as Fn, WebFetchRuntimeMetadataContext as Fo, CliBackendPlugin as Fr, formatMissingAuthError as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, TaskRunView as Ga, ProviderSystemPromptContribution as Gc, BeforeToolCallPolicyDiagnosticState as Gi, RealtimeTranscriptionProviderPlugin as Gn, GenerateVideoRuntimeResult as Go, AgentToolResultMiddlewareContext as Gr, markAuthProfileCooldown as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, TaskRunAggregateSummary as Ha, ProviderThinkingProfile as Hc, normalizeUsage as Hi, ProviderValidateReplayTurnsContext as Hn, WebSearchProviderToolExecutionContext as Ho, PluginTextReplacement as Hr, calculateAuthProfileCooldownMs as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, PluginRuntimeTaskRuns as Ia, CLAUDE_CLI_PROFILE_ID as Ic, AgentHarnessSupportContext as Ii, ProviderSanitizeReplayHistoryContext as In, WebSearchCredentialResolutionSource as Io, CliBackendPrepareExecutionContext as Ir, isMissingProviderAuthError as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, TtsConfigResolutionContext as Ja, ProviderResolveExternalAuthProfilesContext as Jc, getBeforeToolCallPolicyDiagnosticState as Ji, TranscriptSourceProvider as Jn, EmbeddedRunTrigger as Jo, AgentToolResultMiddlewareOptions as Jr, resolveProfilesUnavailableReason as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, ResolvedTtsConfig as Ka, ProviderExternalAuthProfile as Kc, DeferredPluginToolApproval as Ki, RealtimeVoiceProviderPlugin as Kn, GenerateImageParams as Ko, AgentToolResultMiddlewareEvent as Kr, markAuthProfileFailure as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, PluginRuntimeTasks as La, CODEX_CLI_PROFILE_ID as Lc, CompactEmbeddedAgentSessionParams as Li, ProviderSystemPromptContributionContext as Ln, WebSearchProviderContext as Lo, CliBackendPreparedExecution as Lr, isProviderAuthError as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, RuntimeLogger as Ma, AuthCredentialReasonCode as Mc, AgentHarnessResultClassification as Mi, ProviderResolveUsageAuthContext as Mn, WebFetchProviderId as Mo, CliBackendAuthEpochMode as Mr, MissingProviderAuthError as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, BoundTaskFlowsRuntime as Na, DEFAULT_OAUTH_REFRESH_MARGIN_MS as Nc, AgentHarnessSideQuestionParams as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, WebFetchProviderPlugin as No, CliBackendNativeToolMode as Nr, ProviderAuthError as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, LlmCompleteParams as Oa, ProviderAuthAliasLookupParams as Oc, AgentHarnessCompactParams as Oi, ProviderResolveDynamicModelContext as On, PluginWebFetchProviderEntry as Oo, CodexAppServerExtensionFactory as Or, resolveProviderEntryApiKeyBinding as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, BoundTaskRunsRuntime as Pa, TokenExpiryState as Pc, AgentHarnessSideQuestionResult as Pi, ProviderResolvedUsageAuth as Pn, WebFetchProviderToolDefinition as Po, CliBackendNormalizeConfigContext as Pr, ResolvedProviderAuth as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, SpeechDirectiveTokenParseContext as Qa, EmbeddedAgentCompactResult as Qc, runBeforeToolCallHook as Qi, CreatePluginRuntimeOptions as Qn, BlockReplyChunking as Qo, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qr, clearRuntimeAuthProfileStoreSnapshots as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, DetachedTaskFinalizeParams as Ra, resolveModelAsync as Rc, EmbeddedRunAttemptParams as Ri, ProviderToolSchemaDiagnostic as Rn, WebSearchProviderId as Ro, CliBackendResolveExecutionArgs as Rr, requireApiKey as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, SubagentSpawnPreparation as Sa, ExternalCliAuthDiscovery as Sc, RealtimeTranscriptionSession as Si, ProviderReplayPolicyContext as Sn, OpenClawPluginToolContext as So, PluginSessionTurnScheduleParams as Sr, hasAvailableAuthForProvider as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, TranscriptRewriteResult as Ta, AuthProfileEligibilityReasonCode as Tc, AgentHarness as Ti, ProviderReplaySessionState as Tn, TaskRecord as To, PluginToolMetadataRegistration as Tr, hasUsableCustomProviderApiKey as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, TaskRunCancelResult as Ua, ProviderRuntimeModel as Uc, AgentRuntimePlan as Ui, ProviderWebSocketSessionPolicy as Un, WebSearchRuntimeMetadataContext as Uo, PluginTextTransforms as Ur, clearAuthProfileCooldown as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, TaskFlowView as Va, ProviderThinkingPolicyContext as Vc, NormalizedUsage as Vi, ProviderUsageAuthToken as Vn, WebSearchProviderToolDefinition as Vo, CliBundleMcpMode as Vr, resolveEnvApiKey as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, TaskRunDetail as Wa, ProviderRuntimePluginHandle as Wc, BuildAgentRuntimePlanParams as Wi, ProviderWrapStreamFnContext as Wn, GenerateVideoParams as Wo, AgentToolResultMiddleware as Wr, markAuthProfileBlockedUntil as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, TTS_AUTO_MODES as Xa, ProviderResolveSyntheticAuthContext as Xc, isToolWrappedWithBeforeToolCallHook as Xi, UnifiedModelCatalogProviderPlugin as Xn, PromptMode as Xo, AgentToolResultMiddlewareRuntime as Xr, getSoonestCooldownExpiry as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, resolveEffectiveTtsConfig as Ya, ProviderResolveExternalOAuthProfilesContext as Yc, hasBeforeToolCallPolicy as Yi, UnifiedModelCatalogProviderContext as Yn, RunEmbeddedAgentParams as Yo, AgentToolResultMiddlewareResult as Yr, clearExpiredCooldowns as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, normalizeTtsAutoMode as Za, ProviderSyntheticAuthResult as Zc, requestDeferredPluginToolApproval as Zi, VideoGenerationProviderPlugin as Zn, AgentInternalEvent as Zo, OpenClawAgentToolResult as Zr, isProfileInCooldown as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, ContextEnginePromptCacheInfo as _a, upsertAuthProfileWithLock as _c, RealtimeVoiceToolResultOptions as _i, ProviderPrepareRuntimeAuthContext as _n, TtsDirectiveOverrides as _o, PluginSessionAttachmentResult as _r, applyLocalNoAuthHeaderOverride as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, registerContextEngine as aa, loadAuthProfileStoreForSecretsRuntime as ac, RealtimeVoiceBridgeEvent as ai, ProviderNormalizeToolSchemasContext as an, SpeechProviderOverrides as ao, ProviderResolveConfigApiKeyContext as ar, PreparedSimpleCompletionModel as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, IngestResult as ba, refreshOAuthCredentialForRuntime as bc, RealtimeTranscriptionProviderId as bi, ProviderReasoningOutputModeContext as bn, OpenClawPluginActiveModelContext as bo, PluginSessionSchedulerJobHandle as br, getApiKeyForModel as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, BootstrapResult as ca, resolvePersistedAuthProfileOwnerAgentDir as cc, RealtimeVoiceCloseReason as ci, ProviderPlugin as cn, SpeechProviderResolveConfigContext as co, PluginAgentEventSubscriptionRegistration as cr, completeWithPreparedSimpleCompletionModel as cs, PluginCommandResult as ct, MigrationItemKind as d, ContextEngineHostCapability as da, repairOAuthProfileIdMismatch as dc, RealtimeVoiceProviderConfiguredContext as di, ProviderPluginWizard as dn, SpeechSynthesisRequest as do, PluginRunContextPatch as dr, resolveSimpleCompletionSelectionForAgent as ds, PluginEmbeddingProvider as dt, wrapToolWithBeforeToolCallHook as ea, ensureAuthProfileStoreForLocalUpdate as ec, RealtimeVoiceAudioFormat as ei, MessagingToolSend as el, ProviderModernModelPolicyContext as en, SpeechListVoicesRequest as eo, SubagentRunParams as er, AgentStreamParams as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, ContextEngineHostRequirements as fa, suggestOAuthProfileIdForLegacyDefault as fc, RealtimeVoiceProviderId as fi, ProviderPluginWizardModelPicker as fn, SpeechSynthesisStreamRequest as fo, PluginRuntimeLifecycleRegistration as fr, ModelAuthMode as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, ContextEngineProjection as ga, upsertAuthProfile as gc, RealtimeVoiceToolCallEvent as gi, ProviderPrepareExtraParamsContext as gn, SpeechVoiceOption as go, PluginSessionAttachmentParams as gr, applyAuthHeaderOverride as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, ContextEngineOperation as ha, setAuthProfileOrder as hc, RealtimeVoiceTool as hi, ProviderPrepareDynamicModelContext as hn, SpeechTelephonySynthesisRequest as ho, PluginSessionActionResult as hr, RuntimeProviderAuthLookup as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, ContextEngineFactoryContext as ia, loadAuthProfileStoreForRuntime as ic, RealtimeVoiceBridgeCreateRequest as ii, normalizeHeartbeatToolResponse as il, ProviderNormalizeResolvedModelContext as in, SpeechProviderId as io, ProviderNormalizeConfigContext as ir, AgentSimpleCompletionSelection as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, PluginRuntimeCore as ja, resolveProviderIdForAuth as jc, AgentHarnessResetParams as ji, ProviderResolveTransportTurnStateContext as jn, WebFetchProviderContext as jo, CodexAppServerToolResultHandlerResult as jr, shouldPreferExplicitConfigApiKeyAuth as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, LlmCompleteResult as ka, resetProviderAuthAliasMapCacheForTest as kc, AgentHarnessCompactResult as ki, ProviderResolveNonInteractiveApiKeyParams as kn, PluginWebSearchProviderEntry as ko, CodexAppServerExtensionRuntime as kr, resolveProviderEntryApiKeyProfileReference as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, CompactResult as la, saveAuthProfileStore as lc, RealtimeVoiceProviderCapabilities as li, ProviderPluginCatalog as ln, SpeechProviderResolveTalkConfigContext as lo, PluginControlUiDescriptor as lr, prepareSimpleCompletionModel as ls, PluginConfigMigration as lt, MigrationProviderContext as m, ContextEngineMaintenanceResult as ma, removeProviderAuthProfilesWithLock as mc, RealtimeVoiceRole as mi, ProviderPreferRuntimeResolvedModelContext as mn, SpeechSynthesisTarget as mo, PluginSessionActionRegistration as mr, ProviderEntryApiKeyBindingResolution as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, resolveEmbeddedAgentRuntime as na, findPersistedAuthProfileCredential as nc, RealtimeVoiceBridge as ni, HEARTBEAT_RESPONSE_TOOL_NAME as nl, ProviderNonInteractiveApiKeyResult as nn, SpeechProviderConfig as no, settleReplyDispatcher as nr, ExecElevatedDefaults as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, resolveContextEngineOwnerPluginId as oa, loadAuthProfileStoreWithoutExternalProfiles as oc, RealtimeVoiceBrowserSession as oi, ProviderNormalizeTransportContext as on, SpeechProviderPrepareSynthesisContext as oo, PluginAgentEventEmitParams as or, PreparedSimpleCompletionModelForAgent as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, ContextEngineInfo as pa, markAuthProfileSuccess as pc, RealtimeVoiceProviderResolveConfigContext as pi, ProviderPluginWizardSetup as pn, SpeechSynthesisStreamResult as po, PluginSessionActionContext as pr, ProviderCredentialPrecedence as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, ResolvedTtsModelOverrides as qa, ProviderExternalOAuthProfile as qc, ToolOutcomeObserver as qi, SpeechProviderPlugin as qn, GenerateImageRuntimeResult as qo, AgentToolResultMiddlewareHarness as qr, resolveProfileUnusableUntilForDisplay as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, ContextEngineFactory as ra, loadAuthProfileStore as rc, RealtimeVoiceBridgeCallbacks as ri, HeartbeatToolResponse as rl, ProviderNormalizeModelIdContext as rn, SpeechProviderConfiguredContext as ro, ProviderApplyConfigDefaultsContext as rr, ExecToolDefaults as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, AssembleResult as sa, replaceRuntimeAuthProfileStoreSnapshots as sc, RealtimeVoiceBrowserSessionCreateRequest as si, ProviderOAuthProfileIdRepair as sn, SpeechProviderPreparedSynthesis as so, PluginAgentEventEmitResult as sr, SimpleCompletionModelOptions as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, AgentHarnessTaskRuntimeScope as ta, ensureAuthProfileStoreWithoutExternalProfiles as tc, RealtimeVoiceBargeInOptions as ti, MessagingToolSourceReplyPayload as tl, ProviderNonInteractiveApiKeyCredentialParams as tn, SpeechModelOverridePolicy as to, SubagentRunResult as tr, ClientToolDefinition as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, ContextEngine as ua, updateAuthProfileStoreWithLock as uc, RealtimeVoiceProviderConfig as ui, ProviderPluginDiscovery as un, SpeechProviderResolveTalkOverridesContext as uo, PluginRunContextGetParams as ur, prepareSimpleCompletionModelForAgent as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, ContextEngineRuntimeContext as va, dedupeProfileIds as vc, RealtimeTranscriptionProviderConfig as vi, ProviderPreparedRuntimeAuth as vn, TtsDirectiveParseResult as vo, PluginSessionExtensionProjection as vr, canUseProfileAsProviderEntryApiKey as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, TranscriptRewriteRequest as wa, resolveAuthProfileDisplayLabel as wc, RealtimeTranscriptionSessionCreateRequest as wi, ProviderReplaySessionEntry as wn, OpenClawPluginToolOptions as wo, PluginSessionTurnUnscheduleByTagResult as wr, hasSyntheticLocalProviderAuthConfig as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, SubagentEndReason as xa, resolveApiKeyForProfile as xc, RealtimeTranscriptionProviderResolveConfigContext as xi, ProviderReplayPolicy as xn, OpenClawPluginHookOptions as xo, PluginSessionSchedulerJobRegistration as xr, getCustomProviderApiKey as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, IngestBatchResult as ya, listProfilesForProvider as yc, RealtimeTranscriptionProviderConfiguredContext as yi, ProviderReasoningOutputMode as yn, ResolvedProviderRuntimeAuth as yo, PluginSessionExtensionRegistration as yr, createRuntimeProviderAuthLookup as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, DetachedTaskLifecycleRuntime as za, augmentModelCatalogWithProviderPlugins as zc, EmbeddedRunAttemptResult as zi, ProviderTransformSystemPromptContext as zn, WebSearchProviderPlugin as zo, CliBackendResolveExecutionArgsContext as zr, resolveAwsSdkEnvVarName as zs, ProviderCatalogOrder as zt };