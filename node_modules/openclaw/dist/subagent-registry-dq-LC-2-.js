...
import { c as readErrorName, i as formatErrorMessage } from "./errors-DJFNHUbg.js";
import { n as createLazyPromiseLoader, t as createLazyImportLoader } from "./lazy-promise-D9U9idWj.js";
...
import { u as toSafeImportPath } from "./plugin-module-loader-cache-DB66BX3_.js";
...
import { c as getAgentRunContext, l as onAgentEvent } from "./agent-events-f1e3xUso.js";
...
import { c as registerSessionMaintenancePreserveKeysProvider, t as loadSessionStore } from "./store-load-X9ls7b1K.js";
import { d as updateSessionStore } from "./store-D2vwNFZF.js";
import "./sessions-7_zgwGXH.js";
import { c as isBlockedLivenessState, n as buildAgentRunTerminalOutcomeFromWaitResult, o as isAbortedAgentStopReason, s as formatBlockedLivenessError } from "./agent-run-terminal-outcome-DZzwLfzy.js";
import { n as extractTextFromChatContent } from "./chat-content-BbLAEXko.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, n as completeTaskRunByRunId } from "./detached-task-runtime-VADcP34g.js";
...
import { i as waitForAgentRun, t as isRecoverableAgentWaitError } from "./run-wait-_x7v1MpM.js";
import { d as withSubagentOutcomeTiming, t as deleteSubagentSessionForCleanup } from "./subagent-session-cleanup-DFJj9W5n.js";
import { n as removeInternalSessionEffectsTranscript } from "./internal-session-effects-cRdEdTf5.js";
...
const browserCleanupLoader$1 = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-0oPXrmVE.js"));
...
const subagentAnnounceLoader = createLazyImportLoader(() => import("./subagent-announce-HPJnGzNW.js"));
const browserCleanupLoader = createLazyImportLoader(() => import("./browser-lifecycle-cleanup-0oPXrmVE.js"));
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-DtYH9S9g.js").then(({ scheduleOrphanRecovery }) => {
