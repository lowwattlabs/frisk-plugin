...
import { i as normalizeEnv, t as isTruthyEnvValue } from "../env-5g5TGXM7.js";
import { C as getCoreCliParentDefaultHelpCommands, O as consumeRootOptionToken, _ as getSubCliEntries, c as hasFlag, m as normalizeRootHelpTargetArgv, p as normalizeGeneratedHelpCommandArgv, v as getSubCliParentDefaultHelpCommands, x as getCoreCliCommandNames } from "../argv-8KO9gKcu.js";
import { y as resolveStateDir } from "../paths-CiHrdfZh.js";
import { t as isMainModule } from "../is-main-DoKHeRG7.js";
import { t as resolveCliArgvInvocation } from "../argv-invocation-McgJTh4C.js";
import { i as parseCliContainerArgs, n as parseCliProfileArgs, r as maybeRunCliInContainer, t as applyCliProfileEnv } from "../profile-DUddXz83.js";
import { t as normalizeWindowsArgv } from "../windows-argv-CMaAjrO4.js";
import { t as assertSupportedRuntime } from "../runtime-guard-CcqbCKlv.js";
import { n as resolveManifestCommandAliasOwnerInRegistry, r as resolveManifestToolOwnerInRegistry } from "../manifest-command-aliases-XC642OXF.js";
import { t as ensureOpenClawCliOnPath } from "../path-env-D75aiTHM.js";
import { a as shouldSkipPluginCommandRegistration, r as shouldRegisterPrimaryCommandOnly, t as isReservedNonPluginCommandRoot } from "../command-registration-policy-DeS25d8_.js";
import { a as consumeGatewayFastPathRootOptionToken, n as resolveCliNetworkProxyPolicy, o as consumeGatewayRunOptionToken, t as resolveCliCommandPathPolicy } from "../command-path-policy-YVod7apR.js";
...
const loadRootHelpLiveConfigModule = async () => await import("../root-help-live-config-DjUwbV1f.js");
const loadRootHelpMetadataModule = async () => await import("../root-help-metadata-mlt8FGqn.js");
const loadLoggingModule = async () => await import("../logging-BoAjpLuA.js");
const loadCliRegistryLoaderModule = async () => await import("../cli-registry-loader-BH3a6umS.js");
const loadManifestCommandAliasesRuntimeModule = async () => await import("../manifest-command-aliases.runtime-CnMsFq-A.js");
const loadProxyLifecycleModule = async () => await import("../proxy-lifecycle-BAndllEs.js");
const loadCrestodianModule = async () => await import("../crestodian/crestodian.js");
const loadProgressModule = async () => await import("../progress-nqs7E1d1.js");
...
async function tryRunGatewayRunFastPath(argv, startupTrace) {
	...
	const [{ Command }, { addGatewayRunCommand }, { VERSION }, { emitCliBanner }, { resolveCliStartupPolicy }, { enableConsoleCapture }] = await startupTrace.measure("gateway-run-imports", () => Promise.all([
		import("commander"),
		import("../run-command-CtxBXikZ.js"),
		import("../version-Dpd_K_tD.js"),
		import("../banner-eHNHq9Qt.js"),
		import("../command-startup-policy-FMVxOOO5.js"),
		loadLoggingModule()
	]));
...
async function closeCliMemoryManagers() {
	try {
		...
		const { closeActiveMemorySearchManagers } = await import("../memory-runtime-Bgjg60yl.js");
		await closeActiveMemorySearchManagers();
	} catch {}
}
async function disposeCliAgentHarnesses() {
	try {
		const { listAgentHarnessIds, disposeRegisteredAgentHarnesses } = await import("../registry-Bg2zkHm9.js");
...
async function ensureCliEnvProxyDispatcher() {
	try {
		...
		const { ensureGlobalUndiciEnvProxyDispatcher } = await import("../undici-global-dispatcher-BDPYDKhB.js");
...
async function bootstrapCliProxyCaptureAndDispatcher(startupTrace, options = {}) {
	const [{ initializeDebugProxyCapture, finalizeDebugProxyCapture }, { maybeWarnAboutDebugProxyCoverage }] = await startupTrace.measure("proxy-imports", () => Promise.all([import("../runtime-DfWaVq6e.js"), import("../coverage-B718nyYv.js")]));
...
async function runCli(argv = process$1.argv) {
	...
	if (!isHelpOrVersionInvocation && shouldLoadCliDotEnv()) await startupTrace.measure("dotenv", async () => {
		if (isRemoteAgentDispatchInvocation(normalizedArgv, normalizedInvocation.primary)) {
			const { loadGatewayDispatchCliDotEnv } = await import("../gateway-dispatch-dotenv-4XLwRgDD.js");
			await loadGatewayDispatchCliDotEnv({ quiet: true });
		} else {
			const { loadCliDotEnv } = await import("../dotenv-BYGACtis.js");
	...
	const readBestEffortCliConfig = async () => {
		if (!bestEffortConfigPromise) bestEffortConfigPromise = import("../io-BTuuG0aR.js").then(({ readBestEffortConfig }) => readBestEffortConfig());
	...
	try {
		if (shouldUseRootHelpFastPath(normalizedArgv)) {
			...
			const { outputRootHelp } = await import("../root-help-CS677Lis.js");
		...
		if (shouldUseSetupOnboardConfigureHelpFastPath(normalizedArgv)) {
			const { tryOutputSetupOnboardConfigureHelp } = await import("../setup-onboard-configure-help-fast-path-D0gbMyjV.js");
		...
		if (shouldRunBareRootCrestodian) {
			if (await shouldStartOnboardingForFreshInstall(normalizedArgv)) {
				...
				const { setupWizardCommand } = await import("../onboard-BEIwHwNk.js");
		...
		if (bootstrapProxyBeforeFastPath && await tryRunGatewayRunFastPath(normalizedArgv, startupTrace)) return;
		const { tryRouteCli } = await startupTrace.measure("route-import", () => import("../route-DjjJuBT0.js"));
		...
		try {
			...
			const [{ buildProgram }, { formatUncaughtError }, { formatCliFailureLines }, { runFatalErrorHooks }, { installUnhandledRejectionHandler, isBenignUncaughtExceptionError, isUncaughtExceptionHandled }, { restoreTerminalState }] = await startupTrace.measure("core-imports", () => Promise.all([
				import("../program-GRZ2W39w.js"),
				import("../infra/errors.js"),
				import("../failure-output-epADd6ic.js"),
				import("../fatal-error-hooks-BJYnE1yM.js"),
				import("../unhandled-rejections-BZxpC0VC.js"),
			...
			if (primary && shouldRegisterPrimaryCommandOnly(parseArgv)) await startupTrace.measure("register-primary", async () => {
				...
				if (ctx) {
					const { registerCoreCliByName } = await import("../command-registry-DxGt9ndv.js");
					await registerCoreCliByName(program, ctx, primary, parseArgv);
				}
				const { registerSubCliByName } = await import("../register.subclis-BAgE1CiP.js");
			...
			if (!shouldSkipPluginCommandRegistration({
				...
				const config = await startupTrace.measure("register-plugin-commands", async () => {
					const { registerPluginCliCommandsFromValidatedConfig } = await import("../cli-DTtDNA_y.js");
