...
import { m as loadPluginRegistrySnapshotWithMetadata } from "./plugin-registry-CUF3xoIA.js";
import { t as sanitizeTerminalText } from "./safe-text-BkQYdJi1.js";
import { o as openAIProviderUsesCodexRuntimeByDefault } from "./openai-routing-Bc6sEjDj.js";
...
import { b as resolveProviderEnvAuthLookupMaps, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-Br3imLsr.js";
import "./model-selection-BKypu26e.js";
import { t as resolveEnvApiKey } from "./model-auth-env-BkMfyX5x.js";
import { s as resolveAwsSdkEnvVarName } from "./model-auth-runtime-shared-CDjHPu_G.js";
import { l as hasSyntheticLocalProviderAuthConfig, u as hasUsableCustomProviderApiKey } from "./model-auth-UZfuk32X.js";
import { a as formatTokenK, h as createModelCatalogProviderAliasCanonicalizer, m as canonicalizeModelCatalogProviderAlias, r as ensureFlagCompatibility } from "./shared-DtenGgs4.js";
import { n as loadModelsConfigWithSource } from "./load-config-Cs6G0S-P.js";
import { n as formatErrorWithStack } from "./list.errors-BKEXWuM3.js";
import { i as truncate, n as isRich, r as pad, t as formatTag } from "./list.format-DDZRMn8o.js";
...
const registryLoadModuleLoader = createLazyImportLoader(() => import("./list.registry-load-DDsC4YGc.js"));
const rowSourcesModuleLoader = createLazyImportLoader(() => import("./list.row-sources-B0KELQTU.js"));
const sourcePlanModuleLoader = createLazyImportLoader(() => import("./list.source-plan-N3prr1E4.js"));
...
async function modelsListCommand(opts, runtime) {
	...
	const [{ loadAuthProfileStoreWithoutExternalProfiles }, { resolveAgentWorkspaceDir, resolveDefaultAgentDir, resolveDefaultAgentId }, { resolveDefaultAgentWorkspaceDir }] = await Promise.all([
		import("./store-R-PESjzL.js"),
		import("./agent-scope-D91MshD8.js"),
		import("./workspace-CBk_XDOE.js")
	]);
