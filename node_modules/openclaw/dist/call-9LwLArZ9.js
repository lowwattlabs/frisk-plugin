...
import { d as resolveGatewayPort, f as resolveIncludeRoots, s as resolveConfigPath, y as resolveStateDir } from "./paths-CiHrdfZh.js";
...
import { a as trimToUndefined } from "./credential-planner-srMi66PR.js";
import "./credentials-MEPkijLg.js";
import { f as isLoopbackIpAddress } from "./ip-0oQXo6_w.js";
import { n as resolveGatewayAuth } from "./auth-resolve-BZAxqZnD.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards } from "./includes-B6UCEfFS.js";
import { o as redactSensitiveUrlLikeString } from "./redact-sensitive-url-DT6j3eLK.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-BzCrekjX.js";
import "./version-51ymduTn.js";
import { a as isGatewayConnectAssemblyError, n as GatewayClient, u as loadDeviceAuthToken } from "./client-BfgBP91A.js";
import { r as loadOrCreateDeviceIdentity } from "./device-identity-MBMlKHkl.js";
import { t as loadGatewayTlsRuntime } from "./gateway-CDk42N3c.js";
...
import { n as resolveGatewayCredentialsWithSecretInputs } from "./credentials-secret-inputs-BSLmiWGS.js";
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-C-0hncea.js";
import { a as isGatewayMethodClassified, t as CLI_DEFAULT_OPERATOR_SCOPES, u as resolveLeastPrivilegeOperatorScopesForMethod } from "./method-scopes-CooE5VHV.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-DJARK7Di.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-BTuuG0aR.js")).getRuntimeConfig();
...
//#endregion
export { readGatewayDispatchConfig as _, callGateway as a, callGatewayScoped as c, isGatewayCredentialsRequiredError as d, isGatewayExplicitAuthRequiredError as f, testing as g, resolveExplicitGatewayAuth as h, buildGatewayConnectionDetails as i, ensureExplicitGatewayAuth as l, randomIdempotencyKey as m, GatewayExplicitAuthRequiredError as n, callGatewayCli as o, isGatewayTransportError as p, GatewayTransportError as r, callGatewayLeastPrivilege as s, GatewayCredentialsRequiredError as t, formatGatewayTransportErrorJson as u, readGatewayDispatchConfigWithShellEnvFallback as v };
