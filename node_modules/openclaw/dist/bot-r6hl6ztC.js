...
import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-DJFNHUbg.js";
import { _ as uniqueStrings, l as normalizeStringEntries } from "./string-normalization-WNUDCpXX.js";
import { t as createNonExitingRuntime } from "./runtime-pp2OBTec.js";
import { r as getChildLogger } from "./logger-XNVR48Hn.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import { n as normalizeAccountId } from "./account-id-By1zn6Bl.js";
import { h as sanitizeAgentId, i as buildAgentMainSessionKey, m as resolveThreadSessionKeys } from "./session-key-BOpfMTUN.js";
import { a as resolveAgentDir, c as resolveDefaultAgentId, r as resolveAgentConfig } from "./agent-scope-config-BoFGd2i9.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-DiwHZb7D.js";
import { i as getRuntimeConfig } from "./io-AmXZn-TT.js";
import { i as getRuntimeConfigSnapshot } from "./runtime-snapshot-D93_HOsR.js";
import { n as mutateConfigFile } from "./config-Ba5VqNR9.js";
import { a as getReplyPayloadTtsSupplement, n as buildTtsSupplementMediaPayload } from "./reply-payload-DM17pxMC.js";
import { u as fireAndForgetHook } from "./hook-runner-global-CBGmN_LW.js";
import { t as createDedupeCache } from "./dedupe-r2Sh3BPu.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BUw7VcqN.js";
import { s as resolveSessionTranscriptPathInDir, u as resolveStorePath } from "./paths-Bz9nEaho.js";
import { V as resolveSessionStoreEntry } from "./store-load-X9ls7b1K.js";
import { d as updateSessionStore } from "./store-D2vwNFZF.js";
import { d as resolveAndPersistSessionFile, r as readLatestAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-DJ0xrK51.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-_AiEotlV.js";
import { x as findModelInCatalog } from "./model-selection-shared-WGXc9fXh.js";
...
import { i as modelSupportsVision, n as loadModelCatalog } from "./model-catalog-BN-bUmfZ.js";
import { i as isExplicitCommandTurn } from "./command-turn-context-jjyeZbEf.js";
import { n as listChatCommands } from "./commands-registry-list-DoI8AMGd.js";
import { n as maybeResolveTextAlias, r as normalizeCommandBody } from "./commands-registry-normalize-CGdNJ5Vy.js";
import { n as isAbortRequestText } from "./abort-primitives-BORq_unO.js";
import { t as hasControlCommand } from "./command-detection-BPtQDBi9.js";
import { h as isInsideCode, m as findCodeRegions, u as stripReasoningTagsFromText } from "./assistant-visible-text-BWx-tg5g.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-DsLoRHnE.js";
import { i as toInternalMessageReceivedContext } from "./message-hook-mappers-DfeHI2AT.js";
import { m as resolveSendableOutboundReplyParts } from "./reply-payload-JUvJDGAb.js";
import { l as normalizeMessagePresentation } from "./payload-CZlThETZ.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-CiTBhMnQ.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-MOedhfPi.js";
import { n as firstDefined } from "./allow-from-BkvJL_Ra.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-ByRFs_Z3.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-3P8aSD7o.js";
import { c as defineStableChannelIngressIdentity, n as createChannelIngressResolver } from "./runtime-D1pzcQhX.js";
import { n as MediaFetchError } from "./fetch-0Ti_Xazz.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-D0HjZuqR.js";
import { t as resolveAckReaction } from "./identity-CNVeGBq1.js";
import { t as deriveDurableFinalDeliveryRequirements } from "./capabilities-tytC94t4.js";
import { D as resolveChannelStreamingPreviewNativeToolProgress, M as resolveTranscriptBackedChannelFinalText, N as selectLongerFinalText, O as resolveChannelStreamingPreviewNativeToolProgressAllowFrom, S as resolveChannelStreamingBlockEnabled, a as createChannelProgressDraftGate, c as formatChannelProgressDraftText, d as isPotentialTruncatedFinal, f as mergeChannelProgressDraftLine, i as buildChannelProgressDraftLineForEntry, k as resolveChannelStreamingPreviewToolProgress, o as formatChannelProgressDraftLine, s as formatChannelProgressDraftLineForEntry, u as isChannelProgressDraftWorkToolName, y as resolveChannelProgressDraftMaxLines } from "./streaming-Cx6Axj9z.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-CRDYS4Jb.js";
import { a as projectOutboundPayloadPlanForDelivery, t as createOutboundPayloadPlan } from "./payloads-BNQsXibr.js";
import { n as createPreviewMessageReceipt } from "./live-DjttXqqq.js";
import { h as resolveChannelConfigWrites } from "./channel-config-helpers-Q5p9ejlB.js";
import { s as formatReasoningMessage } from "./embedded-agent-utils-BQcyBXno.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-f472QJN_.js";
import { c as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-Bcq9PRwO.js";
import { t as isApprovalNotFoundError } from "./approval-errors-DaOTGqJF.js";
import "./error-runtime-DjAm2R_B.js";
import "./media-runtime-CVHUHNy4.js";
import "./number-runtime-CORbdVbA.js";
import "./runtime-config-snapshot-CVhXA30s.js";
...
import "./text-chunking-BcNuyNPW.js";
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval } from "./conversation-binding-Xif5zAc6.js";
import { r as getPluginCommandSpecs } from "./command-specs-CVIyG8X5.js";
import { c as parseCommandArgs, i as formatCommandArgMenuTitle, n as buildCommandTextFromArgs, o as listNativeCommandSpecs, r as findCommandByNativeName, s as listNativeCommandSpecsForConfig, u as resolveCommandArgMenu } from "./commands-registry-Vmpn6ZeA.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Dsnaqb-N.js";
import { n as resolveStoredModelOverride } from "./stored-model-override-BmGQexf2.js";
import { o as normalizeTelegramApiRoot, r as resolveTelegramTransport } from "./fetch-BZhi2dcZ.js";
import "./routing-DgmMc1xB.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-DCl07AQa.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-BA0IVbwB.js";
import { i as shouldAckReaction, n as removeAckReactionAfterReply } from "./ack-reactions-CynKDO6S.js";
import "./history-KwlZSwDh.js";
import { t as createChannelReplyPipeline } from "./reply-pipeline-BeTxYlDn.js";
import { t as createChannelHistoryWindow } from "./history-window-FJPn99Oi.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-f9_11_Ko.js";
import "./channel-policy-DLbIVuEn.js";
import "./reply-history-DhbwUiVo.js";
import { m as parseExecApprovalCommandText } from "./exec-approval-reply-DX1AI0Hh.js";
import "./approval-reply-runtime-DECda3up.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BNLrZH-T.js";
import { n as resolveNativeCommandsEnabled, r as resolveNativeSkillsEnabled, t as isNativeCommandsExplicitlyDisabled } from "./commands-DYrW8UgJ.js";
import "./config-mutation-DCnGs3pY.js";
import { t as listSkillCommandsForAgents } from "./chat-commands-B4LVRxAA.js";
import { n as isBtwRequestText } from "./btw-command-CPlHzqSX.js";
import { t as generateConversationLabel } from "./conversation-label-generator-B-G-6loA.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./reply-dispatch-runtime-BpI2TpTb.js";
import "./reply-chunking-BbHTZ7sL.js";
import { f as runChannelInboundEvent } from "./inbound-reply-dispatch-C6E7YIIg.js";
import { o as createMessageReceiveContext } from "./channel-outbound-B8Zhao7j.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-Dr3f0mtP.js";
import "./dedupe-runtime-DGn7jUTF.js";
import "./model-session-runtime-CkieVekl.js";
import { n as resolveConfiguredBindingRoute, r as resolveRuntimeConversationBindingRoute } from "./binding-routing-Pt0kZriM.js";
import "./conversation-runtime-CcatpS1e.js";
import "./agent-runtime-oQHrKJM5.js";
import { i as createInteractiveConversationBindingHelpers, r as dispatchPluginInteractiveHandler } from "./plugin-runtime-C4qAqHwR.js";
import "./agent-harness-runtime-CvfBQKrV.js";
import "./hook-runtime-Cxss_xBr.js";
import "./markdown-table-runtime-CJFQm0u8.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-CrPbO7Go.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-BF9yz3ze.js";
import { n as formatModelsAvailableHeader } from "./commands-models-bOIALJPK.js";
import "./command-auth-native-39p2RSJ5.js";
import "./command-primitives-runtime-9qfcpr71.js";
import "./command-status-CHDWdQMN.js";
import "./command-detection-SylJwOn3.js";
import "./command-surface-BRjJlpT9.js";
import { i as resolveUnmentionedGroupInboundPolicy, l as shouldDebounceTextInbound, o as formatLocationText, r as classifyChannelInboundEvent, s as toLocationContext } from "./channel-inbound-VeiRhql9.js";
import { a as DEFAULT_TIMING, i as DEFAULT_EMOJIS } from "./channel-feedback-DfgrCmIQ.js";
import "./channel-mention-gating-CGupd_u-.js";
import "./channel-ingress-runtime-DImO1qFb.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-o4NWeNU6.js";
import { t as loadSessionStore } from "./session-store-runtime-MxmQ3Mxn.js";
import "./models-provider-runtime-BpEIwPAe.js";
import "./skill-commands-runtime-BSxdpt3F.js";
import "./native-command-config-runtime-0JkKLTAj.js";
import { a as resolveDefaultTelegramAccountId, o as resolveTelegramAccount, s as resolveTelegramMediaRuntimeOptions } from "./accounts-CEJGgCX3.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-BICYIDuF.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BsEeTv1V.js";
...
import { t as resolveTelegramInlineButtons } from "./button-types-D82TFKU1.js";
import { a as renderTelegramHtmlText, n as markdownToTelegramChunks } from "./format-Dsg8zHEJ.js";
import { d as buildModelsKeyboard, g as resolveModelSelection, h as parseModelCallbackData, m as getModelsPageSize, o as buildTelegramModelsMenuButtons, p as calculateTotalPages, t as buildCommandsPaginationKeyboard } from "./command-ui-Tf2rUH6T.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-B1yuPCq5.js";
import { a as createTelegramMessageDispatchReplayGuard, i as commitTelegramMessageDispatchReplay, r as claimTelegramMessageDispatchReplay, s as releaseTelegramMessageDispatchReplay } from "./message-dispatch-dedupe-d8x7JRv8.js";
import { r as cacheSticker } from "./sticker-cache-store-BBgENUvY.js";
import { r as createTelegramThreadBindingManager } from "./thread-bindings-CW1c7-y9.js";
import { n as getTopicName, o as resolveTopicNameCacheScope, s as updateTopicName } from "./topic-name-cache-DBHQx69z.js";
import { t as describeStickerImage } from "./sticker-cache-BusHJfms.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-CWn3YBP-.js";
import { A as apiThrottler, C as resolveTelegramClientTimeoutMinimumSeconds, D as withTelegramApiErrorLogging, O as getOrCreateAccountThrottler, S as createTelegramClientFetch, T as resolveTelegramOutboundClientTimeoutFloorSeconds, a as editMessageTelegram, b as buildInlineKeyboard, j as sequentialize, k as Bot, w as resolveTelegramClientTimeoutSeconds, x as asTelegramClientFetch, y as recordOutboundMessageForPromptContext } from "./send-BTL0AC25.js";
import { t as beginTelegramInboundEventDeliveryCorrelation } from "./inbound-event-delivery-DAcj4p9-.js";
import { a as buildCappedTelegramMenuCommands, i as createTelegramDraftStream, n as createNativeTelegramToolProgressDraft, o as buildPluginTelegramMenuCommands, r as resolveTelegramExecApproval, s as syncTelegramMenuCommands, t as defaultTelegramBotDeps } from "./bot-deps-Nw3VjzKb.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BfSe6LIA.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-CBc4nocs.js");
...
function createLaneTextDeliverer(params) {
	...
	const streamText = async (laneName, lane, text, payload, isFinal, buttons) => {
		...
		const deliveredPrefixBeforeUpdate = isFinal && deliveredStreamTextBeforeUpdate !== void 0 && isDeliveredPrefix({
		...
		const deliveredStreamTextAfterStop = stream.lastDeliveredText?.();
		if (isFinal && deliveredStreamTextAfterStop !== void 0 && deliveredStreamTextAfterStop !== firstChunk.trimEnd()) {
			if (isDeliveredPrefix({
				deliveredText: deliveredStreamTextAfterStop,
				finalText
			}) && deliveredStreamTextAfterStop.length > firstChunk.trimEnd().length) return await finalizeDeliveredPrefix(deliveredStreamTextAfterStop, messageId);
			return;
		}
...
const dispatchTelegramMessage = async ({ context, bot, cfg, runtime, replyToMode, streamMode, textLimit, telegramCfg, telegramDeps: injectedTelegramDeps, opts }) => {
	...
	const telegramDeps = injectedTelegramDeps ?? (await import("./bot-deps-D_FrRoZK.js")).defaultTelegramBotDeps;
