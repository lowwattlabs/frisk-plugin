...
import { t as getActiveRuntimePluginRegistry } from "./active-runtime-registry-C6-3LW2G.js";
import { d as resolvePluginApprovalTimeoutMs } from "./plugin-approvals-WkXJ-bse.js";
import { Ki as ErrorCodes, _t as validateNodePairRemoveParams, bt as validateNodePendingAckParams, ct as validateNodeDescribeParams, dt as validateNodeInvokeParams, ft as validateNodeInvokeResultParams, gt as validateNodePairRejectParams, ht as validateNodePairListParams, lt as validateNodeEventParams, mt as validateNodePairApproveParams, pt as validateNodeListParams, qi as errorShape, vt as validateNodePairRequestParams, wt as validateNodeRenameParams, yt as validateNodePairVerifyParams } from "./src-CgoRVpph.js";
import { a as removePairedNode, i as rejectNodePairing, l as verifyNodeToken, o as renamePairedNode, r as listNodePairing, s as requestNodePairing, t as approveNodePairing } from "./node-pairing-CO8saNqD.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins, s as removeRemoteNodeInfo } from "./remote-DEjg5ClH.js";
import { c as refreshClientPluginNodeCapability } from "./plugin-node-capability-DG6eW8bP.js";
import { a as normalizeDeclaredNodeCommands, n as isForegroundRestrictedPluginNodeCommand, o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-D5sNzPzb.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError, r as respondUnavailableOnThrow, t as respondInvalidParams } from "./nodes.helpers-B-J4T3y7.js";
import { l as listDevicePairing } from "./device-pairing-DkTELHfz.js";
import { i as buildSystemRunApprovalBinding, l as toSystemRunApprovalMismatchError, o as matchSystemRunApprovalBinding, r as resolveSystemRunCommandRequest, s as missingSystemRunApprovalBinding } from "./system-run-command-B0MTslE4.js";
import { r as resolveSystemRunApprovalRuntimeContext } from "./system-run-approval-context-BAtL2UQ4.js";
import { c as sendApnsBackgroundWake, d as shouldClearStoredApnsRegistration, f as resolveApnsRelayConfigFromEnv, n as loadApnsRegistration, o as resolveApnsAuthConfigFromEnv, s as sendApnsAlert, t as clearApnsRegistrationIfCurrent } from "./push-apns-CT2owbry.js";
import { n as getKnownNode, r as listKnownNodes, t as createKnownNodeCatalog } from "./node-catalog-CILXRoM4.js";
import { u as resolveApprovalRequestRecipientConnIds } from "./approval-shared-D1AhgbZX.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-C0U21Zbr.js");
