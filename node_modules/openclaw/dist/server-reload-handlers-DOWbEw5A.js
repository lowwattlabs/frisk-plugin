...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BuEF0uTi.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-DxnZU_9l.js";
import { a as resetModelCatalogCache } from "./model-catalog-BN-bUmfZ.js";
import { a as warmCurrentProviderAuthStateOffMainThread, n as clearCurrentProviderAuthState } from "./model-provider-auth-CN4ZPHDo.js";
import { d as listActiveEmbeddedRunSessionIds, f as listActiveEmbeddedRunSessionKeys, u as getActiveEmbeddedRunCount } from "./run-state-DzXVr7P-.js";
import { l as getTotalQueueSize } from "./command-queue-LbK8r37L.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-C2jGqnrb.js";
import { r as disposeAllSessionMcpRuntimes } from "./agent-bundle-mcp-runtime-D9yY5Bw7.js";
import "./agent-bundle-mcp-tools-Cj0bYMPi.js";
import { n as clearSecretsRuntimeSnapshot, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-LK_7s91k.js";
import { r as resetDirectoryCache } from "./target-resolver-BbdS2ktJ.js";
...
import { v as resolveHooksConfig } from "./hooks-BByyPpU2.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-Cgml9D9l.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-9lCc4Vtb.js";
...
import { t as buildGatewayCronService } from "./server-cron-CJwAiILI.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-Bkz_hM0W.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-DCG2gFoz.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-CbTXZTAO.js";
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-Bto37dH7.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-Dlsic7d0.js"), import("./gmail-watcher-lifecycle-wQ4L1kd4.js")]);
