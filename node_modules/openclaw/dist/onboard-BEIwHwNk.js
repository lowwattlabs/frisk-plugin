...
import { d as resolveGatewayPort } from "./paths-CiHrdfZh.js";
import { t as formatCliCommand } from "./command-format-CcxbKMj_.js";
import { t as restoreTerminalState } from "./restore-BBIPYJjW.js";
import { p as resolveUserPath } from "./utils-CFG_gPqL.js";
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef } from "./types.secrets-BEnNl80Y.js";
...
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-Dcup1g4i.js";
import { u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import { i as replaceConfigFile } from "./config-Ba5VqNR9.js";
import { t as randomToken } from "./random-token-hQenuzDT.js";
import { r as formatInvalidPortOption } from "./error-format-17foa2IM.js";
...
import { a as stripPendingPluginInstallRecords, i as hasPendingPluginInstallRecords, n as commitConfigWriteWithPendingPluginInstalls, s as unchangedPendingPluginInstallRecordIds } from "./plugins-install-record-commit-M1OtsqMl.js";
import { c as normalizeGatewayTokenInput, m as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-Cevaj40Q.js";
import { i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-DkXbIzEo.js";
import { i as applySkipBootstrapConfig, r as applyLocalSetupWorkspaceConfig } from "./onboard-config-CpTd50fX.js";
import { t as createNonInteractiveLoggingPrompter } from "./non-interactive-prompter-CGPDOJMx.js";
import { t as runSetupWizard } from "./setup-BJeVdYYO.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-6ToqW7oe.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-1KR7wBaD.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	const inferredAuthChoice = opts.authChoice ? void 0 : (await import("./auth-choice-inference-DLOLUpBH.js")).inferAuthChoiceFromFlags(opts, {
		config: nextConfig,
		workspaceDir,
		env: process.env
	});
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-5aa29SrN.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-D-vkua0S.js");
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-2akb9Aol.js");
...
async function runNonInteractiveMigrationImport(params) {
	...
	const { detectSetupMigrationSources, runSetupMigrationImport } = await import("./setup.migration-import-Cm3gfxnM.js");
