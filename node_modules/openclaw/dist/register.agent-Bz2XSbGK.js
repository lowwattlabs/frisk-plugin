...
import { t as registerAgentTurnCommand } from "./register.agent-turn-uea1Wi49.js";
//#region src/cli/program/register.agent.ts
let agentsBindModulePromise;
function loadAgentsBindModule() {
	return agentsBindModulePromise ??= import("./agents.commands.bind-DDsZc62v.js");
}
async function loadAgentsAddCommand() {
	return (await import("./agents.commands.add-B-ux8Ghk.js")).agentsAddCommand;
}
...
async function loadAgentsDeleteCommand() {
	return (await import("./agents.commands.delete-D8l1uwHF.js")).agentsDeleteCommand;
}
async function loadAgentsSetIdentityCommand() {
	return (await import("./agents.commands.identity-CzUaTxb2.js")).agentsSetIdentityCommand;
}
async function loadAgentsListCommand() {
	return (await import("./agents.commands.list-C4ismryx.js")).agentsListCommand;
}
async function loadAgentsActionRuntime() {
	const [{ defaultRuntime }, { runCommandWithRuntime }] = await Promise.all([import("./runtime-R3uXaz-Y.js"), import("./cli-utils-DJZQyMxF.js")]);
	return {
		defaultRuntime,
