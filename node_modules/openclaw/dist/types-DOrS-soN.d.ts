import { hn as CliBackendConfig, i as OpenClawConfig, pt as TalkProviderConfig, t as ConfigFileSnapshot } from "./types.openclaw-DRmAZfDb.js";
...
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-DGn1azQf.js";
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-CI1MrrJ6.js";
import { E as ThinkingLevel, b as StreamFn, f as Model, l as ImageContent, n as Api, r as AssistantMessage } from "./types-DAMKpKGt.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-BZoNFPND.js";
import { o as SsrFPolicy } from "./ssrf-skjEI_i5.js";
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-J0uRRdaj.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, p as UnifiedModelCatalogKind } from "./manifest-registry-CJyp5yB5.js";
import { t as JsonSchemaObject } from "./json-schema.types-fpZiub1R.js";
import { t as PluginMetadataRegistryView } from "./plugin-metadata-snapshot.types-CvNIi2I5.js";
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-E3InxZGC.js";
import { g as ConfigMutationBase, w as ConfigReplaceResult } from "./config-Dwbv7fpe.js";
import { y as resolveStateDir } from "./paths-CRXdFqew.js";
import { f as ReasoningLevel, g as VerboseLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-DmzvP548.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode, h as InputProvenance, m as UserTurnTranscriptRecorder, n as GetReplyOptions, r as PartialReplyPayload, s as ReplyPayload } from "./types-BIVMBCTf.js";
import { Er as AgentTool, Vr as StreamFn$1, kr as AgentToolResult, wr as AgentMessage } from "./index-DKxB8WKn.js";
import { d as InboundEventKind, n as MsgContext } from "./templating-BdP7Fw7G.js";
import { a as TaskDeliveryStatus, c as TaskRegistrySummary, d as TaskScopeKind, f as TaskStatus, h as CommandQueueEnqueueFn, i as TaskDeliveryState, l as TaskRuntime, m as TaskTerminalOutcome, n as TaskFlowRecord, o as TaskNotifyPolicy, p as TaskStatusCounts, r as TaskFlowStatus, s as TaskRecord, t as JsonValue, u as TaskRuntimeCounts } from "./task-flow-registry.types-D25p0dJW.js";
...
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-CGJJ5-ic.js";
...
import { _ as completeSimple } from "./llm-CMjGaH_v.js";
...
import { r as AnyAgentTool } from "./common-lqMg8SUn.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types--v-RuEVE.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-Ckuzj_ms.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-J-ma9Bgj.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { C as ResolvedProviderAuth } from "./model-auth-e3WSmRWs.js";
...
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-B5wLJrPD.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-CBuwOUdA.js";
import { _ as resolveSessionFilePath, a as patchSessionEntry, b as resolveStorePath, d as updateSessionStoreEntry, f as upsertSessionEntry, i as listSessionEntries, m as loadSessionStore, r as getSessionEntry, u as updateSessionStore } from "./session-key-BkT7hmJl.js";
import { f as MediaUnderstandingProvider } from "./types-ClnP8i2o.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-rF_mZWs62.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-BHE0eJxC.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-Dd_CPMW5.js";
...
import { b as SecretInputMode, n as GatewayRequestHandler } from "./types-Di_2bRk2.js";
import { a as onAgentEvent, n as AgentEventPayload, r as AgentEventStream } from "./agent-events-BNqUqt2U.js";
...
import { a as MediaUnderstandingRuntime } from "./runtime-types-Cr-2Zcn4.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-CgPmPU2O.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-XhDZevLb.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-B6ki--M3.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-BJCRIDs_.js";
import { Dt as PluginHookToolContext, F as PluginHookBeforeToolCallEvent, I as PluginHookBeforeToolCallResult, Kt as PluginNextTurnInjection, Ot as PluginHookToolInputKind, Yt as PluginJsonValue, Z as PluginHookHandlerMap, c as PluginApprovalResolution, cn as PluginHookBeforeAgentStartResult, it as PluginHookName, kt as PluginHookToolKind, qt as PluginNextTurnInjectionEnqueueResult } from "./hook-types-eDvaxJMP.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { n as ChannelPlugin } from "./types.public-CNInoGpL.js";
import { Ht as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-DykRJWO9.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-BFks2xc8.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-41XqYhe4.js";
import { r as ReplyDispatcher } from "./reply-dispatcher.types-7MBFJOdS.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-CQ4LXhv4.js";
import { n as RecordInboundSession$1 } from "./session.types-Cgpw8i1B.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-Dn4z0ZkQ.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-BW7xwRSe.js";
import { t as convertMarkdownTables } from "./tables-B_IykLqQ.js";
import { c as DispatchReplyFromConfig, o as createReplyDispatcherWithTyping, t as DispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher.types-COtL3wjl.js";
import { n as finalizeInboundContext } from "./inbound-context-CTX8BgKW.js";
import { a as resolveEnvelopeFormatOptions, n as formatAgentEnvelope, r as formatInboundEnvelope } from "./envelope-CAlRBSla.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-CtK8Nq4d.js";
import { n as ReadChannelAllowFromStoreForAccount, r as UpsertChannelPairingRequestForAccount } from "./pairing-store.types-DDjYVbBG.js";
import { t as buildPairingReply } from "./pairing-messages-ulM_SapQ.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-C9ntxdZq.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-GkvCZbn0.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-CqkwecYF.js";
import { a as runPreparedInboundReply, b as buildChannelInboundEventContext, i as runChannelInboundEvent, t as dispatchChannelInboundReply } from "./kernel-ntYSCtA7.js";
...
//#endregion
export { OpenClawPluginService as $, normalizeTtsAutoMode as $a, runBeforeToolCallHook as $i, PluginRuntime as $n, PromptMode as $o, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $r, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, LlmCompleteParams as Aa, AgentHarnessDeliveryDefaults as Ai, ProviderResolvePromptOverlayContext as An, PluginWebSearchProviderEntry as Ao, CodexAppServerToolResultEvent as Ar, ProviderSyntheticAuthResult as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, DetachedTaskFinalizeParams as Ba, PreemptiveCompactionRoute as Bi, ProviderTransportTurnState as Bn, WebSearchProviderPlugin as Bo, CliBackendThinkingLevel as Br, ProviderCatalogResult as Bt, OpenClawPluginApi as C, SubagentEndReason as Ca, RealtimeTranscriptionSessionCallbacks as Ci, ProviderReplaySanitizeMode as Cn, OpenClawPluginHookOptions as Co, PluginSessionTurnUnscheduleByTagParams as Cr, ProviderRuntimePluginHandle as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, TranscriptRewriteResult as Da, AgentHarnessAttemptResult as Di, ProviderResolveAuthProfileIdContext as Dn, emitSessionTranscriptUpdate as Do, CodexAppServerExtensionContext as Dr, ProviderResolveExternalAuthProfilesContext as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, TranscriptRewriteRequest as Ea, AgentHarnessAttemptParams as Ei, ProviderReplayToolCallIdMode as En, OpenClawPluginToolOptions as Eo, PluginTrustedToolPolicyRegistration as Er, ProviderExternalOAuthProfile as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, BoundTaskFlowsRuntime as Fa, AgentHarnessSupport as Fi, ProviderRuntimeProviderConfig as Fn, WebFetchProviderToolDefinition as Fo, CliBackendPlugin as Fr, MessagingToolSourceReplyPayload as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, TaskRunCancelResult as Ga, BeforeToolCallPolicyDiagnosticState as Gi, RealtimeTranscriptionProviderPlugin as Gn, GenerateVideoParams as Go, AgentToolResultMiddlewareContext as Gr, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, TaskFlowDetail as Ha, normalizeUsage as Hi, ProviderValidateReplayTurnsContext as Hn, WebSearchProviderToolDefinition as Ho, PluginTextReplacement as Hr, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, BoundTaskRunsRuntime as Ia, AgentHarnessSupportContext as Ii, ProviderSanitizeReplayHistoryContext as In, WebFetchRuntimeMetadataContext as Io, CliBackendPrepareExecutionContext as Ir, HEARTBEAT_RESPONSE_TOOL_NAME as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, ResolvedTtsConfig as Ja, ToolOutcomeObserver as Ji, TranscriptSourceProvider as Jn, GenerateImageRuntimeResult as Jo, AgentToolResultMiddlewareOptions as Jr, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, TaskRunDetail as Ka, DeferredPluginToolApproval as Ki, RealtimeVoiceProviderPlugin as Kn, GenerateVideoRuntimeResult as Ko, AgentToolResultMiddlewareEvent as Kr, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, PluginRuntimeTaskFlows as La, CompactEmbeddedAgentSessionParams as Li, ProviderSystemPromptContributionContext as Ln, WebSearchCredentialResolutionSource as Lo, CliBackendPreparedExecution as Lr, HeartbeatToolResponse as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, LlmCompleteUsage as Ma, AgentHarnessResultClassification as Mi, ProviderResolveUsageAuthContext as Mn, WebFetchProviderContext as Mo, CliBackendAuthEpochMode as Mr, EmbeddedAgentRunMeta as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, PluginRuntimeCore as Na, AgentHarnessSideQuestionParams as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, WebFetchProviderId as No, CliBackendNativeToolMode as Nr, EmbeddedAgentRunResult as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, LlmCompleteCaller as Oa, AgentHarnessCompactParams as Oi, ProviderResolveDynamicModelContext as On, onSessionTranscriptUpdate as Oo, CodexAppServerExtensionFactory as Or, ProviderResolveExternalOAuthProfilesContext as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, RuntimeLogger as Pa, AgentHarnessSideQuestionResult as Pi, ProviderResolvedUsageAuth as Pn, WebFetchProviderPlugin as Po, CliBackendNormalizeConfigContext as Pr, MessagingToolSend as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, TTS_AUTO_MODES as Qa, requestDeferredPluginToolApproval as Qi, CreatePluginRuntimeOptions as Qn, RunEmbeddedAgentParams as Qo, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qr, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, PluginRuntimeTaskRuns as Ra, EmbeddedRunAttemptParams as Ri, ProviderToolSchemaDiagnostic as Rn, WebSearchProviderContext as Ro, CliBackendResolveExecutionArgs as Rr, normalizeHeartbeatToolResponse as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, IngestResult as Sa, RealtimeTranscriptionSession as Si, ProviderReplayPolicyContext as Sn, OpenClawPluginActiveModelContext as So, PluginSessionTurnScheduleParams as Sr, ProviderRuntimeModel as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, TranscriptRewriteReplacement as Ta, AgentHarness as Ti, ProviderReplaySessionState as Tn, OpenClawPluginToolFactory as To, PluginToolMetadataRegistration as Tr, ProviderExternalAuthProfile as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, TaskFlowView as Ua, AgentRuntimePlan as Ui, ProviderWebSocketSessionPolicy as Un, WebSearchProviderToolExecutionContext as Uo, PluginTextTransforms as Ur, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, DetachedTaskLifecycleRuntime as Va, NormalizedUsage as Vi, ProviderUsageAuthToken as Vn, WebSearchProviderSetupContext as Vo, CliBundleMcpMode as Vr, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, TaskRunAggregateSummary as Wa, BuildAgentRuntimePlanParams as Wi, ProviderWrapStreamFnContext as Wn, WebSearchRuntimeMetadataContext as Wo, AgentToolResultMiddleware as Wr, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, TtsConfigResolutionContext as Xa, hasBeforeToolCallPolicy as Xi, UnifiedModelCatalogProviderPlugin as Xn, CurrentInboundPromptContext as Xo, AgentToolResultMiddlewareRuntime as Xr, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, ResolvedTtsModelOverrides as Ya, getBeforeToolCallPolicyDiagnosticState as Yi, UnifiedModelCatalogProviderContext as Yn, resolveAgentTimeoutMs as Yo, AgentToolResultMiddlewareResult as Yr, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, resolveEffectiveTtsConfig as Za, isToolWrappedWithBeforeToolCallHook as Zi, VideoGenerationProviderPlugin as Zn, EmbeddedRunTrigger as Zo, OpenClawAgentToolResult as Zr, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, ContextEngineOperation as _a, RealtimeVoiceToolResultOptions as _i, ProviderPrepareRuntimeAuthContext as _n, SpeechTelephonySynthesisRequest as _o, PluginSessionAttachmentResult as _r, augmentModelCatalogWithProviderPlugins as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, ContextEngineFactoryContext as aa, RealtimeVoiceBridgeEvent as ai, ProviderNormalizeToolSchemasContext as an, SpeechProviderConfiguredContext as ao, ProviderResolveConfigApiKeyContext as ar, ClientToolDefinition as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, ContextEngineRuntimeContext as ba, RealtimeTranscriptionProviderId as bi, ProviderReasoningOutputModeContext as bn, TtsDirectiveParseResult as bo, PluginSessionSchedulerJobHandle as br, ProviderThinkingPolicyContext as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, resolveContextEngineOwnerPluginId as ca, RealtimeVoiceCloseReason as ci, ProviderPlugin as cn, SpeechProviderPrepareSynthesisContext as co, PluginAgentEventSubscriptionRegistration as cr, AgentSimpleCompletionSelection as cs, PluginCommandResult as ct, MigrationItemKind as d, CompactResult as da, RealtimeVoiceProviderConfiguredContext as di, ProviderPluginWizard as dn, SpeechProviderResolveTalkConfigContext as do, PluginRunContextPatch as dr, SimpleCompletionModelOptions as ds, PluginEmbeddingProvider as dt, setBeforeToolCallDiagnosticsEnabled as ea, RealtimeVoiceAudioFormat as ei, ProviderModernModelPolicyContext as en, SpeechDirectiveTokenParseContext as eo, SubagentRunParams as er, AgentInternalEvent as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, ContextEngine as fa, RealtimeVoiceProviderId as fi, ProviderPluginWizardModelPicker as fn, SpeechProviderResolveTalkOverridesContext as fo, PluginRuntimeLifecycleRegistration as fr, completeWithPreparedSimpleCompletionModel as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, ContextEngineMaintenanceResult as ga, RealtimeVoiceToolCallEvent as gi, ProviderPrepareExtraParamsContext as gn, SpeechSynthesisTarget as go, PluginSessionAttachmentParams as gr, resolveModelAsync as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, ContextEngineInfo as ha, RealtimeVoiceTool as hi, ProviderPrepareDynamicModelContext as hn, SpeechSynthesisStreamResult as ho, PluginSessionActionResult as hr, resolveSimpleCompletionSelectionForAgent as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, ContextEngineFactory as ia, RealtimeVoiceBridgeCreateRequest as ii, ProviderNormalizeResolvedModelContext as in, SpeechProviderConfig as io, ProviderNormalizeConfigContext as ir, AgentStreamParams as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, LlmCompleteResult as ja, AgentHarnessResetParams as ji, ProviderResolveTransportTurnStateContext as jn, WebFetchCredentialResolutionSource as jo, CodexAppServerToolResultHandlerResult as jr, EmbeddedAgentCompactResult as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, LlmCompleteMessage as ka, AgentHarnessCompactResult as ki, ProviderResolveNonInteractiveApiKeyParams as kn, PluginWebFetchProviderEntry as ko, CodexAppServerExtensionRuntime as kr, ProviderResolveSyntheticAuthContext as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, AssembleResult as la, RealtimeVoiceProviderCapabilities as li, ProviderPluginCatalog as ln, SpeechProviderPreparedSynthesis as lo, PluginControlUiDescriptor as lr, PreparedSimpleCompletionModel as ls, PluginConfigMigration as lt, MigrationProviderContext as m, ContextEngineHostRequirements as ma, RealtimeVoiceRole as mi, ProviderPreferRuntimeResolvedModelContext as mn, SpeechSynthesisStreamRequest as mo, PluginSessionActionRegistration as mr, prepareSimpleCompletionModelForAgent as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, AgentHarnessTaskRuntimeScope as na, RealtimeVoiceBridge as ni, ProviderNonInteractiveApiKeyResult as nn, SpeechListVoicesRequest as no, settleReplyDispatcher as nr, BlockReplyChunking as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, registerContextEngine as oa, RealtimeVoiceBrowserSession as oi, ProviderNormalizeTransportContext as on, SpeechProviderId as oo, PluginAgentEventEmitParams as or, ExecElevatedDefaults as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, ContextEngineHostCapability as pa, RealtimeVoiceProviderResolveConfigContext as pi, ProviderPluginWizardSetup as pn, SpeechSynthesisRequest as po, PluginSessionActionContext as pr, prepareSimpleCompletionModel as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, TaskRunView as qa, HookContext as qi, SpeechProviderPlugin as qn, GenerateImageParams as qo, AgentToolResultMiddlewareHarness as qr, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, resolveEmbeddedAgentRuntime as ra, RealtimeVoiceBridgeCallbacks as ri, ProviderNormalizeModelIdContext as rn, SpeechModelOverridePolicy as ro, ProviderApplyConfigDefaultsContext as rr, EmbeddedBlockChunker as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, resolveContextEngine as sa, RealtimeVoiceBrowserSessionCreateRequest as si, ProviderOAuthProfileIdRepair as sn, SpeechProviderOverrides as so, PluginAgentEventEmitResult as sr, ExecToolDefaults as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, wrapToolWithBeforeToolCallHook as ta, RealtimeVoiceBargeInOptions as ti, ProviderNonInteractiveApiKeyCredentialParams as tn, SpeechDirectiveTokenParseResult as to, SubagentRunResult as tr, OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, BootstrapResult as ua, RealtimeVoiceProviderConfig as ui, ProviderPluginDiscovery as un, SpeechProviderResolveConfigContext as uo, PluginRunContextGetParams as ur, PreparedSimpleCompletionModelForAgent as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, ContextEngineProjection as va, RealtimeTranscriptionProviderConfig as vi, ProviderPreparedRuntimeAuth as vn, SpeechVoiceOption as vo, PluginSessionExtensionProjection as vr, provider_runtime_d_exports as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, SubagentSpawnPreparation as wa, RealtimeTranscriptionSessionCreateRequest as wi, ProviderReplaySessionEntry as wn, OpenClawPluginToolContext as wo, PluginSessionTurnUnscheduleByTagResult as wr, ProviderSystemPromptContribution as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, IngestBatchResult as xa, RealtimeTranscriptionProviderResolveConfigContext as xi, ProviderReplayPolicy as xn, ResolvedProviderRuntimeAuth as xo, PluginSessionSchedulerJobRegistration as xr, ProviderThinkingProfile as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, ContextEnginePromptCacheInfo as ya, RealtimeTranscriptionProviderConfiguredContext as yi, ProviderReasoningOutputMode as yn, TtsDirectiveOverrides as yo, PluginSessionExtensionRegistration as yr, ProviderDefaultThinkingPolicyContext as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, PluginRuntimeTasks as za, EmbeddedRunAttemptResult as zi, ProviderTransformSystemPromptContext as zn, WebSearchProviderId as zo, CliBackendResolveExecutionArgsContext as zr, ProviderCatalogOrder as zt };