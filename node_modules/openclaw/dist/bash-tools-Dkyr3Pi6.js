...
import "./openclaw-exec-env-DGz-Z2Ir.js";
...
import { a as normalizeHostOverrideEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName, s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-JwhXx2sc.js";
import "./utils-CFG_gPqL.js";
...
import { f as resolveAgentIdFromSessionKey, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { a as logWarn, r as logInfo } from "./logger-CuDPuGSa.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-BRbqTwTq.js";
import { f as resolveApprovalAuditTrustPath } from "./exec-safe-bin-trust-CyMN5lNl.js";
import { O as normalizeExecutableToken, c as isShellWrapperExecutable, k as splitShellArgs, t as POSIX_SHELL_WRAPPERS, u as resolveShellWrapperTransportArgv } from "./shell-wrapper-resolution-C6P5vfdO.js";
...
import { i as normalizeMessageChannel, n as isGatewayMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import "./message-channel-rCegTRAO.js";
import { C as parseExecApprovalResultText, S as isExecDeniedResultText, d as sanitizeUserFacingText, x as formatExecDeniedUserMessage } from "./sanitize-user-facing-text-lkgL0Nf2.js";
import { n as getDiagnosticSessionState } from "./diagnostic-session-state-DwjGSduD.js";
import { c as EXEC_TOOL_DISPLAY_SUMMARY, l as PROCESS_TOOL_DISPLAY_SUMMARY } from "./tool-catalog-D5QsrL1H.js";
import { C as textResult, o as failedTextResult } from "./common-CQZwSsYR.js";
import { t as callGatewayTool } from "./gateway-maGHz7cj.js";
import { c as describeInterpreterInlineEval, t as buildCommandPayloadCandidates } from "./risks-TB-98hVH.js";
import { l as analyzeShellCommand, n as evaluateShellAllowlist, u as buildEnforcedShellCommand } from "./exec-approvals-allowlist-D_2J4fF2.js";
...
import { r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-DQ5UvZ4b.js";
import { n as describeProcessTool, t as describeExecTool } from "./bash-tools.descriptions-C700cR_t.js";
import { i as resolveNodeIdFromList, t as listNodes, u as stripMalformedXmlArgValueSuffixFromKeys } from "./nodes-utils-C7t-bOVx.js";
import { n as processSchema, t as execSchema } from "./bash-tools.schemas-BrOQBs2H.js";
import "./delivery-context-Cm-3AUIL.js";
import { t as resolveExternalBestEffortDeliveryTarget } from "./best-effort-delivery-CIzV-RHI.js";
import { t as sendMessage } from "./message-D-Ux1-Y6.js";
import { t as formatDurationCompact } from "./format-duration-BrZ-AaEJ.js";
import { a as coerceEnv, c as readEnvInt, d as sliceLogLines, f as truncateMiddle, i as clampWithDefault, l as resolveSandboxWorkdir, n as buildSandboxEnv, o as deriveSessionName, s as pad, u as resolveWorkdir } from "./bash-tools.shared-Dk8EsQd3.js";
import { a as drainSession, c as listFinishedSessions, d as markExited, f as setJobTtlMs, i as deleteSession, l as listRunningSessions, o as getFinishedSession, p as tail, s as getSession, u as markBackgrounded } from "./bash-process-registry-D5JXWGY1.js";
import { i as normalizePathPrepend, t as applyPathPrepend } from "./path-prepend-BO0ttmYL.js";
import { t as getProcessSupervisor } from "./supervisor-Cw-nY4TI.js";
import { a as DEFAULT_PENDING_MAX_OUTPUT, c as createApprovalSlug, f as resolveApprovalRunningNoticeMs, h as renderExecOutputText, i as DEFAULT_PATH, m as runExecProcess, n as DEFAULT_APPROVAL_TIMEOUT_MS, o as applyShellPath, p as resolveExecTarget, r as DEFAULT_MAX_OUTPUT, s as buildApprovalPendingMessage, t as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, u as normalizeNotifyOutput } from "./bash-tools.exec-runtime-BrSQ_5XV.js";
import { i as resolveExecApprovalInitiatingSurfaceState } from "./exec-approval-surface-B2xm0n9G.js";
import { u as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-DX1AI0Hh.js";
import { n as detectPolicyInlineEval } from "./policy-CRFzmrvj.js";
import { i as defaultExecAutoReviewer, t as createModelExecAutoReviewer } from "./exec-auto-reviewer-sHev8nbf.js";
import { i as registerExecApprovalFollowupRuntimeHandoff, t as buildExecApprovalFollowupIdempotencyKey } from "./bash-tools.exec-approval-followup-state-ZlqqhDtL.js";
import { n as formatExecCommand, r as resolveSystemRunCommandRequest, t as extractShellCommandFromArgv } from "./system-run-command-B0MTslE4.js";
import { t as parsePreparedSystemRunPayload } from "./system-run-approval-context-BAtL2UQ4.js";
...
function createExecTool(defaults) {
	...
	const prepareParamsWithResolvedExecEnv = async (rawArgs, context) => {
		...
		if (!hookRunner?.hasHooks("resolve_exec_env")) return markResolveExecEnvPrepared(params);
		let host;
		try {
