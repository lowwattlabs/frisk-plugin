...
import { t as normalizeModelCatalog } from "./model-catalog-normalize-V3qo99NY.js";
import { n as copyRecordEntries } from "./safe-record-h1HsqKY4.js";
...
async function getCachedLiveCatalogValue(params) {
	...
	if (expiresAt !== void 0) liveCatalogCache.set(key, {
		expiresAt,
		value
	});
	try {
