...
import { W as TtsAutoMode } from "./types.slack-CI1MrrJ6.js";
import { a as SourceReplyDeliveryMode, s as ReplyPayload } from "./types-BIVMBCTf.js";
import { wr as AgentMessage } from "./index-DKxB8WKn.js";
import { t as FinalizedMsgContext } from "./templating-BdP7Fw7G.js";
import { t as DiagnosticTraceContext } from "./diagnostic-trace-context-DKGBqNVx.js";
import { t as PluginConversationBinding } from "./conversation-binding.types-41XqYhe4.js";
import { n as ReplyDispatchKind, r as ReplyDispatcher } from "./reply-dispatcher.types-7MBFJOdS.js";
...
//#endregion
export { PluginHookLlmInputEvent as $, PluginHookMessageReceivedEvent as $t, PluginHookBeforeInstallSkill as A, PluginHookToolResultPersistContext as At, PluginHookGatewayContext as B, isPluginHookName as Bt, PluginHookBeforeDispatchResult as C, PluginHookSubagentSpawnedEvent as Ct, PluginHookBeforeInstallPlugin as D, PluginHookToolContext as Dt, PluginHookBeforeInstallEvent as E, PluginHookSubagentTargetKind as Et, PluginHookBeforeToolCallEvent as F, PluginInstallSourcePathKind as Ft, PluginHookGatewayCronRemoveResult as G, PluginHeartbeatPromptContributionResult as Gt, PluginHookGatewayCronDeliveryStatus as H, PluginAgentTurnPrepareEvent as Ht, PluginHookBeforeToolCallResult as I, PluginInstallTargetType as It, PluginHookGatewayCronUpdateInput as J, PluginNextTurnInjectionRecord as Jt, PluginHookGatewayCronRunStatus as K, PluginNextTurnInjection as Kt, PluginHookContextWindowSource as L, PromptInjectionHookName as Lt, PluginHookBeforeMessageWriteEvent as M, PluginHookToolResultPersistResult as Mt, PluginHookBeforeMessageWriteResult as N, PluginInstallFinding as Nt, PluginHookBeforeInstallRequest as O, PluginHookToolInputKind as Ot, PluginHookBeforeResetEvent as P, PluginInstallRequestKind as Pt, PluginHookInboundClaimResult as Q, PluginHookMessageContext as Qt, PluginHookCronChangedEvent as R, isConversationHookName as Rt, PluginHookBeforeDispatchEvent as S, PluginHookSubagentEndedEvent as St, PluginHookBeforeInstallContext as T, PluginHookSubagentSpawningResult as Tt, PluginHookGatewayCronJob as U, PluginAgentTurnPrepareResult as Ut, PluginHookGatewayCronCreateInput as V, isPromptInjectionHookName as Vt, PluginHookGatewayCronJobState as W, PluginHeartbeatPromptContributionEvent as Wt, PluginHookGatewayStopEvent as X, PluginHookInboundClaimContext as Xt, PluginHookGatewayStartEvent as Y, PluginJsonValue as Yt, PluginHookHandlerMap as Z, PluginHookInboundClaimEvent as Zt, PluginHookBeforeAgentReplyResult as _, PluginHookSessionEndReason as _t, DeprecatedPluginHookName as a, PLUGIN_PROMPT_MUTATION_RESULT_FIELDS as an, PluginHookRegistration as at, PluginHookBeforeCompactionEvent as b, PluginHookSubagentDeliveryTargetEvent as bt, PluginApprovalResolution as c, PluginHookBeforeAgentStartResult as cn, PluginHookReplyDispatchResult as ct, PluginHookAfterToolCallEvent as d, PluginHookBeforeModelResolveResult as dn, PluginHookReplyPayloadSendingEvent as dt, PluginHookMessageSendingEvent as en, PluginHookLlmOutputEvent as et, PluginHookAgentContext as f, PluginHookBeforePromptBuildEvent as fn, PluginHookReplyPayloadSendingResult as ft, PluginHookBeforeAgentReplyEvent as g, PluginHookSessionEndEvent as gt, PluginHookBeforeAgentFinalizeResult as h, PluginHookSessionContext as ht, DEPRECATED_PLUGIN_HOOK_NAMES as i, InputGateDecision as in, PluginHookName as it, PluginHookBeforeInstallSkillInstallSpec as j, PluginHookToolResultPersistEvent as jt, PluginHookBeforeInstallResult as k, PluginHookToolKind as kt, PluginApprovalResolutions as l, PluginHookBeforeModelResolveAttachment as ln, PluginHookReplyPayload as lt, PluginHookBeforeAgentFinalizeEvent as m, stripPromptMutationFieldsFromLegacyHookResult as mn, PluginHookResolveExecEnvEvent as mt, ConversationHookName as n, PluginHookMessageSentEvent as nn, PluginHookModelCallEndedEvent as nt, PLUGIN_HOOK_NAMES as o, PluginHookBeforeAgentStartEvent as on, PluginHookReplyDispatchContext as ot, PluginHookAgentEndEvent as p, PluginHookBeforePromptBuildResult as pn, PluginHookResolveExecEnvContext as pt, PluginHookGatewayCronService as q, PluginNextTurnInjectionEnqueueResult as qt, DEPRECATED_PLUGIN_HOOKS as r, GateHookResult as rn, PluginHookModelCallStartedEvent as rt, PROMPT_INJECTION_HOOK_NAMES as s, PluginHookBeforeAgentStartOverrideResult as sn, PluginHookReplyDispatchEvent as st, CONVERSATION_HOOK_NAMES as t, PluginHookMessageSendingResult as tn, PluginHookModelCallBaseEvent as tt, PluginHookAfterCompactionEvent as u, PluginHookBeforeModelResolveEvent as un, PluginHookReplyPayloadSendingContext as ut, PluginHookBeforeAgentRunEvent as v, PluginHookSessionStartEvent as vt, PluginHookBeforeInstallBuiltinScan as w, PluginHookSubagentSpawningEvent as wt, PluginHookBeforeDispatchContext as x, PluginHookSubagentDeliveryTargetResult as xt, PluginHookBeforeAgentRunResult as y, PluginHookSubagentContext as yt, PluginHookDeprecation as z, isDeprecatedPluginHookName as zt };