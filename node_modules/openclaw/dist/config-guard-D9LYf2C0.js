import { h as shouldMigrateStateFromPath } from "./argv-8KO9gKcu.js";
import { o as resolveRequiredHomeDir } from "./home-dir-B1vnNUyG.js";
import { _ as resolveOAuthDir, h as resolveLegacyStateDirs, y as resolveStateDir } from "./paths-CiHrdfZh.js";
...
import { r as withSuppressedNotes } from "./note-DuS7ttKk.js";
...
async function ensureConfigReady(params) {
	...
	const runStateMigrationPreflight = async () => {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-c433lzRT.js")).runDoctorConfigPreflight({
			migrateState: true,
	...
	const { formatConfigIssueLines } = await import("./issue-format-DAeadT7O.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }, { isPluginPackagingRuntimeOutputInvalidConfigSnapshot }, { formatPluginPackagingRuntimeOutputRecoveryHint }] = await Promise.all([
		...
		import("./utils-qe_e9gA-.js"),
		import("./command-format-r6lEYFm9.js"),
		import("./recovery-policy-Cl3IaOSf.js"),
		import("./config-recovery-hints-C-rgZGoy.js")
	]);
	const rich = isRich();
