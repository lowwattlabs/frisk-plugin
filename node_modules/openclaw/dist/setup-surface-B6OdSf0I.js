...
import { o as isPrivateOrLoopbackHost } from "./net-Cm4muceK.js";
import "./string-coerce-runtime-DzE-BRXv.js";
import { O as promptAccountId, Q as splitSetupEntries, v as mergeAllowFromEntries } from "./setup-wizard-helpers-aMuEtwAz.js";
...
import { r as resolveMatrixEnvAuthReadiness } from "./env-auth-BzxZxWvz.js";
import { i as resolveMatrixAccount, r as resolveDefaultMatrixAccountId, t as listMatrixAccountIds } from "./accounts-BMNAWsb9.js";
import { r as moveSingleMatrixAccountConfigToNamedAccount, t as resolveMatrixSetupDmAllowFrom } from "./setup-dm-policy-Dh1WIIBR.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-B6IxkurD.js";
import { n as updateMatrixAccountConfig } from "./config-update-DJqR2C8o.js";
import { n as validateMatrixHomeserverUrl, t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-7Dkvd3qK.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-DdUn3XcM.js";
...
async function promptMatrixAllowFrom(params) {
	...
	while (true) {
		...
		if (pending.length > 0) {
			const { resolveMatrixTargets } = await import("./resolve-targets-B-eR5-wb.js");
	...
	if (accessConfig) if (accessConfig.policy !== "allowlist") next = setMatrixGroupPolicy(next, accessConfig.policy, params.accountId);
		...
		if (accessConfig.entries.length > 0) try {
			...
			for (const entry of accessConfig.entries) {
				...
				const { listMatrixDirectoryGroupsLive } = await import("./directory-live-BjtpvOek.js");
...
const matrixOnboardingAdapter = {
	...
	afterConfigWritten: async ({ previousCfg, cfg, accountId, runtime }) => {
		const { runMatrixSetupBootstrapAfterConfigWrite } = await import("./setup-bootstrap-JnzrekZr.js");
