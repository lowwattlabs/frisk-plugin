...
import { s as resolveArchiveKind } from "./archive-CO2Km8eH.js";
import { p as resolveUserPath, r as clampInt } from "./utils-CFG_gPqL.js";
import "./number-coercion-Z7n6tXLk.js";
import { n as resolvePreferredOpenClawTmpDir } from "./tmp-openclaw-dir-C60hWKdY.js";
import { t as parseClawHubPluginSpec } from "./clawhub-spec-C7n7skn-.js";
import "./clawhub-DJOHN8WO.js";
import { n as parseGitPluginSpec, t as installPluginFromGitSpec } from "./git-install-RU5chcpQ.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BuEF0uTi.js";
import { c as resolveOfficialExternalPluginInstall, n as getOfficialExternalPluginCatalogEntryForPackage, s as resolveOfficialExternalPluginId } from "./official-external-plugin-catalog-BB8GGJAo.js";
import { v as resolveSessionAgentId, y as resolveSessionAgentIds } from "./agent-scope-BcYNOCQG.js";
import { r as normalizeOptionalAccountId } from "./account-id-By1zn6Bl.js";
import { f as resolveAgentIdFromSessionKey } from "./session-key-BOpfMTUN.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir } from "./agent-scope-config-BoFGd2i9.js";
import { r as logVerbose } from "./globals-DiwHZb7D.js";
import { E as validateConfigObjectWithPlugins, M as resetConfigOverrides, N as setConfigOverride, P as unsetConfigOverride, j as getConfigOverrides, u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import { c as resolveContextConfigProviderForRuntime, i as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-Bc6sEjDj.js";
import { n as resolveAgentHarnessPolicy } from "./harness-runtimes-BYhR8wfO.js";
import "./archive-CBe_wA_B.js";
import "./installed-plugin-index-records-D0Nb__z2.js";
import { _ as resolveResponseUsageMode, h as normalizeUsageDisplay, u as isSessionDefaultDirectiveValue } from "./thinking-BHlJqFAp.js";
import { n as assertConfigWriteAllowedInCurrentMode } from "./nix-mode-write-guard-D7DUV_-D.js";
import { i as unsetConfigValueAtPath, n as parseConfigPath, r as setConfigValueAtPath, t as getConfigValueAtPath } from "./config-paths-CzLa6XwB.js";
import { t as setPluginEnabledInConfig } from "./toggle-config-BvWs5_zX.js";
import { t as parseDurationMs } from "./parse-duration-DCzQczTy.js";
import { o as transformConfigFileWithRetry } from "./config-Ba5VqNR9.js";
import { n as isRestartEnabled, t as isCommandFlagEnabled } from "./commands.flags-DlEB68fT.js";
import { g as triggerOpenClawRestart, p as scheduleGatewaySigusr1Restart } from "./restart-DxnZU_9l.js";
import { o as normalizeChannelId } from "./registry-snmJh0Ya.js";
import { t as getActivePluginChannelRegistry } from "./runtime-Cc67q459.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BUw7VcqN.js";
import { i as normalizeMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, r as resolveDefaultSessionStorePath } from "./paths-Bz9nEaho.js";
...
import { n as resolveChannelApprovalCapability, t as resolveChannelApprovalAdapter } from "./plugins-2jPMnXk3.js";
import { r as isInternalMessageChannel } from "./message-channel-rCegTRAO.js";
import { o as resolveFreshSessionTotalTokens } from "./types-DUYD_-CI.js";
import { t as extractDeliveryInfo } from "./delivery-info-BkYsqJjE.js";
import "./sessions-7_zgwGXH.js";
import { r as readLatestAssistantTextFromSessionTranscript } from "./transcript-DJ0xrK51.js";
import { y as prepareProviderRuntimeAuth } from "./provider-runtime-D9JyOweC.js";
import { i as ensureAuthProfileStoreWithoutExternalProfiles, n as ensureAuthProfileStore } from "./store-U0aP-Cup.js";
...
import { a as stripToolResultDetails } from "./session-transcript-repair-BWtVPADW.js";
import { i as streamSimple } from "./stream-DsNKgWle.js";
import { c as parseSessionEntries, n as buildSessionContext, s as migrateSessionEntries } from "./session-manager-LJPhjpMG.js";
import { a as getApiKeyForModel } from "./model-auth-UZfuk32X.js";
import { a as isNativeCommandTurn, s as resolveCommandTurnContext } from "./command-turn-context-jjyeZbEf.js";
import { i as resolveTextCommand, r as normalizeCommandBody } from "./commands-registry-normalize-CGdNJ5Vy.js";
import { i as setAbortMemory, r as isAbortTrigger } from "./abort-primitives-BORq_unO.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-VWt31sJ-.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle, t as buildTaskStatusSnapshot } from "./task-status-Dwl2jN25.js";
import { p as replyRunRegistry } from "./reply-run-registry-B8uh7Okn.js";
import "./diagnostic-G4ZpZF4z.js";
import { t as diagnosticLogger } from "./diagnostic-runtime-CVoBslT3.js";
import { a as getActiveEmbeddedRunSnapshot, g as resolveActiveEmbeddedRunSessionId, i as formatEmbeddedAgentQueueFailureSummary, o as isEmbeddedAgentRunActive, p as queueEmbeddedAgentMessageWithOutcomeAsync } from "./runs-ZDT-yHKC.js";
...
import { o as resolveContextTokensForModel } from "./context-CkdWJLB1.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BF9TD_8H.js";
...
import { r as selectAgentHarness, t as resolveAvailableAgentHarnessPolicy } from "./selection-DrXxngyT.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-DB1L4dZN.js";
import { v as resolveEmbeddedAgentStreamFn } from "./compaction-successor-transcript-CUmEvaGX.js";
import { n as redactConfigObject, r as redactConfigSnapshot } from "./redact-snapshot-CvCLe6ow.js";
import { r as resolveImageSanitizationLimits } from "./image-sanitization-B1anI66H.js";
import { n as sanitizeImageBlocks } from "./tool-images-BO1Itut2.js";
import { a as readChannelAllowFromStore, l as removeChannelAllowFromStoreEntry, t as addChannelAllowFromStoreEntry } from "./pairing-store-ByRFs_Z3.js";
import { c as resolveMainSessionAlias, s as resolveInternalSessionKey } from "./sessions-helpers-BHxfvpmm.js";
import { a as clearSessionQueues } from "./queue-D-mTrnGc.js";
import { i as resolveReplyToMode } from "./reply-threading-DkCU8iPc.js";
import { b as resolveBootstrapTotalMaxChars, v as resolveBootstrapMaxChars } from "./embedded-agent-helpers-CdZv6Xta.js";
import { n as routeReply } from "./route-reply-B6keltUN.js";
import { _ as authorizeConfigWriteShared, b as resolveConfigWriteTargetFromPathShared, v as canBypassConfigWritePolicyShared, x as resolveExplicitConfigWriteTargetShared, y as formatConfigWriteDeniedMessageShared } from "./channel-config-helpers-Q5p9ejlB.js";
import { r as resolveModelWithRegistry } from "./model-CxH-pH6G.js";
import { t as registerProviderStreamForModel } from "./provider-stream-Crs84j2E.js";
import { t as formatThreadBindingDurationLabel } from "./thread-bindings-messages-DJW4AiWY.js";
import { t as formatDurationCompact } from "./format-duration-BrZ-AaEJ.js";
import { t as isApprovalNotFoundError } from "./approval-errors-DaOTGqJF.js";
import "./sandbox-CFpWuVFY.js";
import { i as getSpeechProvider, o as listSpeechProviders, r as canonicalizeSpeechProviderId } from "./directives-DNMy_uGh.js";
import { C as setTtsMaxLength, S as setTtsEnabled, T as setTtsProvider, _ as resolveTtsPrefsPath, a as getTtsMaxLength, b as setSummarizationEnabled, c as isSummarizationEnabled, f as listTtsPersonas, g as resolveTtsConfig, i as getResolvedSpeechProviderConfig, k as textToSpeech, l as isTtsEnabled, o as getTtsPersona, r as getLastTtsAttempt, s as getTtsProvider, u as isTtsProviderConfigured, w as setTtsPersona, y as setLastTtsAttempt } from "./tts-runtime-CRnu1vgI.js";
import "./tts-BxWPQUPI.js";
import { o as getFinishedSession, s as getSession } from "./bash-process-registry-D5JXWGY1.js";
import { t as analyzeBootstrapBudget } from "./bootstrap-budget-1AUyw8RK.js";
...
import { a as listTasksForSessionKeyForStatus, r as listTasksForAgentIdForStatus } from "./task-status-access-C6phTwac.js";
import { r as matchPluginCommand, t as executePluginCommand } from "./commands-8TgMfNih.js";
import "./commands-registry-Vmpn6ZeA.js";
import { t as resolveExternalCliAuthOverlayScopeFromSelection } from "./external-cli-auth-selection-D8V2p0a_.js";
import { n as buildThreadingToolContext } from "./agent-runner-utils-D-p5_hDw.js";
import { r as resolveConversationBindingContextFromAcpCommand } from "./conversation-binding-input-Ce2zG9_w.js";
import { a as requireGatewayClientScope, i as requireCommandFlagEnabled, n as rejectNonOwnerCommand, r as rejectUnauthorizedCommand, t as buildDisabledCommandReply } from "./command-gates-BPV24IWw.js";
import { r as handleGoalCommand } from "./commands-goal-BhrHOC62.js";
import { o as stripMentions, s as stripStructuralPrefixes } from "./mentions-Dsnaqb-N.js";
...
import { i as stopSubagentsForRequester, n as formatAbortReplyText, r as resolveSessionEntryForKey, t as abortSessionRunTarget } from "./abort-BsRzqEVW.js";
import { n as formatTimeAgo } from "./format-relative-Bjc3l98W.js";
import { n as setChannelConversationBindingMaxAgeBySessionKey, t as setChannelConversationBindingIdleTimeoutBySessionKey } from "./conversation-bindings-CPF8Zg1t.js";
import { t as handleCrestodianCommand } from "./commands-crestodian-D9pmuJiN.js";
import { n as isImplicitSameChatApprovalAuthorization } from "./approval-auth-helpers-5aM_zJTk.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-CVGm43sZ.js";
import { n as parseActivationCommand } from "./group-activation-CNUkzseN.js";
import { t as resolveFastModeState } from "./fast-mode-_MqS6fB1.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-Tu5G4O_B.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CGEdBW74.js";
import { t as resolveRuntimePolicySessionKey } from "./runtime-policy-session-key-CWn8p--2.js";
import { i as resolveSkillCommandInvocation, t as listSkillCommandsForAgents } from "./chat-commands-B4LVRxAA.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CbLT4tkd.js";
import { t as extractBtwQuestion } from "./btw-command-CPlHzqSX.js";
import { n as buildCommandsMessagePaginated, r as buildHelpMessage, t as buildCommandsMessage } from "./command-status-builders-CrPbO7Go.js";
import { r as handleModelsCommand } from "./commands-models-bOIALJPK.js";
import { r as createExecTool } from "./bash-tools-Dkyr3Pi6.js";
import { C as stopWithText, b as resolveAcpAction, d as COMMAND, x as resolveAcpHelpText } from "./shared-C7xVSyVQ.js";
import { a as resolveHandledPrefix, c as resolveSubagentsAction, d as resolveCommandSurfaceChannel, l as stopWithText$1, o as resolveRequesterSessionKey, u as resolveChannelAccountId } from "./shared-7CayuHAI.js";
import { t as buildToolsMessage } from "./status-JCSyxCra.js";
import { t as loadGatewayRuntimeConfigSchema } from "./runtime-schema-CoGt090u.js";
import { n as setConfiguredMcpServer, o as parseConfigValue, r as unsetConfiguredMcpServer, t as listConfiguredMcpServers } from "./mcp-config-B-tnONmO.js";
import { t as resolveCommandsSystemPromptBundle } from "./commands-system-prompt-Bzq_v_YD.js";
import "./command-export-CuNeCs1Q.js";
import { t as buildStatusReply } from "./commands-status-jaowI9yw.js";
import { n as persistPluginInstall, r as buildNpmInstallRecordFields } from "./plugins-install-persist-BhdbrChF.js";
import { a as installPluginFromNpmSpec, o as installPluginFromPath } from "./install-Db68_GJY.js";
import { a as resolveOfficialExternalNpmPackageTrust } from "./plugin-install-plan-FxsqawTs.js";
import { a as buildPluginDiagnosticsReport, c as formatPluginCompatibilityNotice, o as buildPluginInspectReport, t as buildAllPluginInspectReports } from "./status-ut_mESRE.js";
import { t as buildPluginRegistrySnapshotReport } from "./status-snapshot-C-Iw0_7a.js";
import { d as resolveFileNpmSpecToLocalPath, r as createPluginInstallLogger } from "./plugins-command-helpers-BnVe02g3.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-g2urQ0dw.js";
import { n as installPluginFromClawHub } from "./clawhub-81LkoFp-.js";
import { i as loadSessionCostSummary, n as loadCostUsageSummary } from "./session-cost-usage-Cfa84lXA.js";
...
const lifecycleHandlersLoader = createLazyImportLoader(() => import("./lifecycle-Dnl2xxSs.js"));
const runtimeOptionHandlersLoader = createLazyImportLoader(() => import("./runtime-options-BoEU-i9K.js"));
const diagnosticHandlersLoader = createLazyImportLoader(() => import("./diagnostics-Cc3EFvqv.js"));
...
async function resolveContextReport(params) {
	...
	const { resolveCommandsSystemPromptBundle } = await import("./commands-system-prompt-BVQDv986.js");
...
const actionAgentsLoader = createLazyImportLoader(() => import("./action-agents-D-kUkbKG.js"));
const actionFocusLoader = createLazyImportLoader(() => import("./action-focus-BtdLX-AH.js"));
const actionHelpLoader = createLazyImportLoader(() => import("./action-help-DJGaGwL3.js"));
const actionInfoLoader = createLazyImportLoader(() => import("./action-info-C1AUs_U1.js"));
const actionListLoader = createLazyImportLoader(() => import("./action-list-CDuEQYGJ.js"));
const actionLogLoader = createLazyImportLoader(() => import("./action-log-B9qSxX9T.js"));
const actionUnfocusLoader = createLazyImportLoader(() => import("./action-unfocus-Dinuhvc4.js"));
