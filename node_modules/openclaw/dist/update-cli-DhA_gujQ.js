...
import { d as resolveGatewayPort, f as resolveIncludeRoots, n as DEFAULT_GATEWAY_PORT, t as CONFIG_PATH } from "./paths-CiHrdfZh.js";
import { n as resolveCliName, t as replaceCliName } from "./cli-name-C-K1n6ar.js";
import { t as formatCliCommand } from "./command-format-CcxbKMj_.js";
...
import "./daemon-cli-CVdl8UfQ.js";
import { w as pathExists } from "./fs-safe-aqmM_n6V.js";
import { p as resolveUserPath, u as pathExists$1 } from "./utils-CFG_gPqL.js";
import { r as resolveConfigEnvVars } from "./env-substitution-ByCcITmO.js";
import { i as GATEWAY_SERVICE_RUNTIME_PID_ENV, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName, u as resolveGatewayLaunchAgentLabel } from "./constants-DRh8k0Vm.js";
import { i as resolveGatewayInstallEntrypoint } from "./gateway-entrypoint-DZA4kZzH.js";
import { n as VERSION } from "./version-Crcn9X9T.js";
import { n as defaultRuntime } from "./runtime-pp2OBTec.js";
import { a as parseSemver, i as nodeVersionSatisfiesEngine } from "./runtime-guard-CcqbCKlv.js";
import { a as readJsonIfExists, m as writeJson } from "./json-files-BhHaMcRK.js";
import { o as resolvePackageExtensionEntries } from "./manifest-CyMcRkm1.js";
import { a as resolveDefaultPluginNpmDir } from "./install-paths-BplwoIHr.js";
import { r as validatePackageExtensionEntriesForInstall } from "./package-entry-resolution-BTQ3nGRL.js";
import { a as listManagedPluginNpmRoots, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-BuEF0uTi.js";
import { c as resolveOfficialExternalPluginInstall, r as getOfficialExternalPluginCatalogManifest, t as getOfficialExternalPluginCatalogEntry } from "./official-external-plugin-catalog-BB8GGJAo.js";
import { c as resolveEffectiveEnableState, s as normalizePluginsConfig } from "./config-state-0SrO5o-9.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-C5YhGY9Z.js";
import { r as readPersistedInstalledPluginIndex } from "./installed-plugin-index-store-CO_gdq2y.js";
import { r as runCommandWithTimeout } from "./exec-BcwfCgxg.js";
import { F as asResolvedSourceConfig, I as asRuntimeConfig, o as parseConfigJson5, p as readSourceConfigBestEffort, q as createPreUpdateConfigSnapshot, u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import { a as withPluginInstallRecords, o as withoutPluginInstallRecords, s as writePersistedInstalledPluginIndexInstallRecords } from "./installed-plugin-index-records-D0Nb__z2.js";
import { a as resolveConfigIncludes } from "./includes-B6UCEfFS.js";
...
import { r as mutateConfigFileWithRetry } from "./config-Ba5VqNR9.js";
import { n as quoteCmdScriptArg } from "./cmd-argv-fj4pRVR6.js";
import { r as getSelfAndAncestorPidsSync } from "./restart-stale-pids-DeNrOiEV.js";
import { t as disableCurrentOpenClawUpdateLaunchdJob } from "./launchd-DirYWoav.js";
import { i as resolveGatewayRestartLogPath, n as renderPosixRestartLogSetup, o as shellEscapeRestartLogValue } from "./restart-logs-CgOjPgdD.js";
import { i as resolveGatewayService, r as readGatewayServiceState } from "./service-BlI0-Q4V.js";
import { n as runDaemonInstall } from "./install-gGR_JekD.js";
import { a as recoverInstalledLaunchAgent, t as runDaemonRestart } from "./lifecycle-1guWmn63.js";
import { l as waitForGatewayHealthyRestart, o as renderRestartDiagnostics, s as terminateStaleGatewayPids } from "./restart-health-DfKC1U4m.js";
import { n as resolveTrustedSourceLinkedOfficialClawHubSpec, r as resolveTrustedSourceLinkedOfficialNpmSpec } from "./official-external-install-records-m0hwZqW1.js";
import { u as trimLogTail } from "./restart-sentinel-D3lYdtMW.js";
import { r as formatDurationPrecise } from "./format-duration-BrZ-AaEJ.js";
import { n as stylePromptMessage } from "./prompt-style-MFJZtXf0.js";
import { t as selectStyled } from "./prompt-select-styled-BDljK4H9.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-D7IbR5VI.js";
import { i as relinkOpenClawPeerDependenciesInManagedNpmRoot, n as auditOpenClawPeerDependencyLink } from "./plugin-peer-link-DxXSBjDR.js";
import { a as installCompletion, n as COMPLETION_SKIP_PLUGIN_COMMANDS_ENV } from "./completion-runtime-DPlUXKJ5.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-CsInLrKJ.js";
import { t as formatHelpExamples } from "./help-format-CBGqVsX5.js";
import { r as commitPluginInstallRecordsWithConfig } from "./plugins-install-record-commit-M1OtsqMl.js";
import { t as refreshPluginRegistryAfterConfigMutation } from "./plugins-registry-refresh-g2urQ0dw.js";
import { c as resolveEffectiveUpdateChannel, i as formatUpdateChannelLabel, l as resolveRegistryUpdateChannel, r as channelToNpmTag, s as normalizeUpdateChannel, u as resolveUpdateChannelDisplay } from "./update-channels-CyUTHOT2.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-CBZO4WIh.js";
import { n as readPackageName, r as readPackageVersion } from "./package-json-DNqcsDRs.js";
import { i as fetchNpmTagVersion, n as compareSemverStrings, o as resolveNpmChannelTag, r as fetchNpmPackageTargetStatus, t as checkUpdateStatus } from "./update-check-DCJCE-US.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-CeIwybQ6.js";
import { a as cleanupGlobalRenameDirs, c as detectGlobalInstallManagerForRoot, d as resolveGlobalInstallTarget, f as resolvePnpmGlobalDirFromGlobalRoot, i as canResolveRegistryVersionForPackageTarget, l as globalInstallArgs, n as runGatewayUpdate, o as createGlobalInstallEnv, p as normalizePackageTagInput, r as runGlobalPackageUpdateSteps, s as detectGlobalInstallManagerByPresence, u as resolveGlobalInstallSpec } from "./update-runner-DT5eeHtD.js";
import { t as doctorCommand } from "./doctor-bKPMn3c7.js";
import { n as UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV, r as UPDATE_POST_CORE_CONVERGENCE_ENV, t as UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV } from "./update-phase-BpJvPFvu.js";
import { t as summarizeGatewayServiceLayout } from "./service-layout-CBWdDQjj.js";
import { t as createLowDiskSpaceWarning } from "./disk-space-ObCAdJ9V.js";
import { c as writeControlPlaneUpdateRestartSentinel, i as buildControlPlaneUpdateRestartHealthPendingResult, o as markControlPlaneUpdateRestartSentinelFailure, s as readControlPlaneUpdateSentinelMeta } from "./update-control-plane-sentinel-BkjpJua2.js";
import { n as cleanupStaleManagedServiceUpdateHandoffs } from "./update-managed-service-handoff-cleanup-BKQxjJf5.js";
import { t as repairMissingConfiguredPluginInstalls } from "./missing-configured-plugin-install-DE4cTTNF.js";
import { n as pruneStaleLocalBundledPluginInstallRecords } from "./stale-local-bundled-plugin-install-records-Dh5V5LbG.js";
...
async function maybeRepairLegacyConfigForUpdateChannel(params) {
	...
	const { repairLegacyConfigForUpdateChannel } = await import("./legacy-config-repair-Vb3m9zps.js");
