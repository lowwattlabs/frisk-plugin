...
import { a as normalizeStateDirEnv, d as resolveGatewayPort, t as CONFIG_PATH, y as resolveStateDir } from "./paths-CiHrdfZh.js";
...
import { i as GATEWAY_SERVICE_RUNTIME_PID_ENV } from "./constants-DRh8k0Vm.js";
import { n as defaultRuntime } from "./runtime-pp2OBTec.js";
import { r as setVerbose } from "./global-state-BAD7XgmL.js";
import { c as setConsoleTimestampPrefix, s as setConsoleSubsystemFilter } from "./console-DcpfMatG.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import "./globals-DiwHZb7D.js";
import { t as isContainerEnvironment } from "./container-environment-CNsJSTpY.js";
import { i as isLoopbackHost, p as resolveGatewayBindHost, t as defaultGatewayBindMode } from "./net-Cm4muceK.js";
...
import { a as markGatewayRestartTrace, f as startGatewayRestartTrace, o as measureGatewayRestartTrace, r as createGatewayRestartTraceHandoffEnv, t as captureGatewayRestartTraceHandoff } from "./restart-trace-D-XhyANs.js";
import { r as withProgress } from "./progress-K5zjvHUW.js";
import { n as setGatewayWsLogStyle } from "./ws-logging-zK0zdycs.js";
import { n as acquireGatewayLock, t as GatewayLockError } from "./gateway-lock-doRFR7NE.js";
...
async function resolveGatewayPasswordOption(opts) {
	...
	if (file) {
		const { readSecretFromFile } = await import("./secret-file-DpQH0EqW.js");
...
async function maybeLogPendingControlUiBuild(cfg) {
	...
	const { resolveControlUiRootSync } = await import("./control-ui-assets-DKofvRYs.js");
...
async function maybeWriteGatewayStartupFailureBundle(err) {
	const { writeDiagnosticStabilityBundleForFailureSync } = await import("./diagnostic-stability-bundle-D-vC7nb5.js");
...
async function runGatewayCommand(opts) {
	...
	const { startGatewayServer } = await startupTrace.measure("cli.server-import", () => withProgress({
		...
		indeterminate: true
	}, async () => import("./server-CJSTUGU1.js")));
	setConsoleTimestampPrefix(true);
	if (devMode) {
		const { ensureDevGatewayConfig } = await import("./dev-An3cTw_F.js");
	...
	const { formatFutureConfigActionBlock, resolveFutureConfigActionBlock } = await import("./future-version-guard-Dr4_B3wr.js");
	...
	if (process.env.OPENCLAW_SERVICE_MARKER?.trim()) {
		const { cleanStaleGatewayProcessesSync } = await import("./restart-stale-pids-D3OBhcSd.js");
	...
	if (opts.force) try {
		const { forceFreePortAndWait, waitForPortBindable } = await import("./ports-CY52HYHF.js");
	...
	const { resolveGatewayAuth } = await import("./auth-BvxE4eCx.js");
	...
	const { detectRespawnSupervisor } = await import("./supervisor-markers-DVdGXCzU.js");
	...
	try {
		...
		if (isGatewayLockError(err)) {
			...
			try {
				const { formatPortDiagnostics, inspectPortUsage } = await import("./ports-Brg0NzJq.js");
				const diagnostics = await inspectPortUsage(port);
				if (diagnostics.status === "busy") for (const line of formatPortDiagnostics(diagnostics)) defaultRuntime.error(line);
			} catch {}
			const { maybeExplainGatewayServiceStop } = await import("./shared-DUkhxY1m.js");
