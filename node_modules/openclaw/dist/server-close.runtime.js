...
import { a as closePluginStateSqliteStore } from "./plugin-state-store-DA0BQ61x.js";
...
import { r as abortTrackedChatRunById } from "./chat-abort-BipmFF4B.js";
import { n as collectGatewayProcessMemoryUsageMb, o as measureGatewayRestartTrace, s as recordGatewayRestartTrace } from "./restart-trace-D-XhyANs.js";
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-4Xcd7Aaj.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-8kLnmB6E.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-Dlsic7d0.js");
