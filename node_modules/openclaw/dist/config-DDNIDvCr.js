...
import { o as coerceSecretRef, u as normalizeResolvedSecretInputString } from "./types.secrets-BEnNl80Y.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-By1zn6Bl.js";
...
import { o as isPrivateNetworkOptInEnabled, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DM3MoCYe.js";
import "./ssrf-runtime-BFhKr63u.js";
import "./retry-runtime-DWLPxaI8.js";
import "./secret-input-runtime-D7Kvnv86.js";
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-B0lGJ9LP.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-BpPDJ4yB.js";
import { o as resolveMatrixBaseConfig, r as listNormalizedMatrixAccountIds, t as findMatrixAccountConfig } from "./account-config-bH4Gv22C.js";
import { i as resolveScopedMatrixEnvConfig, n as resolveGlobalMatrixEnvConfig } from "./env-auth-BzxZxWvz.js";
import { t as resolveMatrixConfigFieldPath } from "./config-paths-B6IxkurD.js";
import { t as resolveValidatedMatrixHomeserverUrl } from "./url-validation-7Dkvd3qK.js";
import { i as repairCurrentTokenStorageMetaDeviceId } from "./storage-BKpOYT2j.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-B2IWExnS.js"), import("./logging-DiETBG2W.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-5nBIRo3d.js").then((credentialsReadModule) => ({
