...
import { $ as PluginHookLlmInputEvent, $t as PluginHookMessageReceivedEvent, At as PluginHookToolResultPersistContext, B as PluginHookGatewayContext, C as PluginHookBeforeDispatchResult, Ct as PluginHookSubagentSpawnedEvent, Dt as PluginHookToolContext, E as PluginHookBeforeInstallEvent, F as PluginHookBeforeToolCallEvent, Gt as PluginHeartbeatPromptContributionResult, Ht as PluginAgentTurnPrepareEvent, I as PluginHookBeforeToolCallResult, M as PluginHookBeforeMessageWriteEvent, Mt as PluginHookToolResultPersistResult, N as PluginHookBeforeMessageWriteResult, P as PluginHookBeforeResetEvent, Q as PluginHookInboundClaimResult, Qt as PluginHookMessageContext, R as PluginHookCronChangedEvent, S as PluginHookBeforeDispatchEvent, St as PluginHookSubagentEndedEvent, T as PluginHookBeforeInstallContext, Tt as PluginHookSubagentSpawningResult, Ut as PluginAgentTurnPrepareResult, Wt as PluginHeartbeatPromptContributionEvent, X as PluginHookGatewayStopEvent, Xt as PluginHookInboundClaimContext, Y as PluginHookGatewayStartEvent, Zt as PluginHookInboundClaimEvent, _ as PluginHookBeforeAgentReplyResult, at as PluginHookRegistration, b as PluginHookBeforeCompactionEvent, bt as PluginHookSubagentDeliveryTargetEvent, cn as PluginHookBeforeAgentStartResult, ct as PluginHookReplyDispatchResult, d as PluginHookAfterToolCallEvent, dn as PluginHookBeforeModelResolveResult, dt as PluginHookReplyPayloadSendingEvent, en as PluginHookMessageSendingEvent, et as PluginHookLlmOutputEvent, f as PluginHookAgentContext, fn as PluginHookBeforePromptBuildEvent, ft as PluginHookReplyPayloadSendingResult, g as PluginHookBeforeAgentReplyEvent, gt as PluginHookSessionEndEvent, h as PluginHookBeforeAgentFinalizeResult, ht as PluginHookSessionContext, in as InputGateDecision, it as PluginHookName, jt as PluginHookToolResultPersistEvent, k as PluginHookBeforeInstallResult, m as PluginHookBeforeAgentFinalizeEvent, mt as PluginHookResolveExecEnvEvent, nn as PluginHookMessageSentEvent, nt as PluginHookModelCallEndedEvent, on as PluginHookBeforeAgentStartEvent, ot as PluginHookReplyDispatchContext, p as PluginHookAgentEndEvent, pn as PluginHookBeforePromptBuildResult, pt as PluginHookResolveExecEnvContext, rn as GateHookResult, rt as PluginHookModelCallStartedEvent, st as PluginHookReplyDispatchEvent, tn as PluginHookMessageSendingResult, u as PluginHookAfterCompactionEvent, un as PluginHookBeforeModelResolveEvent, ut as PluginHookReplyPayloadSendingContext, v as PluginHookBeforeAgentRunEvent, vt as PluginHookSessionStartEvent, wt as PluginHookSubagentSpawningEvent, x as PluginHookBeforeDispatchContext, xt as PluginHookSubagentDeliveryTargetResult, yt as PluginHookSubagentContext } from "./hook-types-eDvaxJMP.js";
