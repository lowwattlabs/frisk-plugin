...
import { c as normalizePairingConnectRequestId, d as readConnectPairingRequiredMessage, f as readPairingConnectErrorDetails } from "./connect-error-details-BqV3wdWQ.js";
import { o as readRestartSentinel } from "./restart-sentinel-D3lYdtMW.js";
...
const statusScanModuleLoader = createLazyImportLoader(() => import("./status.scan-Xynkc36M.js"));
const statusScanFastJsonModuleLoader = createLazyImportLoader(() => import("./status.scan.fast-json-D7R6Eo1r.js"));
const statusAllModuleLoader = createLazyImportLoader(() => import("./status-all-DoMcJvXj.js"));
const statusCommandTextRuntimeLoader = createLazyImportLoader(() => import("./status.command.text-runtime-CnM_9Ao0.js"));
const statusNodeModeModuleLoader = createLazyImportLoader(() => import("./status.node-mode-BupofGfX.js"));
...
async function statusCommand(opts, runtime) {
	...
	if (opts.verbose) {
		const { buildGatewayConnectionDetails } = await import("./call-Blf_Okhs.js");
