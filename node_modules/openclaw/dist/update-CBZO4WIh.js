...
import { g as satisfiesPluginApiRange } from "./clawhub-DJOHN8WO.js";
import { t as installPluginFromGitSpec } from "./git-install-RU5chcpQ.js";
import { n as defaultSlotIdForKey } from "./slots-DT22cOei.js";
import { a as isPrereleaseResolutionAllowed, i as isOpenClawOrgNpmSpec, s as parseRegistryNpmSpec, t as compareOpenClawReleaseVersions } from "./npm-registry-spec-CpNkg5p2.js";
import { o as resolvePluginInstallDir } from "./install-paths-BplwoIHr.js";
import { i as resolvePackagePluginApiRange } from "./package-entry-resolution-BTQ3nGRL.js";
import { t as checkMinHostVersion } from "./min-host-version-CZfpfSUG.js";
...
import { o as resolveNpmSpecMetadata } from "./install-source-utils-DliVKyhd.js";
import { n as recordPluginInstall, t as buildNpmResolutionInstallFields } from "./installs-CX4ihYzv.js";
...
import { r as linkOpenClawPeerDependencies } from "./plugin-peer-link-DxXSBjDR.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-OcTbMHKQ.js";
import { i as readInstalledPackageVersion, n as installedPackageNeedsOpenClawPeerLinkRepair, r as readInstalledPackagePeerDependencies, t as expectedIntegrityForUpdate } from "./package-update-utils-Bx-yc6cR.js";
import { a as installPluginFromNpmSpec, t as PLUGIN_INSTALL_ERROR_CODE } from "./install-Db68_GJY.js";
...
import { t as installPluginFromMarketplace } from "./marketplace-DMdgATMd.js";
	...
	for (const pluginId of targets) {
		...
		if (!params.dryRun && record.source === "npm" && currentVersion) {
			...
			if (metadataResult.ok) {
				...
				}) && isNpmMetadataCompatibleWithCurrentHost(metadataResult.metadata) && !installedPackageNeedsOpenClawPeerLinkRepair(installPath) && shouldSkipUnchangedNpmInstall({
					currentVersion,
					record,
					metadata: metadataResult.metadata
				})) {
