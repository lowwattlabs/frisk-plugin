...
import { n as resolveCopilotTransportApi, r as resolveStaticCopilotModelOverride, t as resolveCopilotModelCompat } from "./model-metadata-DVw-uski.js";
...
function resolveCopilotThinkingLevelMap(api, compat) {
	if (api === "anthropic-messages" && compat?.supportedReasoningEfforts?.some((effort) => effort === "xhigh")) return { xhigh: "xhigh" };
}
