import { kt as AuthConfig } from "./types.openclaw-DRmAZfDb.js";
import { d as SecretInput } from "./types.secrets-BKPYDrKY.js";
import { a as ModelApi, m as ModelProviderDeclarationConfig } from "./types.models-BZoNFPND.js";
import { jt as ProviderAuthResult } from "./types-DOrS-soN.js";
...
//#endregion
export { resolveConfiguredModelNameHint as C, supportsFoundryImageInput as D, resolveFoundryTargetProfileId as E, supportsFoundryReasoningEffort as O, requiresFoundryMaxCompletionTokens as S, resolveFoundryModelCapabilities as T, buildFoundryProviderBaseUrl as _, COGNITIVE_SERVICES_RESOURCE as a, listConfiguredFoundryProfileIds as b, DEFAULT_GPT5_API as c, FoundrySelection as d, PROVIDER_ID as f, buildFoundryAuthResult as g, applyFoundryProviderConfig as h, AzDeploymentSummary as i, usesFoundryResponsesByDefault as k, FoundryProviderApi as l, applyFoundryProfileBinding as m, AzAccount as n, CachedTokenEntry as o, TOKEN_REFRESH_MARGIN_MS as p, AzCognitiveAccount as r, DEFAULT_API as s, AzAccessToken as t, FoundryResourceOption as u, extractFoundryEndpoint as v, resolveFoundryApi as w, normalizeFoundryEndpoint as x, isFoundryProviderApi as y };