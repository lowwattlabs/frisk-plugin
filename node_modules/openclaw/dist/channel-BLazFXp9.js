...
import { h as MarkdownConfigSchema, l as GroupPolicySchema, o as DmPolicySchema } from "./zod-schema.core-BedchlTo.js";
import { n as buildCatchallMultiAccountChannelSchema, r as buildChannelConfigSchema, t as AllowFromListSchema } from "./config-schema-BRAUIZly.js";
import { b as sendPayloadWithChunkedTextAndMedia, l as isNumericTargetId } from "./reply-payload-JUvJDGAb.js";
...
import { l as createScopedDmSecurityResolver, m as mapAllowFromEntries, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-Q5p9ejlB.js";
import "./string-coerce-runtime-DzE-BRXv.js";
import { t as chunkTextForOutbound } from "./text-chunking-BcNuyNPW.js";
import { r as describeWebhookAccountSnapshot } from "./account-helpers-CDTU7Oaa.js";
import { n as createStaticReplyToModeResolver } from "./threading-helpers-JSVFlQzA.js";
import { d as stripTargetKindPrefix, i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-yU1EBN6I.js";
...
import { C as createOpenProviderGroupPolicyWarningCollector, o as buildOpenGroupPolicyRestrictSendersWarning, s as buildOpenGroupPolicyWarning } from "./channel-policy-DLbIVuEn.js";
import { t as createChannelDirectoryAdapter } from "./directory-runtime-yJN_bbSv.js";
import { p as listResolvedDirectoryUserEntriesFromAllowFrom } from "./directory-config-helpers-DXaVQVQd.js";
...
import { d as createDefaultChannelRuntimeState, o as buildTokenChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-Bw3y4bRG.js";
import "./channel-status-D86kmK7E.js";
import { a as coerceStatusIssueAccountId, d as readStatusIssueFields } from "./extension-shared-DQWmWZV-.js";
...
import { i as resolveZaloAccount, n as listZaloAccountIds, r as resolveDefaultZaloAccountId, t as listEnabledZaloAccounts } from "./accounts-DcsKp9Fl.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-B2XON54a.js";
import { r as zaloSetupAdapter, t as createZaloSetupWizardProxy } from "./setup-core-PEA1iNjt.js";
//#region extensions/zalo/src/actions.ts
const loadZaloActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-Cl1bk0jq.js"), "zaloActionsRuntime");
...
const loadZaloChannelRuntime = createLazyRuntimeModule(() => import("./channel.runtime-B326kFa2.js"));
const zaloSetupWizard = createZaloSetupWizardProxy(async () => (await import("./setup-surface-DB6ovZfB.js")).zaloSetupWizard);
