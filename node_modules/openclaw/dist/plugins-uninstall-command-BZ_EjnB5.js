...
import { a as tracePluginLifecyclePhaseAsync, i as tracePluginLifecyclePhase } from "./discovery-COO7Hacm.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-DhdTStyJ.js");
	const { buildPluginSnapshotReport } = await import("./status-BsJFhe4I.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-o_N5LLuk.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-D8mr0uw8.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-BVqTxnxo.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BAJNsDfF.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-DvR-RuYi.js");
