...
import { c as checkBrowserOrigin } from "./auth-DCaNI_5E.js";
...
import { m as runBeforeToolCallHook } from "./agent-tools.before-tool-call-CDXSxqiL.js";
import { t as resolveGatewayScopedTools } from "./tool-resolution-BHZm2C6t.js";
import { a as getHeader } from "./http-auth-utils-C3gqvd78.js";
...
async function readMcpHttpBody(req) {
	return await new Promise((resolve, reject) => {
		...
		const cleanup = (options) => {
			req.off("data", onData);
			req.off("end", onEnd);
			if (options?.keepErrorListener !== true) req.off("error", onError);
		};
...
function createMcpHttpBodyTooLargeError() {
	return Object.assign(/* @__PURE__ */ new Error(`Request body exceeds ${MAX_MCP_BODY_BYTES} bytes`), { code: MCP_HTTP_BODY_TOO_LARGE_CODE });
}
