...
import { y as truncateUtf16Safe } from "./utils-CFG_gPqL.js";
import { t as escapeRegExp } from "./regexp-gnNKXe6h.js";
import { n as defaultRuntime } from "./runtime-pp2OBTec.js";
import { t as createSubsystemLogger } from "./subsystem-DM7CD-js.js";
import "./boundary-file-read-CBe_wA_B.js";
import { i as normalizeProviderId } from "./provider-id-Dq06Bcx6.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-EemT8aea.js";
import { i as hasLegacyAutoFallbackWithoutOrigin, m as resolveAutoFallbackPrimaryProbe, p as resolveAgentSkillsFilter, t as clearAutoFallbackPrimaryProbeSelection, v as resolveSessionAgentId, w as hasSessionAutoModelFallbackProvenance } from "./agent-scope-BcYNOCQG.js";
import { a as isSubagentSessionKey, c as parseAgentSessionKey, n as isAcpSessionKey } from "./session-key-utils-Bx3apsJ3.js";
import { d as normalizeMainKey, i as buildAgentMainSessionKey, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { t as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-default-BsnZALPo.js";
import { a as resolveAgentDir, o as resolveAgentWorkspaceDir, r as resolveAgentConfig, t as listAgentEntries } from "./agent-scope-config-BoFGd2i9.js";
import { l as measureDiagnosticsTimelineSpan } from "./plugin-metadata-snapshot-CDfe2bdF.js";
import { r as logVerbose } from "./globals-DiwHZb7D.js";
import { i as getRuntimeConfig } from "./io-AmXZn-TT.js";
import { i as listOpenAIAuthProfileProvidersForAgentRuntime } from "./openai-routing-Bc6sEjDj.js";
...
import { d as normalizeElevatedLevel, f as normalizeReasoningLevel, g as normalizeVerboseLevel, m as normalizeTraceLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels, u as isSessionDefaultDirectiveValue } from "./thinking-BHlJqFAp.js";
import "./config-Ba5VqNR9.js";
import { a as normalizeAnyChannelId } from "./registry-snmJh0Ya.js";
import { s as resetRegisteredAgentHarnessSessions } from "./registry-D4UqzAw3.js";
import { u as markReplyPayloadForSourceSuppressionDelivery } from "./reply-payload-DM17pxMC.js";
import { t as getGlobalHookRunner, u as fireAndForgetHook } from "./hook-runner-global-CBGmN_LW.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-BUw7VcqN.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-BOhvpyEd.js";
import { a as normalizeDeliveryChannelRoute, n as deliveryContextFromSession, o as normalizeDeliveryContext, r as deliveryContextKey, s as normalizeSessionDeliveryFields } from "./delivery-context.shared-DQ3Juxwd.js";
import "./message-channel-constants-xBuIaJJT.js";
import { i as normalizeMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-C9UW7j_h.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-Bz9nEaho.js";
import { D as resolveMaintenanceConfigFromInput, V as resolveSessionStoreEntry, j as parseSessionThreadInfoFast, t as loadSessionStore } from "./store-load-X9ls7b1K.js";
import { t as getLoadedChannelPluginById } from "./registry-loaded-C34IYNUy.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-C3m2WQdt.js";
import { d as updateSessionStore, g as deriveSessionMetaPatch } from "./store-D2vwNFZF.js";
import { t as normalizeChatType } from "./chat-type-_Y2TgaFU.js";
import "./plugins-2jPMnXk3.js";
import { r as isInternalMessageChannel } from "./message-channel-rCegTRAO.js";
import { n as resolveGroupSessionKey } from "./group-B4ucEfB8.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-DUYD_-CI.js";
import { n as resolveSessionLifecycleTimestamps } from "./lifecycle-BlJBXFqk.js";
import { c as resolveSessionResetPolicy, i as resolveThreadFlag, n as resolveChannelResetConfig, o as evaluateSessionFreshness, r as resolveSessionResetType } from "./reset-Cg-ypwIC.js";
import { n as resolveSessionKey } from "./session-key-Bzv4fWJh.js";
import { d as resolveAndPersistSessionFile } from "./transcript-DJ0xrK51.js";
import { y as resolveModelRefFromString } from "./model-selection-shared-WGXc9fXh.js";
import { n as resolveThinkingDefaultWithRuntimeCatalog } from "./model-thinking-default-BnwKbvNv.js";
import "./model-selection-BKypu26e.js";
import { n as loadModelCatalog } from "./model-catalog-BN-bUmfZ.js";
import { d as ensureAgentWorkspace, h as isWorkspaceBootstrapPending } from "./workspace-DVU_odQG.js";
import { a as isNativeCommandTurn, c as resolveCommandTurnTargetSessionKey, s as resolveCommandTurnContext } from "./command-turn-context-jjyeZbEf.js";
import { r as normalizeCommandBody } from "./commands-registry-normalize-CGdNJ5Vy.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-BORq_unO.js";
import { t as hasControlCommand } from "./command-detection-BPtQDBi9.js";
import { n as isInternalSourceReplyChannel } from "./source-reply-delivery-mode-CVlG2-Nl.js";
import { a as enqueueSystemEvent } from "./system-events-BMZOXQOE.js";
import { t as resolveAgentTimeoutMs } from "./timeout-D5IVNNSy.js";
import { c as isReplyRunActiveForSessionId, g as waitForReplyRunEndBySessionId, h as resolveActiveReplyRunThreadId, i as abortReplyRunBySessionId, l as isReplyRunStreamingForSessionId, m as resolveActiveReplyRunSessionId, t as REPLY_RUN_IDLE_SETTLE_TIMEOUT_MS } from "./reply-run-registry-B8uh7Okn.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-BpOBzvOi.js";
import { t as sanitizePendingFinalDeliveryText } from "./pending-final-delivery-9jdLB75K.js";
import { n as annotateInterSessionPromptText, o as isInterSessionInputProvenance } from "./input-provenance-3lgzT57B.js";
import { c as getQueueSize, r as clearCommandLane } from "./command-queue-LbK8r37L.js";
...
import { n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-DfeHI2AT.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-CiTBhMnQ.js";
import { a as HEARTBEAT_TRANSCRIPT_PROMPT, d as stripHeartbeatToken } from "./heartbeat-vio2lkit.js";
import { t as buildAgentHookContextChannelFields } from "./hook-agent-context-BP451Fk5.js";
import { a as resolvePersistedUserTurnText, n as buildPersistedUserTurnMediaInputsFromFields, o as isReasoningTagProvider, r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-BsQfWDIB.js";
import { u as retireSessionMcpRuntime } from "./agent-bundle-mcp-runtime-D9yY5Bw7.js";
import "./agent-bundle-mcp-tools-Cj0bYMPi.js";
import { b as normalizeExecTarget } from "./exec-approvals-BjcYozOJ.js";
import "./delivery-context-Cm-3AUIL.js";
import { c as resolveIngressWorkspaceOverrideForSpawnedRun } from "./subagent-spawn-plan-CFUna7Th.js";
import { s as getMediaDir } from "./store-LFm8rX8c.js";
import { i as generateSecureToken } from "./secure-random-BxnbXS5x.js";
import { d as extractQueueDirective, f as skipDirectiveArgPrefix, p as takeDirectiveToken, t as resolveQueueSettings } from "./queue-D-mTrnGc.js";
import { t as buildOutboundSessionContext } from "./session-context-BXjeUFao.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-tgR91xAn.js";
...
import { a as resolveUserTimezone, t as formatDateStamp } from "./date-time-U_4t9uk6.js";
import { n as buildLimitedBootstrapPromptLines, t as buildFullBootstrapPromptLines } from "./bootstrap-prompt-BRL5cC1x.js";
import { t as appendCronStyleCurrentTimeLine } from "./current-time-pX5as6TY.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-D4xgUn7r.js";
import { t as resolveBootstrapMode } from "./bootstrap-mode-py9cyJZX.js";
import { t as resolveChannelModelOverride } from "./model-overrides-gb_k7ubR.js";
import { a as resolveCurrentTurnImages, r as createReplyTimingTracker, s as resolveSilentReplySettings, t as isSystemEventProvider } from "./effective-reply-route-Dsfqf3WC.js";
import { n as shouldHandleTextCommands } from "./commands-text-routing-svDVjcUR.js";
import "./commands-registry-Vmpn6ZeA.js";
import { r as getCliSessionBinding } from "./cli-session-DCbzzAVH.js";
import { n as hasInboundMedia, t as hasInboundAudio } from "./inbound-media-_rIXeRHW.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-CHjTj4Yz.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-Ce2zG9_w.js";
import { t as parseSoftResetCommand } from "./commands-reset-mode-zay2pJux.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-Dsnaqb-N.js";
import { a as shouldHandleFastReplyTextCommands, c as shouldUseReplyFastTestRuntime, i as resolveGetReplyConfig, n as buildFastReplyCommandContext, o as shouldUseReplyFastDirectiveExecution, r as initFastReplySessionState, s as shouldUseReplyFastTestBootstrap, t as resolveRunTypingPolicy } from "./typing-policy-BVoHRDYC.js";
import { t as resolveRoutedDeliveryThreadId } from "./routed-delivery-thread-D43ac8rR.js";
import { n as resolveStoredModelOverride, t as isStaleHeartbeatAutoFallbackOverride } from "./stored-model-override-BmGQexf2.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-NLHyeueP.js";
import { t as finalizeInboundContext } from "./inbound-context-Co-Go1QD.js";
...
import { t as resolveEffectiveResetTargetSessionKey } from "./acp-reset-target-Fjz95giU.js";
import { a as buildSessionStartHookPayload, i as buildSessionEndHookPayload, r as noteActiveSessionForShutdown, t as forgetActiveSessionForShutdown } from "./active-sessions-shutdown-tracker-CSdkBujm.js";
import { n as clearSessionResetRuntimeState, t as resolveResetPreservedSelection } from "./reset-preserved-selection-lqMpH1LS.js";
import { t as cleanupBrowserSessionsForLifecycleEnd } from "./browser-lifecycle-cleanup-Bbb84Fr7.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-DCl07AQa.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-ZwulEbEB.js";
import { t as normalizeGroupActivation } from "./group-activation-CNUkzseN.js";
import { t as resolveDefaultModel } from "./directive-handling.defaults-7qe81w2Y.js";
import { t as resolveFastModeState } from "./fast-mode-_MqS6fB1.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-2fz2WBBx.js";
import { n as buildCommandContext, t as isResetAuthorizedForContext } from "./reset-authorization-gqYm1Drl.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-BpyF3lOe.js";
import { t as resolveModelSelectionFromDirective } from "./directive-handling.model-selection-DTbR9_46.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-Tu5G4O_B.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-DKvs861E.js";
...
import { i as resolveSkillCommandInvocation, r as listReservedChatSlashCommandNames } from "./chat-commands-B4LVRxAA.js";
import { n as runAgentHarnessBeforeMessageWriteHook } from "./hook-helpers-ohaRWi8T.js";
import { n as resolvePreparedReplyQueueState } from "./get-reply-run-queue-mH_RPenk.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-CjsU3bfs.js";
import { t as resolveEffectiveToolInventory } from "./tools-effective-inventory-CbLT4tkd.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-COgs63Nj.js";
...
const directiveImplLoader = createLazyImportLoader(() => import("./directive-handling.impl-BeuMVEvj.js"));
const directiveFastLaneLoader = createLazyImportLoader(() => import("./directive-handling.fast-lane-DEp62v_O.js"));
...
const skillToolDispatchRuntimeLoader = createLazyImportLoader(() => import("./tool-dispatch-BhniiPEM.js"));
...
const statusCommandRuntimeLoader = createLazyImportLoader(() => import("./commands-status-BQM7FAV8.js"));
...
function loadDeliverRuntime() {
	messageRuntimePromise ??= import("./runtime-BQezIIlt.js");
...
const originRoutingLoader = createLazyImportLoader(() => import("./origin-routing-BIR1SvyB.js"));
		...
		if (opts?.isHeartbeat) {
			if (classifyHeartbeatPendingFinalDelivery(text, resolveHeartbeatAckMaxChars(cfg, agentId)).shouldClear) {
				...
				if (sessionKey && storePath) {
					const { applySessionStoreEntryPatch } = await import("./sessions-DT7Qvno9.js");
