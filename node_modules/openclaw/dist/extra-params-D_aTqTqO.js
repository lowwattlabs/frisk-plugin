...
import { f as wrapProviderStreamFn, o as resolveProviderExtraParamsForTransport, r as prepareProviderExtraParams } from "./provider-hook-runtime-93YL7Xgt.js";
import { c as resolveProviderRequestPolicyConfig } from "./provider-request-config-wvUPb42I.js";
...
import { c as createThinkingOnlyFinalTextWrapper, i as createGoogleThinkingPayloadWrapper, r as createDeepSeekV4OpenAICompatibleThinkingWrapper } from "./provider-stream-shared-BCBqUFTA.js";
import { _ as resolveMaxTokensParam, g as canonicalizeMaxTokensParam } from "./openai-transport-stream-BN2CKZjs.js";
import { t as log } from "./logger-Dls9PNjc.js";
import { _ as createOpenAIResponsesContextManagementWrapper, f as createOpenAICompletionsStrictMessageKeysWrapper, l as resolveAnthropicCacheRetentionFamily, n as createOpenRouterSystemCacheWrapper, o as createMinimaxThinkingDisabledWrapper, p as createOpenAICompletionsToolsCompatWrapper, y as createOpenAIStringContentWrapper } from "./proxy-BIVgQ9u8.js";
...
function isDeepSeekV4OpenAICompatibleModel(model) {
	...
	return model.api === "openai-completions" && model.provider !== "microsoft-foundry" && (normalizedModelId === "deepseek-v4-flash" || normalizedModelId === "deepseek-v4-pro");
}
