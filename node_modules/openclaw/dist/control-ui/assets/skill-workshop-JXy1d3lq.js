import{d as e,f as t,g as n,l as r,m as i,n as a,p as o,t as s}from"./lit-runtime-gkTRPNbC.js";import{p as c,v as l}from"./index-DRTyMBOr.js";var u=class extends t{constructor(...e){super(...e),this.files=[],this.activePath=``,this.query=``,this.label=`Support files`,this.listLabel=`Files`,this.searchPlaceholder=`Search files...`,this.contextLabel=``,this.readOnlyLabel=`read-only`,this.emptyTitle=`No files match`,this.emptySubtitle=`Try another file name or content search.`,this.handleQueryInput=e=>{let t=e.target.value??``;this.dispatchEvent(new CustomEvent(`file-preview-query-change`,{bubbles:!0,composed:!0,detail:t}))},this.preventItemPointerFocus=e=>{e.preventDefault()},this.handleKeydown=e=>{switch(e.key){case`Escape`:e.preventDefault(),e.stopPropagation(),this.emitClose();return;case`ArrowDown`:this.moveSelection(1,e);return;case`ArrowUp`:this.moveSelection(-1,e);default:}},this.emitClose=()=>{this.dispatchEvent(new CustomEvent(`file-preview-close`,{bubbles:!0,composed:!0}))}}static{this.styles=n`
    :host {
      position: fixed;
      inset: 0;
      z-index: 50;
  ...
  `}render(){let e=this.filterFiles(),t=this.resolveActiveFile(e),n=e.length===this.files.length?`${this.files.length} files`:`${e.length}/${this.files.length} files`;return i`
    ...
    ${a&&n?i`
        ...
        `:o}
    ${c?b(e,c):o}
  `}function b(e,t){let n=e.actionBusy?.key===t.key&&e.actionBusy.action===`revise`,r=e.revisionDraft.trim().length>0&&!e.actionBusy,a=e.mode===`board`?`Revise`:`Tweak`;return i`
    <div class="sw-revision-backdrop" role="presentation" @click=${e.onRevisionCancel}>
      ...
      >
        <div class="sw-revision-dialog__head">
          <div>
            <div class="sw-revision-dialog__eyebrow">${a} proposal</div>
  ...
  `}function x(e,t,n,r){return i`
    ${T(e)}
    <div class="sw-triage" style=${a({"--sw-queue-width":`${e.queueWidth}px`})}>
      ${E(e,n,r)} ${S(e)}
      ${r?O(e,r):j(e)}
    </div>
  ...
  `}function E(e,t,n){let r=t.reduce((e,t)=>e+t.items.length,0);return i`
    <aside class="sw-queue">
      ...
      <div class="sw-queue__body">
        ${r===0?i`<div class="sw-queue__empty">${Y(e)}</div>`:t.map(t=>i`
  ...
  `}function D(e,t,n){let r=n?.key===t.key;return i`
    <button
  ...
  `}function O(e,t){let n=t.updatedAt&&t.updatedAt>t.createdAt?t.updatedAt:null,r=n?`Edited ${X(n)}`:`Created ${X(t.createdAt)}`,a=e.inspectingKey===t.key&&!t.body;return i`
    <div class="sw-detail">
      ...
      <div class="sw-detail__body">
        <div class="sw-body-card">
          <h1>${t.slug}</h1>
          ${a?i`<p class="sw-muted">Loading proposal…</p>`:G(t.body)}
        </div>
  ...
  `}function A(e,t){let n=e.actionBusy?.key===t.key?e.actionBusy.action:null,r=!!e.actionBusy;return i`
  ...
  `}function j(e){let t=M(e);return i`
  ...
  `}function M(e){if(e.query.trim())return{icon:`search`,title:`No matching proposals`,body:`Clear the search or try a different keyword.`};switch(e.statusFilter){case`pending`:return{icon:`clock`,title:`No pending proposals`,body:`New drafts will appear here when they need review.`};case`applied`:return{icon:`check`,title:`Nothing applied yet`,body:`Use a pending proposal and it will appear here as a live skill.`};case`rejected`:return{icon:`x`,title:`No rejected proposals`,body:`Skipped proposals will stay here for a clean review history.`};case`quarantined`:return{icon:`shield`,title:`Nothing quarantined`,body:`Scanner-blocked or safety-held proposals will appear here.`};case`stale`:return{icon:`refresh`,title:`No stale proposals`,body:`Proposals that can no longer apply cleanly will appear here.`};case`all`:return{icon:`search`,title:`No proposals here`,body:`Skill Workshop proposals will appear here when your agent drafts them.`}}return{icon:`search`,title:`No proposals here`,body:`Skill Workshop proposals will appear here when your agent drafts them.`}}function N(e){switch(e){case`clock`:return i`
      ...
      `}return o}function P(e){return i`
  ...
  `}function F(e,t,n){if(!t)return i`
    ...
    `;let r=Math.max(0,n.findIndex(e=>e.key===t.key)),a=Math.max(n.length,1),s=n.filter(e=>e.key!==t.key).slice(0,3),c=e.proposals.filter(e=>e.status===`applied`).slice(0,3),l=t.isNew?`NEW`:t.status===`pending`?`WAITING`:`REVIEWED`,u=t.ageLabel,d=W(Date.now()),f=t.status===`pending`,p=e.actionBusy?.key===t.key?e.actionBusy.action:null,m=!!e.actionBusy,h=e.assistantName.trim()||`agent`;return i`
    <div class="sw-today">
      <div class="sw-today__head">
        <div class="sw-today__date">${d}</div>
        <h1 class="sw-today__h1">${n.length} proposals waiting</h1>
        ${n.length===0?i`<div class="sw-today__sub">Browse what's already applied.</div>`:o}
        ${n.length>0?i`
  ...
  `}function I(e){let t=L(e.body);return t?i`
...
`),n=[],r=[],a=[],o=!1,s=[],c=()=>{r.length&&(n.push(i`<p>${K(r.join(` `))}</p>`),r=[])},l=()=>{if(a.length){let e=a;n.push(i`
        <ol>
          ${e.map(e=>i`<li>${K(e)}</li>`)}
        </ol>
