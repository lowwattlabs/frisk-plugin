import{i as e,m as t,p as n,t as r}from"./lit-runtime-gkTRPNbC.js";import{l as i,o as a,t as o}from"./string-coerce-DwnRzrPh.js";import{v as s}from"./markdown-runtime-CUzFp-dW.js";import{$ as c,J as l,K as u,Q as d,W as f,X as p,Y as m,Z as h,a as g,at as _,ct as v,et as ee,it as y,lt as b,mt as x,n as S,nt as te,ot as ne,q as C,r as w,rt as T,st as re,t as E,tt as ie,v as D}from"./index-DRTyMBOr.js";import{r as O}from"./channel-config-extras-BkhZ0Bg1.js";import{i as k,n as A,r as j,t as M}from"./skills-shared-CyESuAoW.js";function ae(e){let{agent:r,configForm:i,agentFilesList:o,configLoading:s,configSaving:u,configDirty:d,onConfigReload:f,onConfigSave:p,onModelChange:m,onModelFallbacksChange:h,onSelectPanel:g}=e,v=!!(e.defaultId&&r.id===e.defaultId),b=ie(i,r.id),x=r.model,S=(o&&o.agentId===r.id?o.workspace:null)||b.entry?.workspace||b.defaults?.workspace||r.workspace||`default`,ne=b.entry?.model?y(b.entry?.model):b.defaults?.model?y(b.defaults?.model):y(x),C=te(r.agentRuntime),w=y(b.defaults?.model??x),re=_(b.entry?.model),E=_(b.defaults?.model)||(w===`-`?null:c(w))||(i?null:_(x)),D=re??E??null,O=v?D:re,k=T(b.entry?.model)??T(b.defaults?.model)??(i?null:T(x))??[],A=Array.isArray(b.entry?.skills)?b.entry?.skills:null,j=A?.length??null,M=!i||s||u,ae=r.thinkingDefault??`-`,oe=e=>{let t=k.filter((t,n)=>n!==e);h(r.id,t)};return t`
    <section class="card">
          ...
          <div class="field">
            ...
            >
              ...
              <input
                ...
                @keydown=${e=>{let t=e.target;if(e.key===`Enter`||e.key===`,`){e.preventDefault();let n=ee(t.value);n.length>0&&(h(r.id,[...k,...n]),t.value=``)}}}
                @blur=${e=>{let t=e.target,n=ee(t.value);n.length>0&&(h(r.id,[...k,...n]),t.value=``)}}
              />
            </div>
          </div>
        </div>
...
${e}
    `.trim()}},`_shadowMode`,`open`);function Oe(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var I=Oe();function ke(e){I=e}var L={exec:()=>null};function R(e){let t=[];return n=>{let r=Math.max(0,Math.min(3,n-1)),i=t[r];return i||(i=e(r),t[r]=i),i}}function z(e,t=``){let n=typeof e==`string`?e:e.source,r={replace:(e,t)=>{let i=typeof t==`string`?t:t.source;return i=i.replace(B.caret,`$1`),n=n.replace(e,i),r},getRegex:()=>new RegExp(n,t)};return r}var Ae=((e=``)=>{try{return!!RegExp(`(?<=1)(?<!1)`+e)}catch{return!1}})(),B={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:e=>RegExp(`^( {0,3}${e})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:R(e=>RegExp(`^ {0,${e}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`)),hrRegex:R(e=>RegExp(`^ {0,${e}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`)),fencesBeginRegex:R(e=>RegExp(`^ {0,${e}}(?:\`\`\`|~~~)`)),headingBeginRegex:R(e=>RegExp(`^ {0,${e}}#`)),htmlBeginRegex:R(e=>RegExp(`^ {0,${e}}<(?:[a-z].*>|!--)`,`i`)),blockquoteBeginRegex:R(e=>RegExp(`^ {0,${e}}>`))},je=/^(?:[ \t]*(?:\n|$))+/,Me=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,Ne=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,V=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Pe=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Fe=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,Ie=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Le=z(Ie).replace(/bull/g,Fe).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,``).getRegex(),Re=z(Ie).replace(/bull/g,Fe).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),ze=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Be=/^[^\n]+/,Ve=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,He=z(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace(`label`,Ve).replace(`title`,/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Ue=z(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Fe).getRegex(),We=`address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul`,Ge=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Ke=z(`^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))`,`i`).replace(`comment`,Ge).replace(`tag`,We).replace(`attribute`,/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),qe=z(ze).replace(`hr`,V).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,We).getRegex(),Je={blockquote:z(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace(`paragraph`,qe).getRegex(),code:Me,def:He,fences:Ne,heading:Pe,hr:V,html:Ke,lheading:Le,list:Ue,newline:je,paragraph:qe,table:L,text:Be},Ye=z(`^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)`).replace(`hr`,V).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`blockquote`,` {0,3}>`).replace(`code`,`(?: {4}| {0,3}	)[^\\n]`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,We).getRegex(),Xe={...Je,lheading:Re,table:Ye,paragraph:z(ze).replace(`hr`,V).replace(`heading`,` {0,3}#{1,6}(?:\\s|$)`).replace(`|lheading`,``).replace(`table`,Ye).replace(`blockquote`,` {0,3}>`).replace(`fences`," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace(`list`,` {0,3}(?:[*+-]|1[.)])[ \\t]`).replace(`html`,`</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)`).replace(`tag`,We).getRegex()},Ze={...Je,html:z(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace(`comment`,Ge).replace(/tag/g,`(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b`).getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:L,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:z(ze).replace(`hr`,V).replace(`heading`,` *#{1,6} *[^
]`).replace(`lheading`,Le).replace(`|table`,``).replace(`blockquote`,` {0,3}>`).replace(`|fences`,``).replace(`|list`,``).replace(`|html`,``).replace(`|tag`,``).getRegex()},Qe=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,$e=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,et=/^( {2,}|\\)\n(?!\s*$)/,tt=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,H=/[\p{P}\p{S}]/u,U=/[\s\p{P}\p{S}]/u,nt=/[^\s\p{P}\p{S}]/u,rt=z(/^((?![*_])punctSpace)/,`u`).replace(/punctSpace/g,U).getRegex(),it=/(?!~)[\p{P}\p{S}]/u,at=/(?!~)[\s\p{P}\p{S}]/u,ot=/(?:[^\s\p{P}\p{S}]|~)/u,st=z(/link|precode-code|html/,`g`).replace(`link`,/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace(`precode-`,Ae?"(?<!`)()":"(^^|[^`])").replace(`code`,/(?<b>`+)[^`]+\k<b>(?!`)/).replace(`html`,/<(?! )[^<>]*?>/).getRegex(),ct=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,lt=z(ct,`u`).replace(/punct/g,H).getRegex(),ut=z(ct,`u`).replace(/punct/g,it).getRegex(),dt=`^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)`,ft=z(dt,`gu`).replace(/notPunctSpace/g,nt).replace(/punctSpace/g,U).replace(/punct/g,H).getRegex(),pt=z(dt,`gu`).replace(/notPunctSpace/g,ot).replace(/punctSpace/g,at).replace(/punct/g,it).getRegex(),mt=z(`^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)`,`gu`).replace(/notPunctSpace/g,nt).replace(/punctSpace/g,U).replace(/punct/g,H).getRegex(),ht=z(/^~~?(?:((?!~)punct)|[^\s~])/,`u`).replace(/punct/g,H).getRegex(),gt=z(`^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)`,`gu`).replace(/notPunctSpace/g,nt).replace(/punctSpace/g,U).replace(/punct/g,H).getRegex(),_t=z(/\\(punct)/,`gu`).replace(/punct/g,H).getRegex(),vt=z(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace(`scheme`,/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace(`email`,/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),yt=z(Ge).replace(`(?:-->|$)`,`-->`).getRegex(),bt=z(`^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>`).replace(`comment`,yt).replace(`attribute`,/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),W=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,xt=z(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace(`label`,W).replace(`href`,/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace(`title`,/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),St=z(/^!?\[(label)\]\[(ref)\]/).replace(`label`,W).replace(`ref`,Ve).getRegex(),Ct=z(/^!?\[(ref)\](?:\[\])?/).replace(`ref`,Ve).getRegex(),wt=z(`reflink|nolink(?!\\()`,`g`).replace(`reflink`,St).replace(`nolink`,Ct).getRegex(),Tt=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Et={_backpedal:L,anyPunctuation:_t,autolink:vt,blockSkip:st,br:et,code:$e,del:L,delLDelim:L,delRDelim:L,emStrongLDelim:lt,emStrongRDelimAst:ft,emStrongRDelimUnd:mt,escape:Qe,link:xt,nolink:Ct,punctuation:rt,reflink:St,reflinkSearch:wt,tag:bt,text:tt,url:L},Dt={...Et,link:z(/^!?\[(label)\]\((.*?)\)/).replace(`label`,W).getRegex(),reflink:z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace(`label`,W).getRegex()},Ot={...Et,emStrongRDelimAst:pt,emStrongLDelim:ut,delLDelim:ht,delRDelim:gt,url:z(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace(`protocol`,Tt).replace(`email`,/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:z(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace(`protocol`,Tt).getRegex()},kt={...Ot,br:z(et).replace(`{2,}`,`*`).getRegex(),text:z(Ot.text).replace(`\\b_`,`\\b_| {2,}\\n`).replace(/\{2,\}/g,`*`).getRegex()},G={normal:Je,gfm:Xe,pedantic:Ze},K={normal:Et,gfm:Ot,breaks:kt,pedantic:Dt},At={"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`},jt=e=>At[e];function q(e,t){if(t){if(B.escapeTest.test(e))return e.replace(B.escapeReplace,jt)}else if(B.escapeTestNoEncode.test(e))return e.replace(B.escapeReplaceNoEncode,jt);return e}function Mt(e){try{e=encodeURI(e).replace(B.percentDecode,`%`)}catch{return null}return e}function Nt(e,t){let n=e.replace(B.findPipe,(e,t,n)=>{let r=!1,i=t;for(;--i>=0&&n[i]===`\\`;)r=!r;return r?`|`:` |`}).split(B.splitPipe),r=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),t)if(n.length>t)n.splice(t);else for(;n.length<t;)n.push(``);for(;r<n.length;r++)n[r]=n[r].trim().replace(B.slashPipe,`|`);return n}function J(e,t,n){let r=e.length;if(r===0)return``;let i=0;for(;i<r;){let a=e.charAt(r-i-1);if(a===t&&!n)i++;else if(a!==t&&n)i++;else break}return e.slice(0,r-i)}function Pt(e){let t=e.split(`
...
Please report this to https://github.com/markedjs/marked.`,e){let e=`<p>An error occurred:</p><pre>`+q(n.message+``,!0)+`</pre>`;return t?Promise.resolve(e):e}if(t)return Promise.reject(n);throw n}}};function $(e,t){return Q.parse(e,t)}$.options=$.setOptions=function(e){return Q.setOptions(e),$.defaults=Q.defaults,ke($.defaults),$},$.getDefaults=Oe,$.defaults=I,$.use=function(...e){return Q.use(...e),$.defaults=Q.defaults,ke($.defaults),$},$.walkTokens=function(e,t){return Q.walkTokens(e,t)},$.parseInline=Q.parseInline,$.Parser=X,$.parser=X.parse,$.Renderer=Bt,$.TextRenderer=Vt,$.Lexer=Y,$.lexer=Y.lex,$.Tokenizer=zt,$.Hooks=Z,$.parse=$,$.options,$.setOptions,$.use,$.walkTokens,$.parseInline,X.parse,Y.lex;function Ht(e){let t=e.trim();return t?t.split(/\s+/).length:0}function Ut(e){return e.length===0?0:e.split(/\r?\n/).length}function Wt(e){return e<=0?a(`agents.files.emptyDraft`):a(`agents.files.minRead`,{count:String(Math.max(1,Math.round(e/220)))})}function Gt(e){let t=e.split(`.`).pop()?.trim().toLowerCase();return t===`md`||t===`markdown`?a(`agents.files.markdownPreview`):t?a(`agents.files.extensionPreview`,{ext:t.toUpperCase()}):a(`agents.files.preview`)}function Kt(e,t){let n=e.trim(),r=t?.trim();if(!n)return``;if(r&&n===r)return`.`;if(r&&n.startsWith(`${r}/`))return n.slice(r.length+1)||`.`;let i=n.split(/[\\/]+/);for(let e=i.length-1;e>=0;--e){let t=i[e];if(t)return t}return n}function qt(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/^-+|-+$/g,``)||`preview`}function Jt(e,t){if(!(e instanceof HTMLElement))return;let n=a(t?`agents.files.collapsePreview`:`agents.files.expandPreview`);e.classList.toggle(`is-fullscreen`,t),e.setAttribute(`aria-pressed`,String(t)),e.setAttribute(`aria-label`,n),e.setAttribute(`title`,n)}function Yt(e,n,r){return t`
      ...
      <section class="card">
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${g(e.status?.nextWakeAtMs??null)}</div>
          </div>
        </div>
        ${e.error?t`<div class="callout danger" style="margin-top: 12px;">${e.error}</div>`:n}
      </section>
  ...
  `}function nn(r){let i=r.agentFilesList?.agentId===r.agentId?r.agentFilesList:null,o=i?.files??[],c=r.agentFileActive??null,l=c?o.find(e=>e.name===c)??null:null,u=c?r.agentFileContents[c]??``:``,d=c?r.agentFileDrafts[c]??u:``,p=c?d!==u:!1,h=l?Ee($.parse(d,{gfm:!0,breaks:!0}),{sanitize:e=>s.sanitize(e)}):``,g=m(new TextEncoder().encode(d).length),_=Ht(d),v=Ut(d),ee=l?Kt(l.path,i?.workspace):``,y=l?`agent-file-preview-title-${qt(l.name)}`:``,b=l?.missing?a(`agents.files.willCreateOnSave`):a(p?`agents.files.liveDraftPreview`:`agents.files.savedPreview`),x=l?.missing?`is-missing`:p?`is-dirty`:`is-synced`,S=l?.updatedAtMs?a(`agents.files.updated`,{time:f(l.updatedAtMs)}):l?.missing?a(`agents.files.notCreatedYet`):a(`agents.files.updatedUnknown`);return t`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
      ...
      ${r.agentFilesError?t`<div class="callout danger" style="margin-top: 12px;">
            ${r.agentFilesError}
          </div>`:n}
      ${i?o.length===0?t` <div class="muted" style="margin-top: 16px">${a(`agents.files.empty`)}</div> `:t`
              <div class="agent-tabs" style="margin-top: 14px;">
                ${o.map(e=>{let i=c===e.name,o=e.name.replace(/\.md$/i,``);return t`
                    <button
                      class="agent-tab ${i?`active`:``} ${e.missing?`agent-tab--missing`:``}"
                      @click=${()=>r.onSelectFile(e.name)}
                    >
                      ${o}${e.missing?t` <span class="agent-tab-badge">${a(`agents.files.missing`)}</span> `:n}
                    </button>
                  `})}
              </div>
              ${l?t`
  ...
  `}function vn(e){return e.source===`plugin`?e.pluginId?a(`agentTools.connectedSource`,{id:e.pluginId}):a(`agentTools.connected`):e.source===`channel`?e.channelId?a(`agentTools.channelSource`,{id:e.channelId}):a(`agentTools.channel`):e.source===`mcp`?`MCP`:a(`agentTools.builtIn`)}function yn(e){let r=ie(e.configForm,e.agentId),i=r.entry?.tools??{},o=r.globalTools??{},s=i.profile??o.profile??`full`,c=re(e.toolsCatalogResult),l=v(e.toolsCatalogResult),u=i.profile?`agent override`:o.profile?`global default`:`default`,d=Array.isArray(i.allow)&&i.allow.length>0,f=Array.isArray(o.allow)&&o.allow.length>0,m=!!e.configForm&&!e.configLoading&&!e.configSaving&&!d&&!(e.toolsCatalogLoading&&!e.toolsCatalogResult&&!e.toolsCatalogError),g=d?[]:Array.isArray(i.alsoAllow)?i.alsoAllow:[],_=d?[]:Array.isArray(i.deny)?i.deny:[],ee=d?{allow:i.allow??[],deny:i.deny??[]}:ne(s)??void 0,y=l.flatMap(e=>e.tools.map(e=>e.id)),x=e=>{let t=p(e,ee),n=h(e,g),r=h(e,_);return{allowed:(t||n)&&!r,baseAllowed:t,denied:r}},S=y.filter(e=>x(e).allowed).length,te=e.runtimeSessionMatchesSelectedAgent&&!e.toolsEffectiveError?pn(e.toolsEffectiveResult?.groups):[],C=Array.from(new Map(te.map(e=>[b(e.id),e])).values()),w=C.slice(0,mn),T=Math.max(0,C.length-w.length),E=C.length,D=new Map(te.map(e=>[b(e.id),e])),O=new Set(D.keys()),k=e=>e.toSorted((e,t)=>{let n=b(e.id),r=b(t.id),i=+!!O.has(n),a=+!!O.has(r);if(i!==a)return a-i;let o=+!!x(e.id).allowed,s=+!!x(t.id).allowed;return o===s?e.label.localeCompare(t.label):s-o}),A=(t,n)=>{let r=new Set(g.map(e=>b(e)).filter(e=>e.length>0)),i=new Set(_.map(e=>b(e)).filter(e=>e.length>0)),a=x(t).baseAllowed,o=b(t);n?(i.delete(o),a||r.add(o)):(r.delete(o),i.add(o)),e.onOverridesChange(e.agentId,[...r],[...i])},j=t=>{let n=new Set(g.map(e=>b(e)).filter(e=>e.length>0)),r=new Set(_.map(e=>b(e)).filter(e=>e.length>0));for(let e of y){let i=x(e).baseAllowed,a=b(e);t?(r.delete(a),i||n.add(a)):(n.delete(a),r.add(a))}e.onOverridesChange(e.agentId,[...n],[...r])};return t`
    <section class="card">
      <div class="agent-tools-header">
        <div class="agent-tools-header__intro">
          ...
          <div class="card-sub">
            ...
            <span class="mono">${S}/${y.length}</span> enabled.
          </div>
        </div>
                    ...
                    `:(e.toolsEffectiveResult?.groups?.length??0)===0?t`
                      ...
                      `:t`
                        <div class="agent-tools-runtime">
                          ${w.map(e=>{let n=dn(e.id);return t`
                              <a
      ...
      <div class="agent-tools-grid">
        ${l.map(r=>{let i=k(r.tools),a=r.tools.filter(e=>x(e.id).allowed).length,o=r.tools.filter(e=>O.has(b(e.id))).length,s=i.slice(0,4),c=Math.max(0,i.length-s.length);return t`
            <details class="agent-tools-group" @toggle=${hn}>
              ...
              <div class="agent-tools-list agent-tools-list--stacked">
                ${i.map(i=>{let a=dn(i.id),o=x(i.id),s=D.get(b(i.id))??null,c=i.defaultProfiles??[],l=on({section:r,tool:i,activeEntry:s}),u=ln(o),d=un({activeEntry:s,runtimeSessionMatchesSelectedAgent:e.runtimeSessionMatchesSelectedAgent});return t`
  ...
  `}function bn(e){let r=!!e.configForm&&!e.configLoading&&!e.configSaving,i=ie(e.configForm,e.agentId),s=Array.isArray(i.entry?.skills)?i.entry?.skills:void 0,c=new Set(x(s??[])),l=s!==void 0,u=!!(e.report&&e.activeAgentId===e.agentId),d=u?e.report?.skills??[]:[],f=o(e.filter),p=f?d.filter(e=>o([e.name,e.description,e.source].join(` `)).includes(f)):d,m=k(p),h=l?d.filter(e=>c.has(e.name)).length:d.length,g=d.length;return t`
    <section class="card">
      ...
      ${p.length===0?t` <div class="muted" style="margin-top: 16px">No skills found.</div> `:t`
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${m.map(t=>xn(t,{agentId:e.agentId,allowSet:c,usingAllowlist:l,editable:r,onToggle:e.onToggle}))}
            </div>
          `}
    </section>
  ...
  `}function Sn(e,r){let i=r.usingAllowlist?r.allowSet.has(e.name):!0,a=M(e),o=A(e);return t`
  ...
  `}function Cn(e){let i=e.agentsList?.agents??[],o=e.agentsList?.defaultId??null,s=e.selectedAgentId??o??i[0]?.id??null,c=s?i.find(e=>e.id===s)??null:null,l=s&&e.agentSkills.agentId===s?e.agentSkills.report?.skills?.length??null:null,f=e.channels.snapshot?Object.keys(e.channels.snapshot.channelAccounts??{}).length:null,p=s?e.cron.jobs.filter(e=>e.agentId===s).length:null,m={files:e.agentFiles.list?.files?.length??null,skills:l,channels:f,cron:p||null};return t`
    <div class="agents-layout">
      <section class="agents-toolbar">
        ...
        ${e.error?t`<div class="callout danger" style="margin-top: 8px;">${e.error}</div>`:n}
      </section>
      <section class="agents-main">
        ${c?t`
              ${wn(e.activePanel,t=>e.onSelectPanel(t),m)}
              ${e.activePanel===`overview`?r(c.id,ae({agent:c,basePath:e.basePath,defaultId:o,configForm:e.config.form,agentFilesList:e.agentFiles.list,agentIdentity:e.agentIdentityById[c.id]??null,agentIdentityError:e.agentIdentityError,agentIdentityLoading:e.agentIdentityLoading,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,modelCatalog:e.modelCatalog,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave,onModelChange:e.onModelChange,onModelFallbacksChange:e.onModelFallbacksChange,onSelectPanel:e.onSelectPanel})):n}
              ${e.activePanel===`files`?nn({agentId:c.id,agentFilesList:e.agentFiles.list,agentFilesLoading:e.agentFiles.loading,agentFilesError:e.agentFiles.error,agentFileActive:e.agentFiles.active,agentFileContents:e.agentFiles.contents,agentFileDrafts:e.agentFiles.drafts,agentFileSaving:e.agentFiles.saving,onLoadFiles:e.onLoadFiles,onSelectFile:e.onSelectFile,onFileDraftChange:e.onFileDraftChange,onFileReset:e.onFileReset,onFileSave:e.onFileSave}):n}
              ${e.activePanel===`tools`?yn({agentId:c.id,configForm:e.config.form,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,toolsCatalogLoading:e.toolsCatalog.loading,toolsCatalogError:e.toolsCatalog.error,toolsCatalogResult:e.toolsCatalog.result,toolsEffectiveLoading:e.toolsEffective.loading,toolsEffectiveError:e.toolsEffective.error,toolsEffectiveResult:e.toolsEffective.result,runtimeSessionKey:e.runtimeSessionKey,runtimeSessionMatchesSelectedAgent:e.runtimeSessionMatchesSelectedAgent,onProfileChange:e.onToolsProfileChange,onOverridesChange:e.onToolsOverridesChange,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave}):n}
              ${e.activePanel===`skills`?bn({agentId:c.id,report:e.agentSkills.report,loading:e.agentSkills.loading,error:e.agentSkills.error,activeAgentId:e.agentSkills.agentId,configForm:e.config.form,configLoading:e.config.loading,configSaving:e.config.saving,configDirty:e.config.dirty,filter:e.agentSkills.filter,onFilterChange:e.onSkillsFilterChange,onRefresh:e.onSkillsRefresh,onToggle:e.onAgentSkillToggle,onClear:e.onAgentSkillsClear,onDisableAll:e.onAgentSkillsDisableAll,onConfigReload:e.onConfigReload,onConfigSave:e.onConfigSave}):n}
              ${e.activePanel===`channels`?en({context:C(c,e.config.form,e.agentFiles.list,o,e.agentIdentityById[c.id]??null),configForm:e.config.form,snapshot:e.channels.snapshot,loading:e.channels.loading,error:e.channels.error,lastSuccess:e.channels.lastSuccess,onRefresh:e.onChannelsRefresh,onSelectPanel:e.onSelectPanel}):n}
              ${e.activePanel===`cron`?tn({context:C(c,e.config.form,e.agentFiles.list,o,e.agentIdentityById[c.id]??null),agentId:c.id,jobs:e.cron.jobs,status:e.cron.status,loading:e.cron.loading,error:e.cron.error,onRefresh:e.onCronRefresh,onRunNow:e.onCronRunNow,onSelectPanel:e.onSelectPanel}):n}
            `:t`
              <div class="card">
...
//# sourceMappingURL=agents-axVWa90s.js.map