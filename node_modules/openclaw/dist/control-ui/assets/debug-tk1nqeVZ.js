import{m as e,p as t}from"./lit-runtime-gkTRPNbC.js";import{o as n}from"./string-coerce-DwnRzrPh.js";import{H as r,i}from"./index-DRTyMBOr.js";function a(a){let o=(a.status&&typeof a.status==`object`?a.status.securityAudit:null)?.summary??null,s=o?.critical??0,c=o?.warn??0,l=o?.info??0,u=s>0?`danger`:c>0?`warn`:`success`,d=s>0?n(`debug.security.critical`,{count:String(s)}):c>0?n(`debug.security.warnings`,{count:String(c)}):n(`debug.security.noCriticalIssues`);return e`
    <section class="grid">
      <div class="card">
...
//# sourceMappingURL=debug-tk1nqeVZ.js.map