...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-Bh0ESsLz.js";
import "./workspace-DVU_odQG.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DmSqEQVq.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-DNygKpBT.js";
import { n as t } from "./i18n-7g_f4oaD.js";
import { n as openUrl } from "./browser-open-oQjG3E1N.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-Dfa8-e4A.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-q0biHaKT.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-CXdV-Nnx.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-IddOiMo0.js");
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-CIUMvR8c.js");
