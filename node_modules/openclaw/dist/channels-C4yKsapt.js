...
import { a as getResolvedLoggerSettings } from "./logger-XNVR48Hn.js";
...
import { t as danger } from "./globals-DiwHZb7D.js";
import { i as getRuntimeConfig, u as readConfigFileSnapshot } from "./io-AmXZn-TT.js";
import { a as getBundledChannelSetupPlugin } from "./bundled-BrAGcTz5.js";
import { i as replaceConfigFile } from "./config-Ba5VqNR9.js";
import { c as formatUnknownChannelMessage, l as formatUnsupportedChannelActionMessage } from "./error-format-17foa2IM.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-C3m2WQdt.js";
import "./plugins-2jPMnXk3.js";
import "./message-channel-rCegTRAO.js";
import "./logging-DSz41SY4.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-DssZLv87.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-D7tPA6lO.js";
import { r as resolveMessageChannelSelection } from "./channel-selection-CRKB2xO6.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-D7WTuInQ.js";
import { n as listReadOnlyChannelPluginsForConfig } from "./read-only-BWLzyE6E.js";
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-RagBiOB3.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-D9eA0NDM.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B4nCo7XW.js";
import { n as resolveLogFile } from "./log-tail-BBu4PFpD.js";
import { t as parseLogLine } from "./parse-log-line-r1AtYhBf.js";
import { t as describeBinding } from "./agents.binding-format-B_OLxIww.js";
import { t as applyAgentBindings } from "./agents.bindings-BWuiUDTG.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-0_lhqO9E.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-DZriJEym.js";
import { t as channelsListCommand } from "./list-znnQcurc.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-D197Mkj9.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-BVbtt--s.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels--SrFGnPH.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-0PPRmeR1.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BGdioiX_.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-Bnje5Nyp.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-dEicAnWr.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-B3DSaHD1.js");
