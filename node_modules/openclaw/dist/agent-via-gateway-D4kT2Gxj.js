...
import { c as isUnscopedSessionKeySentinel, f as resolveAgentIdFromSessionKey, g as scopeLegacySessionKeyToAgent, s as classifySessionKeyShape, u as normalizeAgentId } from "./session-key-BOpfMTUN.js";
import { c as resolveDefaultAgentId, n as listAgentIds } from "./agent-scope-config-BoFGd2i9.js";
import { n as isGatewaySecretRefUnavailableError } from "./credentials-MEPkijLg.js";
import { i as GATEWAY_CLIENT_NAMES, r as GATEWAY_CLIENT_MODES } from "./client-info-BzCrekjX.js";
import { _ as readGatewayDispatchConfig, a as callGateway, d as isGatewayCredentialsRequiredError, f as isGatewayExplicitAuthRequiredError, m as randomIdempotencyKey, p as isGatewayTransportError, v as readGatewayDispatchConfigWithShellEnvFallback } from "./call-9LwLArZ9.js";
...
const defaultAgentSessionModuleLoader = () => import("./session-Q8j-fImg.js");
...
function loadEmbeddedAgentCommand() {
	embeddedAgentCommandPromise ??= import("./agent-Dk-C0Y52.js").then((module) => module.agentCommand);
...
async function loadRuntimeConfig() {
	runtimeConfigModulePromise ??= import("./io-BTuuG0aR.js");
