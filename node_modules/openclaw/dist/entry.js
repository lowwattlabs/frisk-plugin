...
import { c as hasFlag, d as isRootHelpInvocation, f as isRootVersionInvocation, n as getCommandPathWithRootOptions, r as getCommandPositionalsWithRootOptions } from "./argv-8KO9gKcu.js";
import { t as isMainModule } from "./is-main-DoKHeRG7.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-McgJTh4C.js";
import { a as resolveCliContainerTarget, i as parseCliContainerArgs, n as parseCliProfileArgs, t as applyCliProfileEnv } from "./profile-DUddXz83.js";
...
import { n as ensureOpenClawExecMarkerOnProcess } from "./openclaw-exec-env-DGz-Z2Ir.js";
import { t as installProcessWarningFilter } from "./warning-filter-LkhXvda_.js";
...
async function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	try {
		...
		await (deps.outputRootHelp ?? (await import("./root-help-CS677Lis.js")).outputRootHelp)(liveRootHelpOptions ?? void 0);
		return true;
	} catch (error) {
		handleError(error);
		return true;
...
async function runMainOrRootHelp(argv) {
	...
	try {
		...
		const { formatCliFailureLines } = await import("./failure-output-epADd6ic.js");
