...
//#endregion
export { resolveExecModeFromPolicy as $, loadExecApprovals as A, windowsEscapeArg as At, persistAllowAlwaysPatterns as B, resolveCommandResolutionFromArgv as Bt, SystemRunApprovalPlan as C, buildEnforcedShellCommand as Ct, ensureExecApprovals as D, resolvePlannedSegmentArgv as Dt, commandRequiresSecurityAuditSuppressionApproval as E, isWindowsPlatform as Et, normalizeExecAsk as F, parseExecArgvToken as Ft, requireValidExecTarget as G, resolvePolicyAllowlistCandidatePath as Gt, recordAllowlistMatchesUse as H, resolveExecutionTargetCandidatePath as Ht, normalizeExecHost as I, resolveAllowlistCandidatePath as It, resolveExecApprovalRequestAllowedDecisions as J, resolvePolicyTargetTrustPath as Jt, requiresExecApproval as K, resolvePolicyTargetCandidatePath as Kt, normalizeExecMode as L, resolveApprovalAuditCandidatePath as Lt, mergeExecApprovalsSocketDefaults as M, ExecArgvToken as Mt, minSecurity as N, ExecutableResolution as Nt, hasDurableExecApproval as O, splitCommandChain as Ot, normalizeExecApprovals as P, matchAllowlist as Pt, resolveExecApprovalsSocketPath as Q, normalizeExecSecurity as R, resolveApprovalAuditTrustPath as Rt, SystemRunApprovalFileOperand as S, analyzeShellCommand as St, addDurableCommandApproval as T, buildSafeShellCommand as Tt, recordAllowlistUse as U, resolveExecutionTargetResolution as Ut, readExecApprovalsSnapshot as V, resolveExecutableTrustPath as Vt, requestExecApprovalViaSocket as W, resolveExecutionTargetTrustPath as Wt, resolveExecApprovalsFromFile as X, resolveExecApprovals as Y, ExecAllowlistEntry as Yt, resolveExecApprovalsPath as Z, ExecHost as _, ExecCommandAnalysis as _t, ExecApprovalCommandSpan as a, ExecAllowlistAnalysis as at, ExecTarget as b, ShellChainPart as bt, ExecApprovalRequestPayload as c, SkillBinTrustEntry as ct, ExecApprovalsDefaultOverrides as d, isSafeBinUsage as dt, resolveExecModePolicy as et, ExecApprovalsDefaults as f, normalizeSafeBins as ft, ExecAsk as g, CommandExplanationSummary as gt, ExecApprovalsSnapshot as h, resolveSafeBins as ht, EXEC_TARGET_VALUES as i, AllowAlwaysPattern as it, maxAsk as j, CommandResolution as jt, isExecApprovalDecisionAllowed as k, splitCommandChainWithOperators as kt, ExecApprovalResolved as l, evaluateExecAllowlist as lt, ExecApprovalsResolved as m, resolveAllowAlwaysPatterns as mt, DEFAULT_EXEC_APPROVAL_DECISIONS as n, restoreExecApprovalsSnapshot as nt, ExecApprovalDecision as o, ExecAllowlistEvaluation as ot, ExecApprovalsFile as p, resolveAllowAlwaysPatternEntries as pt, resolveExecApprovalAllowedDecisions as q, resolvePolicyTargetResolution as qt, DEFAULT_EXEC_APPROVAL_TIMEOUT_MS as r, saveExecApprovals as rt, ExecApprovalRequest as s, ExecSegmentSatisfiedBy as st, DEFAULT_EXEC_APPROVAL_ASK_FALLBACK as t, resolveExecPolicyForMode as tt, ExecApprovalsAgent as u, evaluateShellAllowlist as ut, ExecMode as v, ExecCommandSegment as vt, addAllowlistEntry as w, buildSafeBinsShellCommand as wt, SystemRunApprovalBinding as x, analyzeArgvCommand as xt, ExecSecurity as y, ShellChainOperator as yt, normalizeExecTarget as z, resolveCommandResolution as zt };