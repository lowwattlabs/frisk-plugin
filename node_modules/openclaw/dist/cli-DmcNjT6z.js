...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-DJqR2C8o.js";
import { n as matrixSetupAdapter } from "./setup-core-CNAEG_QW.js";
import { t as withResolvedActionClient } from "./client-BlqQFHH1.js";
import { r as resolveMatrixAuthContext } from "./config-DDNIDvCr.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-C2qHjHKA.js");
	return matrixActionClientModulePromise;
}
function loadMatrixDirectManagementModule() {
	matrixDirectManagementModulePromise ??= import("./direct-management-CQ1JJ3Mp.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-JnzrekZr.js");
