...
import { p as resolveUserPath, s as ensureDir } from "./utils-CFG_gPqL.js";
...
import { a as isA2uiPath, i as injectCanvasLiveReload, n as CANVAS_HOST_PATH } from "./a2ui-shared-DDC8Xhci.js";
import { n as normalizeUrlPath, r as resolveFileWithinRoot } from "./a2ui-B6r37C-N.js";
	...
	const server = http.createServer((req, res) => {
		...
		(async () => {
			if (req.url && isA2uiPath(new URL(req.url, "http://localhost").pathname)) {
				const { handleA2uiHttpRequest } = await import("./a2ui-CFOsZ4lB.js");
