...
import { b as isUsageCountedSessionTranscriptFileName, h as isSessionArchiveArtifactName, l as resolveSessionTranscriptsDirForAgent } from "./paths-Bz9nEaho.js";
import { n as onSessionTranscriptUpdate } from "./transcript-events-_AiEotlV.js";
...
import { t as getEmbeddingProvider } from "./embedding-provider-runtime-Q6mdXHr5.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BkHzs4SC.js";
import "./embedding-providers-Hu6Ns5vw.js";
import { t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-EkRUeZnH.js";
import { u as enforceEmbeddingMaxInputTokens } from "./memory-core-host-engine-embeddings-BB4b09Jx.js";
import { r as retryTransientMemoryRead, t as hashText } from "./hash-LC4pU6ea.js";
import { t as isFileMissingError } from "./fs-utils-Bnr6PWUN.js";
import { a as ensureDir, c as normalizeExtraMemoryPaths, d as runWithConcurrency, f as hasNonTextEmbeddingParts, i as cosineSimilarity, l as parseEmbedding, n as buildMultimodalChunkForIndexing, r as chunkMarkdown, s as listMemoryFiles, t as buildFileEntry, u as remapChunkLines } from "./internal-yM7bTP9z.js";
import "./memory-core-host-engine-foundation-D3gkwJbN.js";
import { l as buildSessionEntry, m as sessionPathForFile, u as listSessionFilesForAgent } from "./engine-qmd-oR1jDIms.js";
import "./memory-core-host-engine-qmd-DyT7RSFj.js";
import { n as readMemoryFile } from "./read-file-DVfpKpFv.js";
import { a as ensureMemoryIndexSchema, i as loadSqliteVecExtension, n as configureMemorySqliteWalMaintenance, r as requireNodeSqlite, t as closeMemorySqliteWalMaintenance } from "./engine-storage-C8286m98.js";
import "./memory-core-host-engine-storage-D3o3IUm6.js";
import "./dreaming-shared-D-ppwYmu.js";
import { r as tokenize, t as jaccardSimilarity } from "./tokenize-CZsEZIgo.js";
...
var MemoryManagerSyncOps = class {
	...
	async runSync(params) {
		...
		const needsFullReindex = params?.force && !hasTargetSessionFiles || needsInitialIndex || needsExplicitIdentityReindex;
	...
	*/
	...
	async indexFile(entry, options) {
		if (!this.provider) {
			...
			const chunks = filterNonEmptyMemoryChunks(chunkMarkdown(options.content ?? await retryTransientMemoryRead(() => fs$1.readFile(entry.absPath, "utf-8"), `read memory markdown for indexing ${entry.absPath}`), this.settings.chunking));
		...
		if ("kind" in entry && entry.kind === "multimodal") {
			...
			const baseChunks = filterNonEmptyMemoryChunks(chunkMarkdown(options.content ?? await retryTransientMemoryRead(() => fs$1.readFile(entry.absPath, "utf-8"), `read memory markdown for indexing ${entry.absPath}`), this.settings.chunking));
