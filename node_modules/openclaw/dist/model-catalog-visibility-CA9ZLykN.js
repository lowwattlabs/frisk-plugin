...
async function providerHasAuth(providerAuthChecker, entry) {
...
async function resolveVisibleModelCatalog(params) {
	...
	const buildDefaultVisibleCatalog = async () => {
		...
		for (const entry of params.catalog) if (await providerHasAuth(hasAuth, entry)) authBackedCatalog.push(entry);
